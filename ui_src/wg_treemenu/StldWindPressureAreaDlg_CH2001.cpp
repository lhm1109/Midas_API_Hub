...
CStldWindPressureAreaDlg_CH2001::CStldWindPressureAreaDlg_CH2001(CWnd* pParent /*=NULL*/)
: CCMWindPressureBaseChildDlg(CStldWindPressureAreaDlg_CH2001::IDD, pParent)
{
	m_bInitChild = FALSE;
	m_pData = NULL;
}

void CStldWindPressureAreaDlg_CH2001::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CStldWindPressureAreaDlg_CH2001, CCMWindPressureBaseChildDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureAreaDlg_CH2001 message handlers

BOOL CStldWindPressureAreaDlg_CH2001::OnInitDialog() 
{
...
BOOL CStldWindPressureAreaDlg_CH2001::DestroyWindow() 
{
...
void CStldWindPressureAreaDlg_CH2001::InitDefaultData()
{
}

void CStldWindPressureAreaDlg_CH2001::Data2Dlg( void* pData, BOOL bWarning )
{
...
BOOL CStldWindPressureAreaDlg_CH2001::Dlg2Data( void* pData, BOOL bWarning )
{
	m_pData = (T_WDPR_D*)pData;
...
void CStldWindPressureAreaDlg_CH2001::OnBtnMagFactorAutoCalc()
{
	if(!m_pParent->Dlg2Data(FALSE)) return;
...
void CStldWindPressureAreaDlg_CH2001::OnRdoChanged()
{
	int nType = GetType();
	if(nType == 1)
	{
...
int CStldWindPressureAreaDlg_CH2001::GetType()
{
	int nType = 1;
...
void CStldWindPressureAreaDlg_CH2001::InitControl()
{
...
// void CStldWindPressureAreaDlg_CH2001::OnBtnCheckVibration()
// {
