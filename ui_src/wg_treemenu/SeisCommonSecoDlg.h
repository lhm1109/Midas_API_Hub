...
class CSeisCommonSecoDlg : public CMenuBarChildDlg, public CDBUpdateConnector
{
public:
	CSeisCommonSecoDlg(CWnd* pParent = nullptr);
	~CSeisCommonSecoDlg();
	enum { IDD = IDD_TM_SEIS_COMMON_SECO };
...
private:
	bool Dlg2Data(T_SECO_D& rSecoD);
	bool Data2Dlg(const T_SECO_D& SecoD);
