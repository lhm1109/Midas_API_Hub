// NodeCompactDlg.cpp : implementation file
//
...
CNodeCompactDlg::CNodeCompactDlg(CWnd* pParent /*=NULL*/)
	: CMenuBarChildDlg(CNodeCompactDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CNodeCompactDlg)
	m_nRange = 0;
	m_nStartNum = 1;
	m_nEndNum = 1;
	//}}AFX_DATA_INIT
...
void CNodeCompactDlg::DoDataExchange(CDataExchange* pDX)
{
	CMenuBarChildDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CNodeCompactDlg)
...
BEGIN_MESSAGE_MAP(CNodeCompactDlg, CDialog)
#undef CDialog
	//{{AFX_MSG_MAP(CNodeCompactDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CNodeCompactDlg message handlers
BOOL CNodeCompactDlg::OnInitDialog() 
{
...
void CNodeCompactDlg::OnTmSelectAll() 
{
	// TODO: Add your control notification handler code here
	CtrlEnableDisable(m_ByNumCtrl, FALSE);
}

void CNodeCompactDlg::OnTmSelectRange() 
{
	// TODO: Add your control notification handler code here
	CtrlEnableDisable(m_ByNumCtrl, TRUE);	
}

void CNodeCompactDlg::Execute()
{
	...
	BOOL bSuccess = pDoc->m_pDataCtrl->CompactNode(m_nStartNum, m_nEndNum);
