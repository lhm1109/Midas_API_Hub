// SeisMFactorDlg.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CSeisMFactorDlg, CFormViewInBar)

CSeisMFactorDlg::CSeisMFactorDlg()
	: CFormViewInBar(CSeisMFactorDlg::IDD)
{
	//{{AFX_DATA_INIT(CSeisMFactorDlg)
	//}}AFX_DATA_INIT
	...
	T_COMBO_ITEM aItem[] = {
		{ D_PROD_GEN , __TMMODE_SEIS_1ST_RC_M_FACTOR__ },
		{ D_PROD_GEN , __TMMODE_SEIS_1ST_STL_M_FACTOR__ },
		{ D_PROD_GEN , __TMMODE_SEIS_1ST_MASONRY_M_FACTOR__ },
	};
...
void CSeisMFactorDlg::DoDataExchange(CDataExchange* pDX)
{
	CFormViewInBar::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisMFactorDlg)
	DDX_Control(pDX, IDC_TM_SEIS_MFACT_TABLE_BTN, m_wndTableBtn);
	DDX_Control(pDX, IDC_TM_SEIS_MFACT_MENU_COMBO, m_ComboMenu);
	DDX_Control(pDX, IDC_TM_PLACEHOLDER, m_wndPlaceHolder);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CSeisMFactorDlg, CFormViewInBar)
	//{{AFX_MSG_MAP(CSeisMFactorDlg)
	ON_CBN_SELCHANGE(IDC_TM_SEIS_MFACT_MENU_COMBO, OnComboMenuSelect)
	ON_WM_CREATE()
	ON_BN_CLICKED(IDC_TM_SEIS_MFACT_TABLE_BTN, OnTmTableBtn)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CSeisMFactorDlg diagnostics

#ifdef _DEBUG
void CSeisMFactorDlg::AssertValid() const
{
	CFormViewInBar::AssertValid();
}

void CSeisMFactorDlg::Dump(CDumpContext& dc) const
{
...
/////////////////////////////////////////////////////////////////////////////
// CSeisMFactorDlg Implementation Functions
// (수정)
void CSeisMFactorDlg::AddChildDlgs(int nMode)
{
	m_DlgIDs.Add(nMode);
	switch(nMode)
	{
	case __TMMODE_SEIS_1ST_RC_M_FACTOR__:
		m_ComboMenuStr.Add(_LS(IDS_WG_TREEMENU_SEIS_RC_MFACT));
		m_ChildDlgs.Add(new CSeisRcMFactorDlg);
		m_TableIDs.Add(ID_MAIN_RIBBON_SEISEVAL_1ST_RC_M_FACTOR_TB);
		break;
	...
	case __TMMODE_SEIS_1ST_MASONRY_M_FACTOR__:
		m_ComboMenuStr.Add(_LS(IDS_WG_TREEMENU_SEIS_MASONRY_MFACT));
		m_ChildDlgs.Add(new CSeisMasonryMFactorDlg);
		m_TableIDs.Add(ID_MAIN_RIBBON_SEISEVAL_1ST_MASONRY_M_FACTOR_TB);
		break;
	default: ASSERT(0); break;
	}
}

void CSeisMFactorDlg::DeleteChildDlgs()
{
...
BOOL CSeisMFactorDlg::ShowChildDlgByID(int nID)
{
	if(nID == __TMMODE_SEIS_1ST_M_FACTOR__)
	{
		ShowCurChildDlg(0);  
...
void CSeisMFactorDlg::ShowCurChildDlg(int nDlgIndex)
{
...
int CSeisMFactorDlg::_GetHeightFromFont()
{
...
void CSeisMFactorDlg::AdjustComboListBox()
{
	CString str;
	CSize   sz;
	int     dx=0;
...
void CSeisMFactorDlg::InitComboMenu()
{
	int wHeight;
...
void CSeisMFactorDlg::InitContent()
{
...
/////////////////////////////////////////////////////////////////////////////
// CSeisMFactorDlg message handlers

void CSeisMFactorDlg::OnInitialUpdate() 
{
...
void CSeisMFactorDlg::OnActivateView(BOOL bActivate, CView* pActivateView, CView* pDeactiveView) 
{
	// TODO: Add your specialized code here and/or call the base class
...
void CSeisMFactorDlg::OnComboMenuSelect() 
{
...
int CSeisMFactorDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CSeisMFactorDlg::OnTmTableBtn() 
{
	// TODO: Add your control notification handler code here
...
//////////////////////////////////////////////////////////////////
// By L.C.G
void CSeisMFactorDlg::OnTabSelect(WPARAM wParam,LPARAM lParam)
{
...
void CSeisMFactorDlg::OnTabUnSelect(WPARAM wParam,LPARAM lParam)
{

}

CWnd* CSeisMFactorDlg::GetDlgByID(int Mode)
{
...
void CSeisMFactorDlg::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
	HWND hWnd;
...
void CSeisMFactorDlg::UpdateBuffer()
{
