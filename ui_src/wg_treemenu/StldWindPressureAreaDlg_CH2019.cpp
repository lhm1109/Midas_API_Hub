...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureAreaDlg_CH2019 dialog

CStldWindPressureAreaDlg_CH2019::CStldWindPressureAreaDlg_CH2019(CWnd* pParent /*=NULL*/)
: CCMWindPressureBaseChildDlg(CStldWindPressureAreaDlg_CH2019::IDD, pParent)
{
	m_pData = NULL;
	m_nPeriodType = 1;
}

void CStldWindPressureAreaDlg_CH2019::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CStldWindPressureAreaDlg_CH2019, CCMWindPressureBaseChildDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureAreaDlg_CH2019 message handlers

BOOL CStldWindPressureAreaDlg_CH2019::OnInitDialog() 
{
...
BOOL CStldWindPressureAreaDlg_CH2019::DestroyWindow() 
{
...
BOOL CStldWindPressureAreaDlg_CH2019::Dlg2Data( void* pData, BOOL bWarning )
{
...
void CStldWindPressureAreaDlg_CH2019::Data2Dlg( void* pData, BOOL bWarning )
{
	m_pData = (T_WDPR_D*)pData;
...
//   if(m_pData->CH2019.bWindComfort)
...
int CStldWindPressureAreaDlg_CH2019::GetType()
{
	int nType = 1;
...
void CStldWindPressureAreaDlg_CH2019::InitControl()
{
...
void CStldWindPressureAreaDlg_CH2019::OnChkConsiderPartition()
{
	BOOL bEnable;
	if(((CButton*)GetDlgItem(IDC_TM_WIND_CONSIDER_PARTITION))->GetCheck())
		bEnable = TRUE;
...
void CStldWindPressureAreaDlg_CH2019::OnChkConsiderWindShield()
{
	BOOL bEnable;
	if(((CButton*)GetDlgItem(IDC_TM_WIND_CONSIDER_WINDSHIELD))->GetCheck())
		bEnable = TRUE;
...
void CStldWindPressureAreaDlg_CH2019::OnChkConsiderCrossWind()
{
	BOOL bEnable;
	if(((CButton*)GetDlgItem(IDC_TM_WIND_CROSS_CHECK))->GetCheck())
		bEnable = TRUE;
...
// void CStldWindPressureAreaDlg_CH2019::OnChkConsiderComfort()
// {
//   BOOL bEnable;
//   if(((CButton*)GetDlgItem(IDC_TM_WIND_CFT_CHECK))->GetCheck())
//     bEnable = TRUE;
...
void CStldWindPressureAreaDlg_CH2019::OnBtnPeriod()
{
	int nStore;
...
void CStldWindPressureAreaDlg_CH2019::OnBtnCrossWind()
{
...
void CStldWindPressureAreaDlg_CH2019::OnBtnPeriod2()
{
	int nStore;
	double dHeight, dWidth;  
...
void CStldWindPressureAreaDlg_CH2019::OnCmdWindAlongCheck()
{
