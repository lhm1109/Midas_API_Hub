// NodeRenumberDlg.cpp : implementation file
//
...
CNodeRenumberDlg::CNodeRenumberDlg(CWnd* pParent /*=NULL*/)
	: CMenuBarChildDlg(CNodeRenumberDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CNodeRenumberDlg)
	m_NumTarget = 0;
	m_SelType = 1;
	m_tmStartNode = _T("1");
...
void CNodeRenumberDlg::DoDataExchange(CDataExchange* pDX)
{
	CMenuBarChildDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CNodeRenumberDlg)
...
BEGIN_MESSAGE_MAP(CNodeRenumberDlg, CMenuBarChildDlg)
	//{{AFX_MSG_MAP(CNodeRenumberDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CNodeRenumberDlg message handlers

BOOL CNodeRenumberDlg::OnInitDialog() 
{
	...
	m_wndPicture.SetImage(_T("SVG\\Illustration\\Dialog\\tm_renum.svg"));
...
void CNodeRenumberDlg::AlignControl()
{
	CRect rRef;
	CRect rToMove;
	int nDistY;	
	...
	CArray<UINT, UINT> *aCtrlSet[] = {&m_aCtrlCartesian};
...
void CNodeRenumberDlg::SetInitCombString()
{
...
void CNodeRenumberDlg::OnTmRenumTarget() 
{		
	UpdateData(TRUE);
	SetEditControl();	
}

void CNodeRenumberDlg::OnSelchangeSortMethodCmb() 
{  
	SetFrameSize();
	SetEditControl();
}

void CNodeRenumberDlg::SetFrameSize()
{
	...
	((CStructNodeDlg*)(GetParent()->GetParent()))->SetHolderSize(nDlgHeight);

	Invalidate();
}

void CNodeRenumberDlg::OnTmCylinderAxisRdo() 
{
	UpdateData(TRUE);
	SetEditControl();
}

void CNodeRenumberDlg::SetEditControl()
{
	CEdit* pEdit;
...
void CNodeRenumberDlg::OnSelchangeCarOrder1st() 
{
...
void CNodeRenumberDlg::OnSelchangeCarOrder2nd() 
{
	CString strTemp = _T("");  
...
void CNodeRenumberDlg::OnSelchangeCynOrder1st()
{
...
void CNodeRenumberDlg::OnSelchangeCynOrder2nd()
{  
	CString strTemp;
...
void CNodeRenumberDlg::OnSelchangeCynAxisOrder()
{
...
BOOL CNodeRenumberDlg::GetRot1stPoint(double &Px, double &Py, double &Pz)
{
...
BOOL CNodeRenumberDlg::GetRot2ndPoint(double &Px, double &Py, double &Pz)
{
...
BOOL CNodeRenumberDlg::GetPol1stPoint(double &Px, double &Py, double &Pz)
{
...
BOOL CNodeRenumberDlg::GetPol2ndPoint(double &Px, double &Py, double &Pz)
{
...
BOOL CNodeRenumberDlg::CheckOrthogonal()
{
...
void CNodeRenumberDlg::ExecuteCartesian()
{
 	UpdateData(TRUE);
...
void CNodeRenumberDlg::ExecuteCylindrical()
{
	UpdateData(TRUE);
	CArray<T_NODE_K, T_NODE_K> aNodeKey;
	CArray<T_ELEM_K, T_ELEM_K> aElemKey;
...
int CNodeRenumberDlg::GetOrderOpt()
{
	int nRet = 0;
