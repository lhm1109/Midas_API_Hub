#if !defined(__TM_STLD_WIND_NODAL_KBC2016_H__)
#define __TM_STLD_WIND_NODAL_KBC2016_H__
...
class CStldWindPressureNodalDlg_KBC2016: public CCMWindPressureBaseChildDlg
{
	// Construction
public:
	CStldWindPressureNodalDlg_KBC2016(CWnd* pParent = NULL);   // standard constructor
	...
	enum { IDD = IDD_TM_STLD_WINDP_DLG_NODAL_KBC2016 };  
