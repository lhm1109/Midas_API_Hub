#if !defined(__TM_STLD_WIND_AREA_CH2019_H__)
#define __TM_STLD_WIND_AREA_CH2019_H__
...
class CStldWindPressureAreaDlg_CH2019 : public CCMWindPressureBaseChildDlg
{
	// Construction
public:
	CStldWindPressureAreaDlg_CH2019(CWnd* pParent = NULL);   // standard constructor
	...
	enum { IDD = IDD_TM_STLD_WINDP_DLG_AREA_CH2019 };
