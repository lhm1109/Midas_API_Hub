#if !defined(AFX_StructStripDlg_H__70E9CCA6_3443_11D3_8899_0000C0A2329D__INCLUDED_)
#define AFX_StructStripDlg_H__70E9CCA6_3443_11D3_8899_0000C0A2329D__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// StructStripDlg.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CStructStripDlg form view
#ifndef __AFXEXT_H__
#include <afxext.h>
#endif
...
class CStructStripDlg : public MChildFormView
{
protected:
	CStructStripDlg();           // protected constructor used by dynamic creation
 	DECLARE_DYNCREATE(CStructStripDlg)

// Form Data
public:
	
	//{{AFX_DATA(CStructStripDlg)
	enum { IDD = IDD_TM_STRIP };
...
#endif // !defined(AFX_StructStripDlg_H__70E9CCA6_3443_11D3_8899_0000C0A2329D__INCLUDED_)
