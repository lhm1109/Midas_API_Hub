// StructStripDlg.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CStructStripDlg, MChildFormView)

CStructStripDlg::CStructStripDlg()
	: MChildFormView(CStructStripDlg::IDD)
{
	//{{AFX_DATA_INIT(CStructStripDlg)
	//}}AFX_DATA_INIT
...
// (����)
	T_COMBO_ITEM aItem[] = {
		{ D_PROD_GEN                       , _LS(IDS_TM_Assign_Strip) },
...
void CStructStripDlg::DoDataExchange(CDataExchange* pDX)
{
	MChildFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CStructStripDlg)
...
BEGIN_MESSAGE_MAP(CStructStripDlg, MChildFormView)
	//{{AFX_MSG_MAP(CStructStripDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CStructStripDlg diagnostics

#ifdef _DEBUG
void CStructStripDlg::AssertValid() const
{
	MChildFormView::AssertValid();
}

void CStructStripDlg::Dump(CDumpContext& dc) const
{
...
/////////////////////////////////////////////////////////////////////////////
// CStructStripDlg message handlers

void CStructStripDlg::OnInitialUpdate() 
{
	...
	//m_gbStartNum.InitControl(this, CStructStripDlg::IDD, IDC_TM_START_STC,TRUE,FALSE,3,4);
}

// (����)
void CStructStripDlg::CreateChildDlgs()
{
	m_nCurChildDlg = -1; 
	
	m_ChildDlgs.Add(new CStripAssignDlg());
	m_DlgIDs.Add(__TMMODE_STRUCT_STRIP_ASSIGN__);
	m_TableIDs.Add(0);
}

void CStructStripDlg::AdjustComboListBox()
{
	CString str;
	CSize   sz;
	int     dx=0;
...
void CStructStripDlg::InitComboMenu()
{
	int wHeight;
...
// Combo Menu���ÿ� ���� ��Ȳ�ݿ��� ���Ѵ�. 
void CStructStripDlg::OnComboMenuSelect() 
{
...
void CStructStripDlg::ShowExecuteButton(UINT nShowHide)
{
	//CWnd * pWnd;
...
void CStructStripDlg::OnTmExecAndClose(BOOL bExecute)
{
	if (bExecute)
		OnTmExecute();
	else
...
int  CStructStripDlg::_GetHeightFromFont()
{
...
BOOL CStructStripDlg::ShowChildDlgByID(int nID)
{
	if(nID == __TMMODE_STRUCT_STRIP_ASSIGN__)
	{
		ShowCurChildDlg(0);  
		m_ComboMenu.SetCurSel(0);
		return TRUE;
...
void CStructStripDlg::ShowCurChildDlg(int nDlgIndex)
{
...
void CStructStripDlg::DeleteChildDlgs()
{
...
void CStructStripDlg::InitContent()
{
	CDBDoc* pDoc = (CDBDoc*)CTreeMenuBarBase::GetDocST();
}

void CStructStripDlg::OnTmTableBtn() 
{
	// TODO: Add your control notification handler code here
...
/////////////////////////////////////////////////////////////////////
// By L.C.G
void CStructStripDlg::OnTabSelect(WPARAM wParam,LPARAM lParam)
{
...
/////////////////////////////////////////////////////////////////////
// By L.C.G
void CStructStripDlg::OnTabUnSelect(WPARAM wParam,LPARAM lParam)
{
	int nCurSel = m_ComboMenu.GetCurSel();
	if (nCurSel < 0 || nCurSel >= m_ComboMenu.GetCount()) return;
	if (0 > m_nCurChildDlg || m_nCurChildDlg >= m_ComboMenu.GetCount()) return;
...
CWnd* CStructStripDlg::GetDlgByID(int Mode)
{
...
void CStructStripDlg::SetHolderSize(int nHeight)
{
