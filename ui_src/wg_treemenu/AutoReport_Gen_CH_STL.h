...
class CEngineBase;
class I_GPSModel;
class  AutoReport_Gen_CH_STL :public AutoReport_Gen_Base
{
protected:
...
private:
	...
	void WriteTable3_4_2(GenSegmentElements &Elems);
...
private:
	void SetConcInfo(const T_MATD_D& data,CStringArray& strArray);
	...
	double GetBz();
	CString EmbellishStr(const CString& str){return m_strFormat+str;}
private:
