#if !defined(__TM_STLD_WIND_AREA_KBC2009_H__)
#define __TM_STLD_WIND_AREA_KBC2009_H__
...
class CStldWindPressureAreaDlg_KBC2009: public CCMWindPressureBaseChildDlg
{
	// Construction
public:
	CStldWindPressureAreaDlg_KBC2009(CWnd* pParent = NULL);   // standard constructor
	...
	enum { IDD = IDD_TM_STLD_WINDP_DLG_AREA_KBC2009 };  
