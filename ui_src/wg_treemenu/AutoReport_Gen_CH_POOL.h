...
class I_GPSModel;
class CRCSCodeCheck;
class  AutoReport_Gen_CH_POOL :public AutoReport_Gen_Base
{
protected:
...
private:
	...
	void WriteCharpt6_1_TableMaxElemInSbdo(CArray<CStringArray, CStringArray&>& recond, const T_SBDO_D& SbdoD, const T_ELEM_K_LIST& aSbdoElem, int nIndex, const CString& strLoad, int nDir, CRCSCodeCheck* pCodeCheck);
	void WriteCharpt6_2(GenSegmentElements &Elems);
	BOOL WriteCharpt6_2_TableMaxElemInSbdo(CArray<CStringArray, CStringArray&>& recond, const T_SBDO_D& SbdoD, const T_ELEM_K_LIST& aSbdoElem, int nIndex, const CString& strLoad, int nDir, CRCSCodeCheck* pCodeCheck);
private:
