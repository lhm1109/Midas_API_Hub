// CMWindItemKBC2016.cpp : implementation file
//
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureNodalDlg_KBC2016 dialog

CStldWindPressureNodalDlg_KBC2016::CStldWindPressureNodalDlg_KBC2016(CWnd* pParent /*=NULL*/)
: CCMWindPressureBaseChildDlg(CStldWindPressureNodalDlg_KBC2016::IDD, pParent)
{
	m_pData = NULL;
	m_bInAutoCalc = FALSE;
...
void CStldWindPressureNodalDlg_KBC2016::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CStldWindPressureNodalDlg_KBC2016, CCMWindPressureBaseChildDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureNodalDlg_KBC2016 message handlers

BOOL CStldWindPressureNodalDlg_KBC2016::OnInitDialog() 
{
...
BOOL CStldWindPressureNodalDlg_KBC2016::DestroyWindow() 
{
...
void CStldWindPressureNodalDlg_KBC2016::InitDefaultData()
{
}

BOOL CStldWindPressureNodalDlg_KBC2016::Dlg2Data( void* pData, BOOL bWarning )
{
	SetMemberData(pData);
...
void CStldWindPressureNodalDlg_KBC2016::Data2Dlg( void* pData, BOOL bWarning )
{
	SetMemberData(pData);
	...
	if(m_pParent->GetWvepKey(WvepK))
	{
		...
		T_WVEP_KBC2016* pWvepData = m_pData->nCodeType == KBC_W_2016 ? &WvepD.CodeParam.KBC2016 : &WvepD.CodeParam.KDS2019;
...
void CStldWindPressureNodalDlg_KBC2016::OnCmdGustFactor()
{
	m_bInAutoCalc = TRUE;
...
void CStldWindPressureNodalDlg_KBC2016::OnCmdVibrationBtn() 
{
	if(m_pData->GetKBC2016()== NULL) { ASSERT(0); return; }
...
void CStldWindPressureNodalDlg_KBC2016::OnCmdBuildingTypeRadio()
{
	int nBuildingType = 0;
...
void CStldWindPressureNodalDlg_KBC2016::OnCmdWindTypeCheck()
{
	int nBuildingType = 0;
	CDlgUtil::CtrlRadioGetCheck(this, m_aCtrlBuildingType, nBuildingType);
...
void CStldWindPressureNodalDlg_KBC2016::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
	HWND hWnd;
...
void CStldWindPressureNodalDlg_KBC2016::UpdateBuffer()
{
