// ReportTableDlg.h: interface for the CReportTableDlg class.
//////////////////////////////////////////////////////////////////////

#if !defined(__REPORTTABLEDLG_H__)
#define __REPORTTABLEDLG_H__
...
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CReportTableDlg : public CDialogMove
{
// Construction
public:
	CReportTableDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CReportTableDlg();
	
// Dialog Data
	//{{AFX_DATA(CReportTableDlg)
	enum { IDD = IDD_TM_REPORT_TABLE_DLG };
	CString   m_strName;
	//}}AFX_DATA
...
#endif // !defined(__REPORTTABLEDLG_H__)
