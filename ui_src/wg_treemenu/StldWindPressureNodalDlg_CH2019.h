#if !defined(__TM_STLD_WIND_NODAL_CH2019_H__)
#define __TM_STLD_WIND_NODAL_CH2019_H__
...
class CStldWindPressureNodalDlg_CH2019 : public CCMWindPressureBaseChildDlg
{
	// Construction
public:
	CStldWindPressureNodalDlg_CH2019(CWnd* pParent = NULL);   // standard constructor
	...
	enum { IDD = IDD_TM_STLD_WINDP_DLG_NODAL_CH2019 };
