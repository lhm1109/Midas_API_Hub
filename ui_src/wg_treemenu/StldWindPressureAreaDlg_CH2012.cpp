...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureAreaDlg_CH2012 dialog

CStldWindPressureAreaDlg_CH2012::CStldWindPressureAreaDlg_CH2012(CWnd* pParent /*=NULL*/)
: CCMWindPressureBaseChildDlg(CStldWindPressureAreaDlg_CH2012::IDD, pParent)
{
	m_pData = NULL;
	m_nPeriodType = 1;
}

void CStldWindPressureAreaDlg_CH2012::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CStldWindPressureAreaDlg_CH2012, CCMWindPressureBaseChildDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CStldWindPressureAreaDlg_CH2012 message handlers

BOOL CStldWindPressureAreaDlg_CH2012::OnInitDialog() 
{
...
BOOL CStldWindPressureAreaDlg_CH2012::DestroyWindow() 
{
...
BOOL CStldWindPressureAreaDlg_CH2012::Dlg2Data( void* pData, BOOL bWarning )
{
...
void CStldWindPressureAreaDlg_CH2012::Data2Dlg( void* pData, BOOL bWarning )
{
	m_pData = (T_WDPR_D*)pData;
...
int CStldWindPressureAreaDlg_CH2012::GetType()
{
	int nType = 1;
...
void CStldWindPressureAreaDlg_CH2012::InitControl()
{
...
void CStldWindPressureAreaDlg_CH2012::OnChkConsiderPartition()
{
	BOOL bEnable;
	if(((CButton*)GetDlgItem(IDC_TM_WIND_CONSIDER_PARTITION))->GetCheck())
		bEnable = TRUE;
...
void CStldWindPressureAreaDlg_CH2012::OnChkConsiderWindShield()
{
	BOOL bEnable;
	if(((CButton*)GetDlgItem(IDC_TM_WIND_CONSIDER_WINDSHIELD))->GetCheck())
		bEnable = TRUE;
...
void CStldWindPressureAreaDlg_CH2012::OnChkConsiderCrossWind()
{
	BOOL bEnable;
	if(((CButton*)GetDlgItem(IDC_TM_WIND_CROSS_CHECK))->GetCheck())
		bEnable = TRUE;
...
// void CStldWindPressureAreaDlg_CH2012::OnChkConsiderComfort()
// {
//   BOOL bEnable;
//   if(((CButton*)GetDlgItem(IDC_TM_WIND_CFT_CHECK))->GetCheck())
//     bEnable = TRUE;
...
void CStldWindPressureAreaDlg_CH2012::OnBtnPeriod()
{
	int nStore;
...
void CStldWindPressureAreaDlg_CH2012::OnBtnCrossWind()
{
...
void CStldWindPressureAreaDlg_CH2012::OnBtnPeriod2()
{
	int nStore;
	double dHeight, dWidth;  
...
void CStldWindPressureAreaDlg_CH2012::OnCmdWindAlongCheck()
{
