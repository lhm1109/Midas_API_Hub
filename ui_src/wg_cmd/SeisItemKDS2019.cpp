// SeisItemKDS2019.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemKDS2019 dialog


CSeisItemKDS2019::CSeisItemKDS2019(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemKDS2019::IDD, pParent)
{
...
void CSeisItemKDS2019::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisItemKDS2019)
	...
	DDX_Control(pDX, IDC_CMD_NOT_CONSIDER_CU_CHK, m_chkNotConsiderCu);
...
BEGIN_MESSAGE_MAP(CSeisItemKDS2019, CChildDialog)
	//{{AFX_MSG_MAP(CSeisItemKDS2019)
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemKDS2019 message handlers

BOOL CSeisItemKDS2019::OnInitDialog()
{
	CChildDialog::OnInitDialog();

	m_chkNotConsiderCu.ShowWindow(SW_HIDE);
	m_chkNotConsiderCu.EnableWindow(FALSE);
...
BOOL CSeisItemKDS2019::DestroyWindow()
{
	if (m_pParent != NULL)
	{
...
void CSeisItemKDS2019::CtrlManager()
{
	int nPeriodMethod;
...
void CSeisItemKDS2019::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemKDS2019::IDD, IDC_WG_CMD_STATIC0, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

void CSeisItemKDS2019::SetData2Dlg(T_SEIS_KDS2019& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemKDS2019::SetDlg2Data(T_SEIS_KDS2019& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemKDS2019::InitDefaultData()
{
...
void CSeisItemKDS2019::SetComboValue()
{
...
void CSeisItemKDS2019::SetFaFvSdsSd1()
{
	CString str;
...
void CSeisItemKDS2019::SetSeisDesignCategory()
{
	...
	CDBDoc* pDoc = CDBDoc::GetDocPoint();
	if (!pDoc->m_pAttrCtrl->CalcKBC2009SeisDesignCategory(nSeisUseGroup, dSds, dSd1, SDC_S, SDC_1, SDC)) return;
...
void CSeisItemKDS2019::SetImportanceFactor()
{
...
void CSeisItemKDS2019::OnSelchangeCmdSiteCmb()
{
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
}

void CSeisItemKDS2019::OnSelchangeCmdZoneCmb()
{
	SetComboValue();
...
void CSeisItemKDS2019::OnSelchangeCmdZoneFactorCmb()
{
...
void CSeisItemKDS2019::OnChangeCmdZoneFactor()
{
	int nSiteClass = m_cmbSiteClass.GetCurSel();
	if (nSiteClass == 5) return;
...
void CSeisItemKDS2019::OnChangeCmdFaEdit()
{
	int nSiteClass = m_cmbSiteClass.GetCurSel();
	if (nSiteClass == 5) return;
...
void CSeisItemKDS2019::OnChangeCmdFvEdit()
{
	int nSiteClass = m_cmbSiteClass.GetCurSel();
	if (nSiteClass == 5) return;
...
void CSeisItemKDS2019::OnChangeCmdSdsEdit()
{
	SetSeisDesignCategory();
}

void CSeisItemKDS2019::OnChangeCmdSd1Edit()
{
	double dSd1 = m_editSd1.GetEditValue();
	double dCu;
...
void CSeisItemKDS2019::OnSelchangeCmdUseGroupCmb()
{
	SetImportanceFactor();
	SetSeisDesignCategory();
}

void CSeisItemKDS2019::OnCmdPeriodBtn()
{
...
void CSeisItemKDS2019::OnCmdPeriodRdo()
{
	CtrlManager();
	OnChangeCmdPeriodEdit();
}

void CSeisItemKDS2019::OnChangeCmdPeriodEdit()
{
...
void CSeisItemKDS2019::InitZoneCombo()
{
...
void CSeisItemKDS2019::InitZoneFactorCombo()
{
...
void CSeisItemKDS2019::InitSiteCombo()
{
...
void CSeisItemKDS2019::InitUseGroupCombo()
{
...
void CSeisItemKDS2019::InitImportanceFactorCombo()
{
...
void CSeisItemKDS2019::InitRxRyCombo()
{
	CString aItem[15] = {
		_T("1.25"), _T("1.5"), _T("2.5"), _T("3"), _T("3.25"), _T("3.5"), _T("4"), _T("4.5"), _T("5"), _T("5.5"),
		_T("6"), _T("6.5"), _T("7"), _T("7.5"), _T("8")
	};
...
void CSeisItemKDS2019::Data2Dlg()
{
	CString csValue;
	...
	m_chkNotConsiderCu.SetCheck(m_Data.bNotConsiderCu);
...
BOOL CSeisItemKDS2019::Dlg2Data()
{
	CString str;
	...
	m_Data.bNotConsiderCu = m_chkNotConsiderCu.GetCheck();
	...
	m_Data.dPeriodFinalX = pDoc->m_pAttrCtrl->CalcFundamentalPeriodKBC2009(
		nCodeType, m_Data.nPeriodMethod, m_Data.dPeriodAnalX, m_Data.dPeriodApprX, m_Data.dPeriodCoef);
	m_Data.dPeriodFinalY = pDoc->m_pAttrCtrl->CalcFundamentalPeriodKBC2009(
		nCodeType, m_Data.nPeriodMethod, m_Data.dPeriodAnalY, m_Data.dPeriodApprY, m_Data.dPeriodCoef);
...
LRESULT CSeisItemKDS2019::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
