// SeisItemKorea2000.cpp : implementation file
//
// 2003. 12 30   by TAE
/////////////////////////////////////////////////////////////////////////////
...
CSeisItemKorea2000::CSeisItemKorea2000(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemKorea2000::IDD, pParent)
{
	//{{AFX_DATA_INIT(CSeisItemKorea2000)
	//}}AFX_DATA_INIT

	m_aSoilName.RemoveAll();
	m_aSoilData.RemoveAll();
	m_aSoilName.Add(_T("S1(1.0)")); m_aSoilData.Add(1.0);
	m_aSoilName.Add(_T("S2(1.2)")); m_aSoilData.Add(1.2);
	m_aSoilName.Add(_T("S3(1.5)")); m_aSoilData.Add(1.5);
	m_aSoilName.Add(_T("S4(2.0)")); m_aSoilData.Add(2.0);

	m_aAreaName.RemoveAll();
	m_aAreaData.RemoveAll();
	m_aAreaName.Add(_LS(IDS_WG_CMD__ADD2__Area1_0_11_)); m_aAreaData.Add(0.11);
	m_aAreaName.Add(_LS(IDS_WG_CMD__ADD2__Area2_0_07_)); m_aAreaData.Add(0.07);

	m_aIFactorName.RemoveAll();
	m_aIFactorData.RemoveAll();
	m_aIFactorName.Add(_T("0.8")); m_aIFactorData.Add(0.8);
	m_aIFactorName.Add(_T("1.0")); m_aIFactorData.Add(1.0);
	m_aIFactorName.Add(_T("1.2")); m_aIFactorData.Add(1.2);
	m_aIFactorName.Add(_T("1.5")); m_aIFactorData.Add(1.5);
...
void CSeisItemKorea2000::SetData2Dlg(T_SEIS_KS2000& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemKorea2000::SetDlg2Data(T_SEIS_KS2000& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemKorea2000::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisItemKorea2000)
...
BEGIN_MESSAGE_MAP(CSeisItemKorea2000, CChildDialog)
	//{{AFX_MSG_MAP(CSeisItemKorea2000)
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemKorea2000 message handlers

BOOL CSeisItemKorea2000::OnInitDialog() 
{
...
void CSeisItemKorea2000::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemKorea2000::IDD, IDC_CMD_FRAME1, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

BOOL CSeisItemKorea2000::DestroyWindow() 
{
...
void CSeisItemKorea2000::OnCmdBtnCalcPeriod() 
{
...
void CSeisItemKorea2000::InitDefaultData()
{
...
void CSeisItemKorea2000::InitSFactorCombo()
{
...
void CSeisItemKorea2000::InitZFactorCombo()
{
...
void CSeisItemKorea2000::InitIFactorCombo()
{
...
void CSeisItemKorea2000::Data2Dlg()
{
	int i;
	T_PREFERENCE  ref;
...
BOOL CSeisItemKorea2000::Dlg2Data()
{
	int nIndex;
	CString str;
...
LRESULT CSeisItemKorea2000::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
