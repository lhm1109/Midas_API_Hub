#if !defined(AFX_PsllItemMOE2018_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_)
#define AFX_PsllItemMOE2018_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_
...
class CPsllItemMOE2018 : public CChildDialog
{
// Construction
public:
	CPsllItemMOE2018(CWnd* pParent = NULL);   // standard constructor

	 void SetData2Dlg(T_PSLL_MOE2018& data, BOOL bModify, int nMethod);
	 BOOL SetDlg2Data(T_PSLL_MOE2018& data);

// Dialog Data
	//{{AFX_DATA(CPsllItemMOE2018)
	enum { IDD = IDD_ETC_PSLL_ITEM_MOE2018 };
...
protected:
	...
	double  m_dC;
	double  m_dJ;
	BOOL    m_bNotConsiderCu;
// Implementation
protected:

	// Generated message map functions
	//{{AFX_MSG(CPsllItemMOE2018)
	...
	afx_msg void OnChangeCmdDepth2MREdit();
...
#endif // !defined(AFX_PsllItemMOE2018_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_)
