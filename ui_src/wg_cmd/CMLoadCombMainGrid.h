#if !defined(AFX_CMLOADCOMBMAINGRID_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_CMLOADCOMBMAINGRID_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMLoadCombMainGrid.h : header file
//
...
/*
	#define D_LCOM_CT_LINEAR    "Linear"
	#define D_LCOM_CT_PSRSS     "+SRSS"
	#define D_LCOM_CT_MSRSS     "-SRSS"
*/

class CCMLoadCombSubGrid;

/////////////////////////////////////////////////////////////////////////////
// CCMLoadCombMainGrid window

class CCMLoadCombMainGrid : public CTBCommon
{
// Construction
public:
	CCMLoadCombMainGrid();
	virtual ~CCMLoadCombMainGrid();

// Attributes
public:
	static CString m_aCurDefVal[];
	CCMLoadCombSubGrid* m_pSubGrid;

// Operations
public:
	void Initialize(CDBDoc* pDoc, T_UNIT_SYSTEM &UnitSystem);

	BOOL DeleteRecordByKey(const T_LCOM_K &key, const T_LCOM_D &data);
	BOOL InsertRecordByKey(const T_LCOM_K &key, const T_LCOM_D &data);
	...
	virtual BOOL ValidateAndMakeRecord(CStringArray &value, CRowColArray &aCols, T_LCOM_K &key, T_LCOM_D &data);
...
// Implementation
public:
	BOOL GetValue(ROWCOL nRow, T_LCOM_K &key, T_LCOM_D &data);
	BOOL SetValue(ROWCOL nRow, const T_LCOM_K &key, const T_LCOM_D &data);
	BOOL SetValue(CGXData* pData, ROWCOL nRow, const T_LCOM_K &key, const T_LCOM_D &data, CRowColArray &awCols);
	void ConvStrToData(int i, CString& value, T_LCOM_D& data);
	void ConvDataToStr(int i, const T_LCOM_D& data, CString& value);

	void GetAllSelectedLcom(CArray<T_LCOM_K, T_LCOM_K>& aSelKey);
	void MakeSearchKey(const T_LCOM_K &key, const T_LCOM_D &data, CStringArray &aKey);
...
protected:
	...
	void resizeElastColumn(BOOL bElastHide);
	...
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
	CArray<T_LCOM_K, T_LCOM_K> m_aSelectedKeys;
...
#endif // !defined(AFX_CMLOADCOMBMAINGRID_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
