...
class __MY_EXT_CLASS__ CDrawArrowPolyline : public CDrawBase  
{
public:
	CDrawArrowPolyline();
	virtual ~CDrawArrowPolyline();

public:
	T_ARROWPOLYLINE_R_GROUP m_DataR;
	T_ARROWPOLYLINE_GROUP   m_Data;

	// Overrides ※주의:현재(08.03.4)화살표형상에 대한 영역은 고려하지 않습니다.
public:
