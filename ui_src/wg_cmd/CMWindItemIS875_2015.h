#if !defined(__CMWINDITEMIS875_2015_H__)
#define __CMWINDITEMIS875_2015__H__
...
class CCMWindItemIS875_2015 : public CChildDialog
{
// Construction
public:
	CCMWindItemIS875_2015(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	enum { IDD = IDD_ETC_WIND_ITEM_IS875_2016 };
...
protected:
	...
	CArray<UINT, UINT> m_aCtrlGustFactorParamBtn;

	int    m_iStrKind;
	double m_dBeta;
	double m_dAlongWind;
	double m_dAcrossWind;
	double m_dGustFactor;
	int    m_iFactk;
	double m_dCfs;
	double m_dMc;
	BOOL   m_bIsUSerDefGustFact;
// Implementation
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedCmdGustFactBtn();
};
