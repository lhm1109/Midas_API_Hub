#if !defined(AFX_ETC_GDS_KBC2009_H__764B3BE8_32DC_43AF_9CE2_0E11FB2C9D56__INCLUDED_)
#define AFX_ETC_GDS_KBC2009_H__764B3BE8_32DC_43AF_9CE2_0E11FB2C9D56__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// ETC_GDS_KBC2009.h : header file
//
...
class CETC_GDS_KBC2009 : public CMyChildDialog
{
// Construction
public:
	CETC_GDS_KBC2009(T_SPFC_D* pParamData, CWnd* pParent = NULL);   // standard constructor
	void End();
	void EndNotClose(){};
	BOOL ISVALID();
	void SetValue();
...
// Dialog Data
	//{{AFX_DATA(CETC_GDS_KBC2009)
	enum { IDD = IDD_ETC_GDS_KBC2009 };
...
protected:
	...
	std::shared_ptr<CSpfcKBC2009Util> m_pSpfcUtil;
...
#endif // !defined(AFX_ETC_GDS_KBC2009_H__764B3BE8_32DC_43AF_9CE2_0E11FB2C9D56__INCLUDED_)
