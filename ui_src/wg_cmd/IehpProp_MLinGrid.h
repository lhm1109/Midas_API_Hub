#if !defined(AFX_IEHPPROP_MLINGRID_H__5B311B43_B86C_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_IEHPPROP_MLINGRID_H__5B311B43_B86C_11D3_92DE_0000C0B0E6B3__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// CIehpProp_MLinGrid window
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CIehpProp_MLinGrid : public CTBCommon
{
// Construction
public:
	CIehpProp_MLinGrid();
...
// Operations
public:
	void Initialize(T_IEHP_MULT* pData, T_UNIT_SYSTEM &UnitSystem, int nDof, int nHingeType, BOOL bPmmcML=FALSE);
	void SetData(T_IEHP_MULT* pData);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CIehpProp_MLinGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CIehpProp_MLinGrid();

	// Generated message map functions
protected:
	//{{AFX_MSG(CIehpProp_MLinGrid)
...
#endif // !defined(AFX_IEHPPROP_MLINGRID_H__5B311B43_B86C_11D3_92DE_0000C0B0E6B3__INCLUDED_)
