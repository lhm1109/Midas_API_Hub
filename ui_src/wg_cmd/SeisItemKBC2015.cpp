// SeisItemKBC2015.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemKBC2015 dialog


CSeisItemKBC2015::CSeisItemKBC2015(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemKBC2015::IDD, pParent)
{
...
void CSeisItemKBC2015::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisItemKBC2015)
...
BEGIN_MESSAGE_MAP(CSeisItemKBC2015, CChildDialog)
	//{{AFX_MSG_MAP(CSeisItemKBC2015)
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemKBC2015 message handlers

BOOL CSeisItemKBC2015::OnInitDialog()
{
...
void CSeisItemKBC2015::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemKBC2015::IDD, IDC_WG_CMD_STATIC0, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

BOOL CSeisItemKBC2015::DestroyWindow()
{
	if (m_pParent != NULL)
	{
...
void CSeisItemKBC2015::CtrlManager()
{
	int nPeriodMethod;
...
void CSeisItemKBC2015::SetData2Dlg(T_SEIS_KBC2015& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemKBC2015::SetDlg2Data(T_SEIS_KBC2015& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemKBC2015::InitDefaultData()
{
...
void CSeisItemKBC2015::SetComboValue()
{
...
void CSeisItemKBC2015::SetFaFvSdsSd1()
{
	int nSeismicZone = m_cmbSeisZone.GetCurSel();
	CString str;
...
void CSeisItemKBC2015::SetSeisDesignCategory()
{
...
void CSeisItemKBC2015::SetImportanceFactor()
{
...
void CSeisItemKBC2015::OnSelchangeCmdSiteCmb()
{
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
}

void CSeisItemKBC2015::OnSelchangeCmdZoneCmb()
{
	SetComboValue();
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
...
void CSeisItemKBC2015::OnSelchangeCmdZoneFactorCmb()
{
...
void CSeisItemKBC2015::OnChangeCmdZoneFactor()
{
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
}

void CSeisItemKBC2015::OnChangeCmdDepth2MREdit()
{
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
}

void CSeisItemKBC2015::OnChangeCmdFaEdit()
{
	CString str;
...
void CSeisItemKBC2015::OnChangeCmdFvEdit()
{
	CString str;
...
void CSeisItemKBC2015::OnChangeCmdSdsEdit()
{
	SetSeisDesignCategory();
}

void CSeisItemKBC2015::OnChangeCmdSd1Edit()
{
	double dSd1 = m_editSd1.GetEditValue();
	double dCu;
...
void CSeisItemKBC2015::OnSelchangeCmdUseGroupCmb()
{
	SetImportanceFactor();
	SetSeisDesignCategory();
}

void CSeisItemKBC2015::OnCmdPeriodBtn()
{
...
void CSeisItemKBC2015::OnCmdPeriodRdo()
{
	CtrlManager();
	OnChangeCmdPeriodEdit();
}

void CSeisItemKBC2015::OnChangeCmdPeriodEdit()
{
...
void CSeisItemKBC2015::InitZoneCombo()
{
...
void CSeisItemKBC2015::InitZoneFactorCombo()
{
...
void CSeisItemKBC2015::InitSiteCombo()
{
...
void CSeisItemKBC2015::InitUseGroupCombo()
{
...
void CSeisItemKBC2015::InitImportanceFactorCombo()
{
...
void CSeisItemKBC2015::InitRxRyCombo()
{
	CString aItem[15] = {
...
void CSeisItemKBC2015::Data2Dlg()
{
	CString csValue;
...
BOOL CSeisItemKBC2015::Dlg2Data()
{
	CString str;
...
LRESULT CSeisItemKBC2015::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
