...
BOOL __bIsNotOnInitialUpdate = TRUE;
/////////////////////////////////////////////////////////////////////////////
// CEigvDlg dialog


CEigvDlg::CEigvDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CEigvDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CEigvDlg)
	m_bNLLinkVect = FALSE;
	m_nEigenRitz = 0;
	m_nSubLanc = 0;
	m_bSTRUM=0;
...
void CEigvDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CEigvDlg)
...
BEGIN_MESSAGE_MAP(CEigvDlg, CDialogMove)
	//{{AFX_MSG_MAP(CEigvDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CEigvDlg message handlers
BOOL CEigvDlg::OnInitDialog() 
{
	__bIsNotOnInitialUpdate = FALSE;
...
void CEigvDlg::OnAnaltypeRadio() 
{
	UpdateData(TRUE);
	CtrlMan();
}

void CEigvDlg::MakeCaseListHeader()
{
...
void CEigvDlg::OnLcDeleteButton() 
{
	// TODO: Add your control notification handler code here
...
void CEigvDlg::OnLcModifyButton() 
{
	// TODO: Add your control notification handler code here
...
void CEigvDlg::ShowCurLoadCaseData()
{
...
void CEigvDlg::OnItemchangedLcList(NMHDR* pNMHDR, LRESULT* pResult) 
{
	ShowCurLoadCaseData();	
	*pResult = 0;
}

void CEigvDlg::OnClickLcList(NMHDR* pNMHDR, LRESULT* pResult) 
{
	ShowCurLoadCaseData();	
	*pResult = 0;
}

void CEigvDlg::OnIncNlLinkFvectorCheck() 
{
	UpdateData(TRUE);
	// TODO: Add your control notification handler code here
	NLLVCtrlMan();	
...
void CEigvDlg::DisplayRitzVectorNumber()
{
...
void CEigvDlg::OnChangeNlLinkVnumberEdit() 
{
	...
	// TODO: Add your control notification handler code here
	if(__bIsNotOnInitialUpdate)
		DisplayRitzVectorNumber();
	
}
void CEigvDlg::OnUseFRICheck()
{
	CArray<UINT,UINT> arTempCtrls;
	arTempCtrls.Add(IDC_EIGV_LOF_EDIT);
	arTempCtrls.Add(IDC_EIGV_UPF_EDIT);
...
void CEigvDlg::OnEIGVComplexRadio()
{
...
void CEigvDlg::CtrlComplex(BOOL bShow)
{
...
void CEigvDlg::ChangeComplexBtnText(int nType)
{
...
void CEigvDlg::OnEigvComplexBtn()
{
	UpdateData();
...
void CEigvDlg::OpenComplexMassDlg()
{
...
void CEigvDlg::OpenComplexElemDlg()
{
