...
class CSpfcJPBRG2012Util : public CSpfcBaseUtil
{
public:
	CSpfcJPBRG2012Util() = delete;
	CSpfcJPBRG2012Util(int nCode);
...
private:
	void GetSpectrumValue(double* dValue, double* dExp, int nMethod, int nCode);
