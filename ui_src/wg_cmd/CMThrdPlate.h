#if !defined(__WG_CMD_CMTHRDPLATE_H__)
#define __WG_CMD_CMTHRDPLATE_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMThrdPlate.h : header file
//
...
class CCMThrdPlate : public CCMChildBarBase
{
// Construction
public:
	CCMThrdPlate(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CCMThrdPlate)
	enum { IDD = IDD_DBAR_THRD_PLATE };
...
#endif // !defined(__WG_CMD_CMTHRDPLATE_H__)
