...
// CEigvDlg_MEC dialog
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CEigvDlg_MEC : public CDialogMove
{
// Construction
...
public:
	CEigvDlg_MEC(CWnd* pParent = NULL);   // standard constructor
	void CtrlMan();
	void NLLVCtrlMan();
...
// Dialog Data
	//{{AFX_DATA(CEigvDlg_MEC)
	enum { IDD = IDD_ETC_EIGV_MEC };
...
#endif // !defined(__EIGVDLG_MEC_H__)