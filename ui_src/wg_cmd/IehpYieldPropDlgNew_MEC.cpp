// IehpYieldPropDlgNew_MEC.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CIehpYieldPropDlgNew_MEC dialog


CIehpYieldPropDlgNew_MEC::CIehpYieldPropDlgNew_MEC(CWnd* pParent /*=NULL*/)
	: CDialogMove(CIehpYieldPropDlgNew_MEC::IDD, pParent)
{
	//{{AFX_DATA_INIT(CIehpYieldPropDlgNew_MEC)
	m_nPMInputType = 0;
	m_nYLDInputType = 0;
	...
	m_wndGrid = NULL;
	m_wndGrid = new CIehpYieldPropGrid_MEC(this);
...
CIehpYieldPropDlgNew_MEC::~CIehpYieldPropDlgNew_MEC()
{
	if (m_wndGrid != NULL)
	{
		delete m_wndGrid;
...
void CIehpYieldPropDlgNew_MEC::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CIehpYieldPropDlgNew_MEC)
...
BEGIN_MESSAGE_MAP(CIehpYieldPropDlgNew_MEC, CDialogMove)
	//{{AFX_MSG_MAP(CIehpYieldPropDlgNew_MEC)
...
/////////////////////////////////////////////////////////////////////////////
// CIehpYieldPropDlgNew_MEC message handlers

BOOL CIehpYieldPropDlgNew_MEC::OnInitDialog() 
{
...
void CIehpYieldPropDlgNew_MEC::OnOK() 
{
...
void CIehpYieldPropDlgNew_MEC::OnPMInputType() 
{
	UpdateData();
	Dlg2Data(TRUE);
...
void CIehpYieldPropDlgNew_MEC::OnYLDInputType() 
{
	UpdateData();
	Dlg2Data(TRUE);
...
void CIehpYieldPropDlgNew_MEC::SetInitData()
{
...
void CIehpYieldPropDlgNew_MEC::WndMessageCtrl()
{
	switch(m_nMessage)
	{
	case 0:
...
void CIehpYieldPropDlgNew_MEC::Data2Dlg()
{
...
void CIehpYieldPropDlgNew_MEC::PMData2Dlg(T_IEHP_YLDSUR& Data)
{
...
void CIehpYieldPropDlgNew_MEC::YLDData2Dlg(T_IEHP_YLDSUR& Data)
{
...
void CIehpYieldPropDlgNew_MEC::Dlg2Data(BOOL bUpdateRatios)
{
	UpdateData();
...
BOOL CIehpYieldPropDlgNew_MEC::CheckErrorNameDataVar(LPCTSTR lpszData, LPCTSTR lpszVar, BOOL bMsg)
{
...
BOOL CIehpYieldPropDlgNew_MEC::CheckDataCtrl(int nTabID, BOOL bMsg/*=TRUE*/)
{
	T_IEHP_YLDSUR Data;
...
void CIehpYieldPropDlgNew_MEC::OnSelchangePlotComb() 
{
	Dlg2Data(TRUE);
	if(!CheckDataCtrl(m_Tab.GetCurSel())) return;
...
void CIehpYieldPropDlgNew_MEC::OnChangeEditBox() 
{
	Dlg2Data(FALSE);
	if(!CheckDataCtrl(m_Tab.GetCurSel(),FALSE)) return;
...
void CIehpYieldPropDlgNew_MEC::OnKillFocusEditBox()
{
	//if(!CheckDataCtrl(m_Tab.GetCurSel(),FALSE)) return;
	Data2Dlg();
	UpdateData(TRUE);
...
void CIehpYieldPropDlgNew_MEC::OnPmcvGrid() 
{
	UpdateData();
...
/////////////////////////////////////////////////////////////////////
// Graph operations
void CIehpYieldPropDlgNew_MEC::InitGraph()
{
...
void CIehpYieldPropDlgNew_MEC::UpdateGraph(int nSel)
{
	//Dlg2Data();
...
BOOL CIehpYieldPropDlgNew_MEC::InitTabCtrl()
{
	UpdateData(TRUE);
...
BOOL CIehpYieldPropDlgNew_MEC::ChangeDlgCtrls()
{
...
void CIehpYieldPropDlgNew_MEC::ChangeTabCtrl()
{
	UpdateData(TRUE);
...
void CIehpYieldPropDlgNew_MEC::OnSelchangingTab(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void CIehpYieldPropDlgNew_MEC::OnSelchangeTab(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void CIehpYieldPropDlgNew_MEC::Data2TabDlg(int nTabID, T_IEHP_YLDSUR& Data)
{
	PMData2Dlg(Data);
	YLDData2Dlg(Data);
}
BOOL CIehpYieldPropDlgNew_MEC::TabDlg2Data(int nTabID, T_IEHP_YLDSUR& Data, BOOL bUpdateRatios)
{
...
void CIehpYieldPropDlgNew_MEC::OnValueTypeSymmetry()
{
	UpdateData(TRUE);
...
void CIehpYieldPropDlgNew_MEC::SetIehpPropData(T_IEHP_D iehpD, T_IEHP_YLDSUR data, T_IEHP_YLDSUR Subdata, 
...
void CIehpYieldPropDlgNew_MEC::Set3rdControl(BOOL bUse3rdCtrl)
{
	m_bUse3rdCtrl = bUse3rdCtrl;
}

void CIehpYieldPropDlgNew_MEC::SetIJDataExist(BOOL bExistIJData, int CurType)
{
...
void CIehpYieldPropDlgNew_MEC::BackupDisplayData()
{
	UpdateData(TRUE);
...
void CIehpYieldPropDlgNew_MEC::LoadDisplayBackupData()
{
	if(m_aBackupArr.GetSize() == 0) 
	{
		ASSERT(FALSE);
...
void CIehpYieldPropDlgNew_MEC::InitCtrl()
{
...
void CIehpYieldPropDlgNew_MEC::InitCtrl_Unable1stCtrl()
{
...
void CIehpYieldPropDlgNew_MEC::Init3rdYieldCtrl()
{
...
void CIehpYieldPropDlgNew_MEC::OnShowValueChk()
{
	Dlg2Data(TRUE);
