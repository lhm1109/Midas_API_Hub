...
/////////////////////////////////////////////////////////////////////////////
// CMWindItemChina2019PartDlg dialog
CMWindItemChina2019PartDlg::CMWindItemChina2019PartDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CMWindItemChina2019PartDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMWindItemChina2019PartDlg)  
	//}}AFX_DATA_INIT
}

void CMWindItemChina2019PartDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMWindItemChina2019PartDlg)  
	DDX_Control(pDX, IDC_CMD_GRID_PART, m_wndGrid);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMWindItemChina2019PartDlg, CDialogMove)
	//{{AFX_MSG_MAP(CMWindItemChina2019PartDlg)
...
// Implementations
//////////////////////////////////////////////////////////////////////////////
BOOL CMWindItemChina2019PartDlg::OnInitDialog()//(CArray<T_CHINA_WARD, T_CHINA_WARD&>& arDataList) 
{
...
void CMWindItemChina2019PartDlg::OnOK() 
{
...
void CMWindItemChina2019PartDlg::OnCancel() 
{
...
void CMWindItemChina2019PartDlg::InitGrid()
{
...
void CMWindItemChina2019PartDlg::SetGridTitle()
{
    BOOL bOldLock = m_wndGrid.LockUpdate(TRUE);
...
// Data -> Grid
void CMWindItemChina2019PartDlg::Data2Grid()
{
...
// Grid -> Data
BOOL CMWindItemChina2019PartDlg::Grid2Data()
{
    CDBDoc* pDoc = CDBDoc::GetDocPoint();
    ASSERT(pDoc);
    int error;
