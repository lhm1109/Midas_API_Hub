...
IMPLEMENT_DYNCREATE(CCMIepiMainDlg, MChildFormView)


CCMIepiMainDlg::CCMIepiMainDlg(CWnd* pParent /*=NULL*/)
	: MChildFormView(CCMIepiMainDlg::IDD)
{
	//{{AFX_DATA_INIT(CCMIepiMainDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT

	CArray<const TCHAR*, const TCHAR*> ComboStrs;
	ComboStrs.Add(_LS(IDS_DB_DT_IEPI));
...
CCMIepiMainDlg::~CCMIepiMainDlg()
{
	DeleteChildDlgs();
}

void CCMIepiMainDlg::DoDataExchange(CDataExchange* pDX)
{
	MChildFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMIepiMainDlg)
...
BEGIN_MESSAGE_MAP(CCMIepiMainDlg, MChildFormView)
	//{{AFX_MSG_MAP(CCMIepiMainDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCMIepiMainDlg message handlers

void CCMIepiMainDlg::CreateChildDlgs()
{ 
	m_nCurChildDlg = -1; 
	
	m_ChildDlgs.Add(new CCMIepiItemDlg);
	m_DlgIDs.Add(__TMMODE_CMD_IEPI__);
	m_TableIDs.Add(ID_QUERY_STRUCT_IEPI);  
}

void CCMIepiMainDlg::DeleteChildDlgs()
{
...
BOOL CCMIepiMainDlg::ShowChildDlgByID(int nID)
{
	if (nID == __TMMODE_CMD_IEPI__)
	{
...
void CCMIepiMainDlg::ShowCurChildDlg(int nDlgIndex)
{
...
void CCMIepiMainDlg::LayoutChildDialog()
{
	/////////////////////////////////////////////////////////////////////////
	// Layout Child Dialog...
	CRect DlgRect,ParentRect,PHRect;
...
int CCMIepiMainDlg::_GetHeightFromFont()
{
...
void CCMIepiMainDlg::InitComboMenu()
{  
...
void CCMIepiMainDlg::AdjustComboListBox()
{
	CString str;
	CSize   sz;
	int     dx=0;
...
void CCMIepiMainDlg::InitContent()
{
...
/////////////////////////////////////////////////////////////////////////////
// CCMIepiMainDlg message handlers
void CCMIepiMainDlg::OnInitialUpdate() 
{
...
void CCMIepiMainDlg::OnActivateView(BOOL bActivate, CView* pActivateView, CView* pDeactiveView) 
{	
	MChildFormView::OnActivateView(bActivate, pActivateView, pDeactiveView);
}

void CCMIepiMainDlg::OnComboMenuSelect() 
{
...
int CCMIepiMainDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CCMIepiMainDlg::OnCmdTableButton() 
{
...
CWnd* CCMIepiMainDlg::GetDlgByID(int nID)
{
