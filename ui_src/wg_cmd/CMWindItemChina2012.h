#if !defined(__CMWINDITEMCHINA2012_H__)
#define __CMWINDITEMCHINA2012_H__
...
class CCMWindItemChina2012 : public CChildDialog
{
// Construction
public:
	CCMWindItemChina2012(CWnd* pParent = NULL);   // standard constructor

	void SetData2Dlg(T_WIND_CH2012& data, BOOL bModify);
	BOOL SetDlg2Data(T_WIND_CH2012& data);

// Dialog Data
	//{{AFX_DATA(CCMWindItemChina2012)
	enum { IDD = IDD_ETC_WIND_ITEM_CHINA2012 };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCMWindItemChina2012)
	public:
...
#endif // !defined(__CMWINDITEMCHINA2012_H__)
