// CMSectItemPSCTee.cpp : implementation file
//
/////////////////////////////////////////////////////////////////////////////
...
CCMSectItemPSCTee::CCMSectItemPSCTee(CWnd* pParent /*=NULL*/)
	: CCMSectItemPSCBase(CCMSectItemPSCTee::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCMSectItemPSCTee)
	m_bJ1 = FALSE;
	m_bJL1 = FALSE;
	m_bJL2 = FALSE;
	m_bJL3 = FALSE;
	...
	m_pSectDB = NULL;
	m_pSectDB = new CCMSectItemPSCTeeDB();

	//-------------------------------------------------------------------
	// Make Group of Control
	//-------------------------------------------------------------------
	// Joint Group
	arJ1Group.Add(IDC_CMD_H1_EDIT);
	arJL1Group.Add(IDC_CMD_HL21_EDIT);  arJL1Group.Add(IDC_CMD_BL31_EDIT);
	arJL2Group.Add(IDC_CMD_HL22_EDIT);  arJL2Group.Add(IDC_CMD_BL32_EDIT);
	arJL3Group.Add(IDC_CMD_HL31_EDIT);  arJL3Group.Add(IDC_CMD_BL21_EDIT);
	arJL4Group.Add(IDC_CMD_HL32_EDIT);  arJL4Group.Add(IDC_CMD_BL22_EDIT);
	arJR1Group.Add(IDC_CMD_HR21_EDIT);  arJR1Group.Add(IDC_CMD_BR31_EDIT);
	arJR2Group.Add(IDC_CMD_HR22_EDIT);  arJR2Group.Add(IDC_CMD_BR32_EDIT);
	arJR3Group.Add(IDC_CMD_HR31_EDIT);  arJR3Group.Add(IDC_CMD_BR21_EDIT);
	arJR4Group.Add(IDC_CMD_HR32_EDIT);  arJR4Group.Add(IDC_CMD_BR22_EDIT);

	// Symmetry Group
	arSymmetryGroup.Add(IDC_CMD_HR1_EDIT);  arSymmetryGroup.Add(IDC_CMD_HR2_EDIT);
	arSymmetryGroup.Add(IDC_CMD_HR3_EDIT);  arSymmetryGroup.Add(IDC_CMD_BR1_EDIT);
	arSymmetryGroup.Add(IDC_CMD_BR2_EDIT);  arSymmetryGroup.Add(IDC_CMD_BR3_EDIT);
	arSymmetryGroup.Add(IDC_CMD_BR4_EDIT);
	arSymmetryGroup.Add(IDC_CMD_JR1_CHECK); arSymmetryGroup.Add(IDC_CMD_JR2_CHECK);
	arSymmetryGroup.Add(IDC_CMD_JR3_CHECK); arSymmetryGroup.Add(IDC_CMD_JR4_CHECK);
}

CCMSectItemPSCTee::~CCMSectItemPSCTee()
{
	if (m_pSectDB != NULL)
	{
		delete m_pSectDB;
...
void CCMSectItemPSCTee::DoDataExchange(CDataExchange* pDX)
{
	CCMSectItemPSCBase::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMSectItemPSCTee)
	...
	DDX_Check(pDX, IDC_CMD_PSC_SYMMETRY_CHECK, m_bSymmetry);
	DDX_Radio(pDX, IDC_CMD_WARPING_EFFECT_AUTO_RDO, m_nWarpingCheck);

	//}}AFX_DATA_MAP

	CArray<UINT , UINT > UnitIDs;
	UnitIDs.Add(IDC_CMD_H1_UNIT);   UnitIDs.Add(IDC_CMD_HL1_UNIT);
	UnitIDs.Add(IDC_CMD_HL2_UNIT);  UnitIDs.Add(IDC_CMD_HL3_UNIT);
	UnitIDs.Add(IDC_CMD_BL1_UNIT);  UnitIDs.Add(IDC_CMD_BL2_UNIT);
	UnitIDs.Add(IDC_CMD_BL3_UNIT);  UnitIDs.Add(IDC_CMD_BL4_UNIT);
	UnitIDs.Add(IDC_CMD_HL21_UNIT); UnitIDs.Add(IDC_CMD_HL22_UNIT);
	UnitIDs.Add(IDC_CMD_HL31_UNIT); UnitIDs.Add(IDC_CMD_HL32_UNIT);
	UnitIDs.Add(IDC_CMD_BL21_UNIT); UnitIDs.Add(IDC_CMD_BL22_UNIT);
	UnitIDs.Add(IDC_CMD_BL31_UNIT); UnitIDs.Add(IDC_CMD_BL32_UNIT);
	UnitIDs.Add(IDC_CMD_HR1_UNIT);  UnitIDs.Add(IDC_CMD_HR2_UNIT);
	UnitIDs.Add(IDC_CMD_HR3_UNIT);  UnitIDs.Add(IDC_CMD_BR1_UNIT);
	UnitIDs.Add(IDC_CMD_BR2_UNIT);  UnitIDs.Add(IDC_CMD_BR3_UNIT);
	UnitIDs.Add(IDC_CMD_BR4_UNIT);  UnitIDs.Add(IDC_CMD_HR21_UNIT);
	UnitIDs.Add(IDC_CMD_HR22_UNIT); UnitIDs.Add(IDC_CMD_HR31_UNIT);
	UnitIDs.Add(IDC_CMD_HR32_UNIT); UnitIDs.Add(IDC_CMD_BR21_UNIT);
	UnitIDs.Add(IDC_CMD_BR22_UNIT); UnitIDs.Add(IDC_CMD_BR31_UNIT);
	UnitIDs.Add(IDC_CMD_BR32_UNIT);
	for(int i=0; i<31; i++)
	{
	...
	EditIDs.Add(IDC_CMD_H1_EDIT);   EditIDs.Add(IDC_CMD_HL1_EDIT);
	EditIDs.Add(IDC_CMD_HL2_EDIT);  EditIDs.Add(IDC_CMD_HL3_EDIT);
	EditIDs.Add(IDC_CMD_BL1_EDIT);  EditIDs.Add(IDC_CMD_BL2_EDIT);
	EditIDs.Add(IDC_CMD_BL3_EDIT);  EditIDs.Add(IDC_CMD_BL4_EDIT);
	EditIDs.Add(IDC_CMD_HL21_EDIT); EditIDs.Add(IDC_CMD_HL22_EDIT);
	EditIDs.Add(IDC_CMD_HL31_EDIT); EditIDs.Add(IDC_CMD_HL32_EDIT);
	EditIDs.Add(IDC_CMD_BL21_EDIT); EditIDs.Add(IDC_CMD_BL22_EDIT);
	EditIDs.Add(IDC_CMD_BL31_EDIT); EditIDs.Add(IDC_CMD_BL32_EDIT);
	EditIDs.Add(IDC_CMD_HR1_EDIT);  EditIDs.Add(IDC_CMD_HR2_EDIT);
	EditIDs.Add(IDC_CMD_HR3_EDIT);  EditIDs.Add(IDC_CMD_BR1_EDIT);
	EditIDs.Add(IDC_CMD_BR2_EDIT);  EditIDs.Add(IDC_CMD_BR3_EDIT);
	EditIDs.Add(IDC_CMD_BR4_EDIT);  EditIDs.Add(IDC_CMD_HR21_EDIT);
	EditIDs.Add(IDC_CMD_HR22_EDIT); EditIDs.Add(IDC_CMD_HR31_EDIT);
	EditIDs.Add(IDC_CMD_HR32_EDIT); EditIDs.Add(IDC_CMD_BR21_EDIT);
	EditIDs.Add(IDC_CMD_BR22_EDIT); EditIDs.Add(IDC_CMD_BR31_EDIT);
	EditIDs.Add(IDC_CMD_BR32_EDIT);
	for(int i=0; i<31; i++)
	{
...
BEGIN_MESSAGE_MAP(CCMSectItemPSCTee, CCMSectItemPSCBase)
	//{{AFX_MSG_MAP(CCMSectItemPSCTee)
	...
	ON_BN_CLICKED(IDC_CMD_PSC_SYMMETRY_CHECK, OnCmdPscSymmetryCheck)
	...
	ON_EN_CHANGE(IDC_CMD_BL3_EDIT, OnChangeCmdLeftSize)
	ON_EN_CHANGE(IDC_CMD_BL31_EDIT, OnChangeCmdLeftSize)
	ON_EN_CHANGE(IDC_CMD_BL32_EDIT, OnChangeCmdLeftSize)
	ON_EN_CHANGE(IDC_CMD_BL4_EDIT, OnChangeCmdLeftSize)
	...
	ON_EN_CHANGE(IDC_CMD_BR3_EDIT, OnChangeCmdSize)
	ON_EN_CHANGE(IDC_CMD_BR31_EDIT, OnChangeCmdSize)
	ON_EN_CHANGE(IDC_CMD_BR32_EDIT, OnChangeCmdSize)
	ON_EN_CHANGE(IDC_CMD_BR4_EDIT, OnChangeCmdSize)
	...
	ON_EN_CHANGE(IDC_CMD_HL31_EDIT, OnChangeCmdLeftSize)
	ON_EN_CHANGE(IDC_CMD_HL32_EDIT, OnChangeCmdLeftSize)
	...
	ON_EN_CHANGE(IDC_CMD_HR31_EDIT, OnChangeCmdSize)
	ON_EN_CHANGE(IDC_CMD_HR32_EDIT, OnChangeCmdSize)
...
/////////////////////////////////////////////////////////////////////////////
// CCMSectItemPSCTee message handlers
...
//
BOOL CCMSectItemPSCTee::GetDlgData(void* pData)
{
	UpdateData(TRUE);

	// Window°¡ Á×±âÀü¿¡ ºÒ¸°´Ù.
	T_SECT_D * pSect = (T_SECT_D*) pData;  
	pSect->SectBefore.Shape  = D_SECT_SHAPE_PSC_T;
	...
	memcpy(pSect->SectBefore.dWarpingCheckPosI, m_SectData.SectBefore.dWarpingCheckPosI, sizeof(dWarpingCheckPos)); // I/J°°À½.
	...
	if (pSect->SectBefore.bSymmetric)
	{
		...
		for(int i=0; i<15; i++)
			pSect->SectBefore.SectI.Size[16+i] =  m_Edits[i+1].GetEditValue();
...
void  CCMSectItemPSCTee::SetCurDlgData(void* pData, BOOL bModify)
{
	m_bModify = bModify;
...
void CCMSectItemPSCTee::DisplayOffsetPoint()
{
...
void CCMSectItemPSCTee::SetAutotShearCheckPos(double dShearPos[3])
{
...
void CCMSectItemPSCTee::SetAutoMinWebThick(double dShear[3], double dTorsion)
{
	for (int i = 0; i < 3; i++)
	{
...
void CCMSectItemPSCTee::SetWarpingCheckPosition(double dWarpingCheckPosI[2][6], double dWarpingCheckPosJ[2][6])
{
	for (int i = 0; i < 3; i++)
	{
		for (int j = 0; j < 6; j++)
...
// Initialize
//
void CCMSectItemPSCTee::InitCtrlsData()
{
	m_bJ1 = FALSE;
	m_bJL1 = FALSE;
	m_bJL2 = FALSE;
...
void CCMSectItemPSCTee::UpdateCurDatas()
{
	InitCtrlsData();
...
void CCMSectItemPSCTee::UpdateCtrlsByJoint()
{
	UpdateData(TRUE);
	...
	CDlgUtil::CtrlEnableDisable(this, arJR1Group, m_jChk[4].GetCheck()&&!m_bSymmetry);
	CDlgUtil::CtrlEnableDisable(this, arJR2Group, m_jChk[5].GetCheck()&&!m_bSymmetry);
	CDlgUtil::CtrlEnableDisable(this, arJR3Group, m_jChk[6].GetCheck()&&!m_bSymmetry);
	CDlgUtil::CtrlEnableDisable(this, arJR4Group, m_jChk[7].GetCheck()&&!m_bSymmetry);

}

void CCMSectItemPSCTee::UpdateCtrlsBySymmetry()
{
	UpdateData(TRUE);
	CDlgUtil::CtrlEnableDisable(this, arSymmetryGroup, (!m_bSymmetry));
...
void CCMSectItemPSCTee::InitSectNameCombo()
{
...
BOOL CCMSectItemPSCTee::OnInitDialog() 
{
	...
	UpdateCurDatas();	
	UpdateCtrlsBySymmetry();
	UpdateCtrlsByJoint();

	RedrawSection();
	ChangeBitmap(__SECT_PSC_TEE__);
...
// OnOK
//
BOOL CCMSectItemPSCTee::DestroyWindow() 
{
...
void CCMSectItemPSCTee::SyncEditData(BOOL bSync)
{
	if(bSync)
	{
		for(int i = 1; i < 16 ; i++)  
...
void CCMSectItemPSCTee::OnChangeCmdLeftSize()
{
	SyncEditData(m_bSymmetry);
	RedrawSection();
}

void CCMSectItemPSCTee::OnChangeCmdSize() 
{
...
void CCMSectItemPSCTee::SyncCheckData(BOOL bSync)
{
	if(bSync)
	{
		for(int i = 0; i < 4 ; i++)  
...
void CCMSectItemPSCTee::OnCmdCheckLeftCtrls() 
{
	// TODO: Add your control notification handler code here
	UpdateCtrlsByJoint();
	RedrawSection();
...
void CCMSectItemPSCTee::OnCmdCheckCtrls() 
{
	// TODO: Add your control notification handler code here
...
void CCMSectItemPSCTee::OnCmdPscSymmetryCheck() 
{
	// TODO: Add your control notification handler code here
	UpdateCtrlsBySymmetry();
	RedrawSection();
...
void CCMSectItemPSCTee::OnChangeCmdShearEdit() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CCMSectItemPSCBase::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CCMSectItemPSCTee::OnCmdShearCheck() 
{
	// TODO: Add your control notification handler code here
...
void CCMSectItemPSCTee::ChangeShearCheck(int nCheck)
{
...
void CCMSectItemPSCTee::OnCmdSectCentroidBtn() 
{
	// TODO: Add your control notification handler code here
...
void CCMSectItemPSCTee::OnCmdChangeOffsetBtn() 
{
	// TODO: Add your control notification handler code here
...
void CCMSectItemPSCTee::OnSelchangeCmdSectNameCombo() 
{
	// TODO: Add your control notification handler code here
	CString csDBName;
	...
	// Joint
	m_bJ1  = (nOffset & 0x00000001);if(m_bJ1>0) m_bJ1=TRUE;
	m_bJL1 = (nOffset & 0x00000002);if(m_bJL1>0) m_bJL1=TRUE;
	m_bJL2 = (nOffset & 0x00000004);if(m_bJL2>0) m_bJL2=TRUE;
	m_bJL3 = (nOffset & 0x00000008);if(m_bJL3>0) m_bJL3=TRUE;
	m_bJL4 = (nOffset & 0x00000010);if(m_bJL4>0) m_bJL4=TRUE;
	m_bJR1 = (nOffset & 0x00000020);if(m_bJR1>0) m_bJR1=TRUE;
	m_bJR2 = (nOffset & 0x00000040);if(m_bJR2>0) m_bJR2=TRUE;
	m_bJR3 = (nOffset & 0x00000080);if(m_bJR3>0) m_bJR3=TRUE;
	m_bJR4 = (nOffset & 0x00000100);if(m_bJR4>0) m_bJR4=TRUE;
...
void CCMSectItemPSCTee::OnCmdShear1Check() 
{
	// TODO: Add your control notification handler code here
	ChangeAutoShearCheck1();
	RedrawSection();
...
void CCMSectItemPSCTee::ChangeAutoShearCheck1()
{
...
void CCMSectItemPSCTee::OnCmdShear3Check() 
{
	// TODO: Add your control notification handler code here
	ChangeAutoShearCheck3();
	RedrawSection();
...
void CCMSectItemPSCTee::ChangeAutoShearCheck3()
{
	BOOL bShearCheck = m_chkShearCheck.GetCheck();
...
void CCMSectItemPSCTee::OnCmdWebICheck() 
{
	// TODO: Add your control notification handler code here]
...
void CCMSectItemPSCTee::OnCmdWebICheck2() 
{
	// TODO: Add your control notification handler code here
	for (int i = 0; i < 3; i++)
	{
...
void CCMSectItemPSCTee::SaveDataForDrawSection()
{
	UpdateData(TRUE);

	m_SectData.nStype = D_SECT_TYPE_PSC;
	m_SectData.SectBefore.Shape = D_SECT_SHAPE_PSC_T;
	...
	// Size
	if (m_SectData.SectBefore.bSymmetric)  // ´ëÄªÀÏ¶§
	{
		...
		for(int i=0; i<15; i++)
			m_SectData.SectBefore.SectI.Size[16+i] =  m_Edits[i+1].GetEditValue();
	}
	else             // ´ëÄªÀÌ ¾Æ´Ò¶§
	{
...
// Update Viewer
//
BOOL CCMSectItemPSCTee::ChangeBitmap(int nIndex)
{
	ASSERT(m_pParent);
	return m_pParent->ChangeBitmap(nIndex);
}

void CCMSectItemPSCTee::SetDataSource(T_SECT_D* pDataSrc)
{
	ASSERT(m_pParent);
	m_pParent->SetDataSource(pDataSrc);
}

void CCMSectItemPSCTee::RedrawSection()
{
	ASSERT(m_pParent);
...
void CCMSectItemPSCTee::OnCmdSectTableinputBtn() 
{
	CCMSectItemPSCTeeGridDlg m_GridDlg(this);
...
void CCMSectItemPSCTee::OnCmdSectWapingCheckBtn() 
{
...
void CCMSectItemPSCTee::OnCmdSectWapingCheckUser()
{
	UpdateData(TRUE);
	m_SectData.SectBefore.nWarpingCheck[0] =m_nWarpingCheck;
	m_SectData.SectBefore.nWarpingCheck[1] =m_nWarpingCheck;
...
void CCMSectItemPSCTee::OnCmdSectWapingCheck()
{
	UpdateData(TRUE);
