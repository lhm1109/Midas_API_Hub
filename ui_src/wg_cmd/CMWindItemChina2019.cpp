// CMWindItemChina2019.cpp : implementation file
//
/////////////////////////////////////////////////////////////////////////////
...
//#include "CMWindItemChina2019Tool.h"
#include "CMWindItemChina2019CrossDlg.h"
#include "CMWindItemChina2019PartDlg.h"
...
CCMWindItemChina2019::CCMWindItemChina2019(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCMWindItemChina2019::IDD, pParent)
{
		m_pParent = NULL;
	ASSERT(pParent);
	m_pParent = (CCMWindItemDlg*)pParent;

	//{{AFX_DATA_INIT(CCMWindItemChina2019)
...
void CCMWindItemChina2019::SetData2Dlg(T_WIND_CH2019& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CCMWindItemChina2019::SetDlg2Data(T_WIND_CH2019& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CCMWindItemChina2019::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMWindItemChina2019)
	...
	DDX_Control(pDX, IDC_CMD_AIRFLOW_CD_EDIT, m_editWindDirect);
...
BEGIN_MESSAGE_MAP(CCMWindItemChina2019, CChildDialog)
	//{{AFX_MSG_MAP(CCMWindItemChina2019)
...
/////////////////////////////////////////////////////////////////////////////
// CCMWindItemChina2019 message handlers

BOOL CCMWindItemChina2019::OnInitDialog() 
{
	CChildDialog::OnInitDialog();
	
		m_grpWindParam.InitControl(this, CCMWindItemChina2019::IDD, IDC_CMD_FRAME, TRUE, TRUE);
	...
	m_editWindDirect.SetUnitType(D_UNITSYS_NONE);
...
BOOL CCMWindItemChina2019::DestroyWindow() 
{
	Dlg2Data();
...
void CCMWindItemChina2019::OnChangeCmdPeriodXEdit() 
{
	CalcPulseMagnifyFactor();		
}

void CCMWindItemChina2019::OnChangeCmdPeriodYEdit() 
{
	CalcPulseMagnifyFactor();	
}

void CCMWindItemChina2019::OnChangeCmdDampingEdit() 
{
	CalcPulseMagnifyFactor();		
}

void CCMWindItemChina2019::OnSelchangeCategoryCombo() 
{
	CalcPulseMagnifyFactor();		
}

void CCMWindItemChina2019::OnChangeCmdSpeedEdit() 
{
	CalcPulseMagnifyFactor();		
}

void CCMWindItemChina2019::OnCmdPeriodButton() 
{
...
void CCMWindItemChina2019::InitDefaultValue()
{
...
void CCMWindItemChina2019::InitCategoryCombo()
{
...
void CCMWindItemChina2019::CalcPulseMagnifyFactor()
{
//  int nMethod;
...
//  if (nMethod != 0) return;
	...
	CalWind_PulseMagnifyFactor(data);
}

void CCMWindItemChina2019::Data2Dlg()
{
	...
	m_editWindDirect.SetEditUnit(m_Data.dWindDirectionCoe);
...
BOOL CCMWindItemChina2019::Dlg2Data()
{
//  m_Data.Initialize();
	...
	m_Data.dWindDirectionCoe = m_editWindDirect.GetEditValue();
	if(m_Data.dWindDirectionCoe < 1e-9)
	{
		GSaveHistoryFormat(_LS(IDS_WG_CMD__ADDD__Error___Wind_load_WindDirectionCoe));
		return FALSE;
	}
...
void CCMWindItemChina2019::OnCmdPartitionButton()
{
	CMWindItemChina2019PartDlg dlg;
	dlg.SetInitPos(D_INIT_POS_RT);
...
void CCMWindItemChina2019::OnCmdShieldButton()
{
	CMWindItemChina2019ShieldDlg dlg;
	dlg.SetInitPos(D_INIT_POS_RT);
...
void CCMWindItemChina2019::OnCmdCrossButton()
{
	CMWindItemChina2019CrossDlg dlg;
	dlg.SetInitPos(D_INIT_POS_RT);
	//dlg.SetData(m_Data);	
	if(dlg.DoModal()== IDOK)
	{
...
void CCMWindItemChina2019::OnCmdPartitionCheck()
{
...
void CCMWindItemChina2019::OnCmdShieldCheck()
{
...
void CCMWindItemChina2019::OnCmdCrossCheck()
{
...
void CCMWindItemChina2019::OnCmdComfortCheck()
{
...
LRESULT CCMWindItemChina2019::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
		CRect rcChild;
...
double CCMWindItemChina2019::GetWindCoff_KW (const T_WIND_CH2019 &data)
{
...
void CCMWindItemChina2019::CalWind_PulseMagnifyFactor (T_WIND_CH2019 &data)
{
...
void CCMWindItemChina2019::OnCmdWindAlongCheck()
{
