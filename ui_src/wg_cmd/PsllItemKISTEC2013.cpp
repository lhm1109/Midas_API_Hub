// PsllItemKISTEC2013.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPsllItemKISTEC2013 dialog


CPsllItemKISTEC2013::CPsllItemKISTEC2013(CWnd* pParent /*=NULL*/)
	: CChildDialog(CPsllItemKISTEC2013::IDD, pParent)
{
}


void CPsllItemKISTEC2013::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPsllItemKISTEC2013)
...
BEGIN_MESSAGE_MAP(CPsllItemKISTEC2013, CChildDialog)
	//{{AFX_MSG_MAP(CPsllItemKISTEC2013)
...
/////////////////////////////////////////////////////////////////////////////
// CPsllItemKISTEC2013 message handlers

BOOL CPsllItemKISTEC2013::OnInitDialog() 
{
...
BOOL CPsllItemKISTEC2013::DestroyWindow() 
{
	return CChildDialog::DestroyWindow();
}

void CPsllItemKISTEC2013::SetData2Dlg(T_PSLL_KISTEC2013& data, BOOL bModify, int nMethod)
{
	m_Data = data;
	m_bModify = bModify;
	m_nMethod = nMethod;
...
// 
BOOL CPsllItemKISTEC2013::SetDlg2Data(T_PSLL_KISTEC2013& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CPsllItemKISTEC2013::InitDefaultData()
{
	...
	else
	{
		...
		double dTable4_2_1[3][5] = {{0.0, 1.3, 1.1, 1.0, 1.0},
																{0.0, 1.4, 1.2, 1.1, 1.0},
																{0.0, 1.0, 1.0, 1.0, 1.0}};
...
void CPsllItemKISTEC2013::InitDefaultPeriodData()
{
	CDBDoc* pDoc  = (CDBDoc*) CDBDoc::GetDocPoint();
	CAttrCtrl* pAttrCtrl = pDoc->m_pAttrCtrl;
	CUnitCtrl* pUnitCtrl = pDoc->m_pUnitCtrl;	
...
void CPsllItemKISTEC2013::SetComboValue()
{
...
void CPsllItemKISTEC2013::SetFaFvSdsSd1()
{
	int nSeismicZone = m_cmbSeisZone.GetCurSel();
	CString str; 
	...
	//if(!pDoc->m_pAttrCtrl->CalcKISTEC2013FaFvSdsSd1(nPsllmicZone, dZoneFactor, nSiteClass, dFa, dFv, dSds, dSd1, dCu)) return;
...
void CPsllItemKISTEC2013::SetKey(T_PSLL_K key)
{
	m_Key = key;
}

void CPsllItemKISTEC2013::OnSelchangeCmdSiteCmb() 
{
	SetFaFvSdsSd1();
}

void CPsllItemKISTEC2013::OnSelchangeCmdZoneCmb() 
{
	SetComboValue();
	SetFaFvSdsSd1();
}

void CPsllItemKISTEC2013::OnSelchangeCmdZoneFactorCmb() 
{
...
void CPsllItemKISTEC2013::OnChangeCmdZoneFactor() 
{
	SetFaFvSdsSd1();
}

void CPsllItemKISTEC2013::OnChangeCmdFaEdit() 
{
	CString str;
...
void CPsllItemKISTEC2013::OnChangeCmdFvEdit() 
{
	CString str; 
...
void CPsllItemKISTEC2013::OnChangeCmdSdsEdit() 
{
}

void CPsllItemKISTEC2013::OnChangeCmdSd1Edit() 
{ 
...
void CPsllItemKISTEC2013::OnCmdPeriodBtn() 
{
...
void CPsllItemKISTEC2013::InitZoneCombo()
{
...
void CPsllItemKISTEC2013::InitZoneFactorCombo()
{
...
void CPsllItemKISTEC2013::InitSiteCombo()
{
...
void CPsllItemKISTEC2013::Data2Dlg()
{
	CString csValue;
...
BOOL CPsllItemKISTEC2013::Dlg2Data()
{
	CString str; 
