#if !defined(AFX_ISOLATORLRBH30DLG_H__0447C033_E190_48FF_B629_16538194A179__INCLUDED_)
#define AFX_ISOLATORLRBH30DLG_H__0447C033_E190_48FF_B629_16538194A179__INCLUDED_
...
class CIsolatorLrbH30Dlg : public CDialogMove
{
	// Construction
public:
	CIsolatorLrbH30Dlg(CWnd* pParent = NULL);   // standard constructor

	// Dialog Data
		//{{AFX_DATA(CIsolatorDmpRbrDlg)
	enum { IDD = IDD_IEHP_ISOLATOR_LRB_H30 };
...
public:
	T_IEHP_D m_Data;
	void SetIehpPropData(T_IEHP_D iehpD, T_IEHP_LRBH30 data, int nModel, int nDof);
	bool SyncDialogData();
