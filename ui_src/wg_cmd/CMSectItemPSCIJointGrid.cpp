// CMSectItemPSCIJointGrid.cpp : implementation file
//
...
#define D_JOINT_START_ROW 3
#define D_JOINT_END_ROW 7
#define D_JOINT_ROW_SIZE 5

/////////////////////////////////////////////////////////////////////////////
// CCMSectItemPSCIJointGrid

CCMSectItemPSCIJointGrid::CCMSectItemPSCIJointGrid()
{
	m_pSect = 0;
	m_bInitDone = FALSE;
	m_pParent=0;
...
BEGIN_MESSAGE_MAP(CCMSectItemPSCIJointGrid, CGXGridWnd)
	//{{AFX_MSG_MAP(CCMSectItemPSCIJointGrid)
...
/////////////////////////////////////////////////////////////////////////////
// CCMSectItemPSCIJointGrid message handlers

////////////////////////////////외부에서 호출되는 함수////////////////////////
void CCMSectItemPSCIJointGrid::InitGrid()
{
...
void CCMSectItemPSCIJointGrid::SetDataSource(T_SECT_D* pSect,CWnd* pParent,int nIOrTee)
{
	ASSERT(pSect);
	m_pSect = pSect;
	m_pParent=pParent;
...
void CCMSectItemPSCIJointGrid::SetStyleOnSizeCell()
{
...
/////////////////////////데이터를 그리드에 보여주는 함수////////////////////
void CCMSectItemPSCIJointGrid::ShowData()
{
...
void CCMSectItemPSCIJointGrid::ShowLeftJoint()
{
	T_SECT_D_PSC_I m_Cell;
	m_Cell.Set(*m_pSect,TRUE,TRUE);
...
void CCMSectItemPSCIJointGrid::ShowRightJoint()
{
	T_SECT_D_PSC_I m_Cell;
	m_Cell.Set(*m_pSect,TRUE,TRUE);
...
///////////////////////////그리드의 데이터를 저장하는 함수////////////////////
BOOL CCMSectItemPSCIJointGrid::SaveData()
{
	T_SECT_D_PSC_I m_Cell;
	m_Cell.Set(*m_pSect,TRUE,TRUE);
	CString csNum;
...
void CCMSectItemPSCIJointGrid::OnSizeChange()
{
	// 임시(다시 그려주기)
	if(m_nIOrTee==0)
	{
...
BOOL CCMSectItemPSCIJointGrid::SetLeftValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i, j;
...
BOOL CCMSectItemPSCIJointGrid::SetRightValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i, j;
...
BOOL CCMSectItemPSCIJointGrid::SetDownValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i,j;
	i=nRow+1;
	j=nCol;
...
BOOL CCMSectItemPSCIJointGrid::SetUpValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i,j;
	i = nRow-1;
	j = nCol;
...
BOOL CCMSectItemPSCIJointGrid::CopyRange(const CGXRangeList& selList)
{
...
BOOL CCMSectItemPSCIJointGrid::OnPasteFromClipboard(const CGXRange &range)
{
	CGXGridWnd x;
	CGXRange r;
	CGXRange toRange;
...
BOOL CCMSectItemPSCIJointGrid::VerifyPasteRange(CGXRange& from,CGXRange& to)
{
...
int CCMSectItemPSCIJointGrid::GetSelectedRowsCount(int top,int bottom)
{
	int toRows;
	toRows=bottom-top+1;
...
int CCMSectItemPSCIJointGrid::GetSelectedColsCount(int left,int right)
{
	int toCols;
	toCols=0;
	if(left<=2&&right>=2)
...
void CCMSectItemPSCIJointGrid::DecideEnable()
{
	T_SECT_D_PSC_I m_Cell;
	m_Cell.Set(*m_pSect,TRUE,TRUE);
...
void CCMSectItemPSCIJointGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CCMSectItemPSCIJointGrid::OnStartEditing(ROWCOL nRow, ROWCOL nCol)
{
...
////////////////////////////////////////안 바뀌는 부분//////////////////////////////
BOOL CCMSectItemPSCIJointGrid::OnEndEditing(ROWCOL nRow, ROWCOL nCol)
{
...
CString CCMSectItemPSCIJointGrid::GetEditingValue(ROWCOL nRow, ROWCOL nCol)
{
	CString csNum;
	BOOL bGet = FALSE;
	ROWCOL ncRow, ncCol;
...
BOOL CCMSectItemPSCIJointGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
	CRowColArray awRows;
...
BOOL CCMSectItemPSCIJointGrid::OnValidateCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CCMSectItemPSCIJointGrid::OnActivateGrid(BOOL bActivate)
{
...
BOOL CCMSectItemPSCIJointGrid::GetDoubleValue(CString& csNum, double& dNum)
{
	int ecode;
...
BOOL CCMSectItemPSCIJointGrid::IsValidDoubleNumber(CString value, int &nErrCode)
{
	value.TrimLeft();
	value.TrimRight();
...
BOOL CCMSectItemPSCIJointGrid::ConvertFormulaToValue(CString& value)
{
...
BOOL CCMSectItemPSCIJointGrid::IsNumeric(CString str, int& ecode)
{
...
BOOL CCMSectItemPSCIJointGrid::InvalidDoubleNumber(int nErrCode)
{
	switch(nErrCode)
	{
...
BOOL CCMSectItemPSCIJointGrid::ValidateError(LPCTSTR lpszError)
{
