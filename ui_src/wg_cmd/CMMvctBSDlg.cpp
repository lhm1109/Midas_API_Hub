...
CCMMvctBSDlg::CCMMvctBSDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CCMMvctBSDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCMMvctBSDlg)
	m_nReaction = 0;
	m_nDisplacement = 0;
	m_nForceMoment = 0;
	m_nLink = 0;
...
void CCMMvctBSDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMMvctBSDlg)
	...
	DDX_Radio(pDX, IDC_CMD_MVCT_NUM_LANE_RDO1, m_nNumLanes);
	//}}AFX_DATA_MAP
}

//----------------------------------------------------------------------
// Implementation
void CCMMvctBSDlg::Data2Dlg()
{
	T_GRUP_D GroupData;
	T_BNGR_D BngrData;
...
BOOL CCMMvctBSDlg::Dlg2Data()
{
	...
	m_Data.nNumLanes = m_nNumLanes;

	return TRUE;
}

void CCMMvctBSDlg::InitGroupData() 
{
...
BEGIN_MESSAGE_MAP(CCMMvctBSDlg, CDialogMove)
	//{{AFX_MSG_MAP(CCMMvctBSDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCMMvctBSDlg message handlers

BOOL CCMMvctBSDlg::OnInitDialog() 
{
	m_pDoc = CDBDoc::GetDocPoint();
	...
	if (!m_pDoc->m_pAttrCtrl->GetMvctbs(m_Data))
	{
		m_Data.Initialize();
...
void CCMMvctBSDlg::OnCmdMvctFiltersDisplacements() 
{
...
void CCMMvctBSDlg::OnCmdMvctFiltersForceMoments() 
{
...
void CCMMvctBSDlg::OnCmdMvctFiltersLinks() 
{
...
void CCMMvctBSDlg::OnChangeIGPMethod() 
{
	int nCheck;
