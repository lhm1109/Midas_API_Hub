// CMRebarPscShear_I.cpp : implementation file
//
// 2004. 03. 08    by TAE
/////////////////////////////////////////////////////////////////////////////
...
CCMRebarPscShear_I::CCMRebarPscShear_I(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCMRebarPscShear_I::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCMRebarPscShear_I)
	//}}AFX_DATA_INIT
...
void CCMRebarPscShear_I::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMRebarPscShear_I)
...
BEGIN_MESSAGE_MAP(CCMRebarPscShear_I, CChildDialog)
	//{{AFX_MSG_MAP(CCMRebarPscShear_I)
...
void CCMRebarPscShear_I::SetCurData(T_RPSC_SBAR* pData)
{
	ASSERT(pData);  
	m_Data = *pData;
...
BOOL CCMRebarPscShear_I::GetCurData(T_RPSC_SBAR* pData)
{
	ASSERT(pData);
...
/////////////////////////////////////////////////////////////////////////////
// CCMRebarPscShear_I message handlers

BOOL CCMRebarPscShear_I::OnInitDialog() 
{
...
BOOL CCMRebarPscShear_I::DestroyWindow() 
{
...
void CCMRebarPscShear_I::OnCmdLbarCheck() 
{
...
void CCMRebarPscShear_I::OnCmdSbarCheck() 
{
	// TODO: Add your control notification handler code here
...
void CCMRebarPscShear_I::OnCmdTensCheck() 
{
	// TODO: Add your control notification handler code here
...
void CCMRebarPscShear_I::OnCmdStrrCheck() 
{
	// TODO: Add your control notification handler code here
...
void CCMRebarPscShear_I::OnCmdAcpCheck()
{
...
void CCMRebarPscShear_I::Data2Dlg()
{
	// °æ»çÀÎÀåÃ¶±Ù
...
void CCMRebarPscShear_I::Dlg2Data(T_RPSC_SBAR* pData)
{
	ASSERT(pData);
	pData->Initialize();
