#if !defined(AFX_THISITEMDLG_H__66CFF362_FF05_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_THISITEMDLG_H__66CFF362_FF05_11D3_92DE_0000C0B0E6B3__INCLUDED_
...
class __MY_EXT_CLASS__ CThisItemDescDlg : public CDialogMove
{
public:
	CThisItemDescDlg::CThisItemDescDlg() : CDialogMove(CThisItemDescDlg::IDD) {}
	// Dialog Data
	//{{AFX_DATA(CThisItemDescDlg)
	enum { IDD = IDD_ETC_THIS_ITEM_DESC_DLG };
	//}}AFX_DATA
	virtual BOOL OnInitDialog();
};

class CDampGrid;
class __MY_EXT_CLASS__ CThisItemDlg : public CCMDlgBase
{
// Construction
public:
	CThisItemDlg(CWnd* pParent = NULL);   // standard constructor
	~CThisItemDlg();
	enum { IDD = IDD_ETC_THIS_ITEM };
