#if !defined(__CMREBARPSCSHEAR_J_H__)
#define __CMREBARPSCSHEAR_J_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMRebarPscShear_J.h : header file
//
...
class CCMRebarPscShear_J : public CChildDialog
{
// Construction
public:
	CCMRebarPscShear_J(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CCMRebarPscShear_J)
	enum { IDD = IDD_CMD_REBAR_PSC_SHEAR_J };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCMRebarPscShear_J)
	public:
...
#endif // !defined(__CMREBARPSCSHEAR_J_H__)
