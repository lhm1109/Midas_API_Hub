#if !defined(AFX_WINDPROFILEIS875GUSTDLG_H__73923241_1CE0_11D4_AA8B_0080AD78AAC8__INCLUDED_)
#define AFX_WINDPROFILEIS875GUSTDLG_H__73923241_1CE0_11D4_AA8B_0080AD78AAC8__INCLUDED_
...
class CWindProfileIS875GUSTDlg : public CDialogMove
{
// Construction
public:
	CWindProfileIS875GUSTDlg(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CWindProfileIS875GUSTDlg)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CWindProfileIS875GUSTDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CWindProfileIS875GUSTDlg)
