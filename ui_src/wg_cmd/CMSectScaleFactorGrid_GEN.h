#if !defined(__CMSECTSCALEFACTORGRID_GEN_H__)
#define __CMSECTSCALEFACTORGRID_GEN_H__
...
class CCMSectScaleFactorDlgNew_GEN;

/////////////////////////////////////////////////////////////////////////////
// CCMSectScaleFactorGrid_GEN window
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CCMSectScaleFactorGrid_GEN : public CTBCommon
{
// Construction
public:
...
// Operations
public:
	void Initialize(CCMSectScaleFactorDlgNew_GEN* pParent);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCMSectScaleFactorGrid_GEN)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CCMSectScaleFactorGrid_GEN();

	// Generated message map functions
protected:
	//{{AFX_MSG(CCMSectScaleFactorGrid_GEN)
...
private:
	...
	CCMSectScaleFactorDlgNew_GEN* m_pParent;
};
...
#endif // !defined(__CMSECTSCALEFACTORGRID_GEN_H__)
