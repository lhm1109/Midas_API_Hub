...
CSeisItemTaiwan2011::CSeisItemTaiwan2011(CWnd* pParent)
	: CChildDialog(CSeisItemTaiwan2011::IDD, pParent)
{
...
void CSeisItemTaiwan2011::SetData2Dlg(T_SEIS_TAIWAN02& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemTaiwan2011::SetDlg2Data(T_SEIS_TAIWAN02& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemTaiwan2011::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CSeisItemTaiwan2011, CChildDialog)
...
BOOL CSeisItemTaiwan2011::OnInitDialog()
{
...
void CSeisItemTaiwan2011::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemTaiwan2011::IDD, IDC_WG_CMD_STATIC0, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}
BOOL CSeisItemTaiwan2011::DestroyWindow()
{
	//Dlg2Data();
	if (m_pParent != NULL)
	{
...
void CSeisItemTaiwan2011::OnCmdTaiwan02PeriodBtn()
{
	CSeisTaiwan86PeriodDlg dlg(EN_DLG_MODE_TAIWAN_2011, false);
...
void CSeisItemTaiwan2011::OnCmdTaiwan02PeriodRdo()
{
	int nCheck;
...
void CSeisItemTaiwan2011::SetFinalPeriod()
{
	double dSD1 = 0.0;
	...
	m_Data.dPeriodFinalX = pDoc->m_pAttrCtrl->CalcFundamentalPeriod2(TAIWAN_E_2011, dSD1, nCheck, dTXAnal, dTXAppr);
	m_Data.dPeriodFinalY = pDoc->m_pAttrCtrl->CalcFundamentalPeriod2(TAIWAN_E_2011, dSD1, nCheck, dTYAnal, dTYAppr);
}

void CSeisItemTaiwan2011::OnChangeCmdPeriodEdit()
{
	SetFinalPeriod();
...
void CSeisItemTaiwan2011::InitDefaultData()
{
...
void CSeisItemTaiwan2011::InitZoneCombo()
{
	m_cbxZone.ResetContent();
	for (int i = 0; i < 3; i++)
	{
		m_cbxZone.AddString(CSeisItemTaiwan2011Sub::GetSeismicZoneName(i));
	}
	m_cbxZone.SetCurSel(0);
}

void CSeisItemTaiwan2011::InitIFactorCombo()
{
...
void CSeisItemTaiwan2011::InitAlphaCombo()
{
...
void CSeisItemTaiwan2011::InitRxRyCombo()
{
...
void CSeisItemTaiwan2011::Data2Dlg()
{
...
BOOL CSeisItemTaiwan2011::Dlg2Data()
{
	m_Data.nSeismicZone = m_cbxZone.GetCurSel();
...
void CSeisItemTaiwan2011::OnCmdSeisTaiwan02SubBtn()
{
	CSeisItemTaiwan2011Sub dlg;
	dlg.SetInitPos(D_INIT_POS_RT);
...
void CSeisItemTaiwan2011::OnSelchangeZone()
{
	m_Data.nSeismicZone = m_cbxZone.GetCurSel();
	OnChangeCmdPeriodEdit();
}

LRESULT CSeisItemTaiwan2011::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
