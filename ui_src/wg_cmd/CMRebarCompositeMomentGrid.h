#if !defined(__CMREBARCOMPOSITEMOMENTGRID_H__)
#define __CMREBARCOMPOSITEMOMENTGRID_H__
...
/////////////////////////////////////////////////////////////////////////////
// CCMRebarCompositeMomentGrid window
// Browser Style의 윈도우, 가로, 세로 방향으로 늘어난다.
// Row, Column 이동이 금지.
class CCMRebarCompositeMoment;
class CCMRebarCompositeMomentGrid : public CTBBrowserWnd
{
// Construction
public:
	CCMRebarCompositeMomentGrid(CCMRebarCompositeMoment* pParent);
...
public:
	void SetColInfo();
	void EnableSelPart1(BOOL bEnable);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCMRebarCompositeMomentGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CCMRebarCompositeMomentGrid();

	// Generated message map functions
protected:
	//{{AFX_MSG(CCMRebarCompositeMomentGrid)
...
#endif // !defined(__CMREBARCOMPOSITEMOMENTGRID_H__)
