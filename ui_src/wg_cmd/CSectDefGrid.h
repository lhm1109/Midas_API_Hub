#if !defined(AFX_CSECTDEFGRID_H__CDFDFD18_AC20_4ED3_B7DA_A881E933AE44__INCLUDED_)
#define AFX_CSECTDEFGRID_H__CDFDFD18_AC20_4ED3_B7DA_A881E933AE44__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CSectDefGrid.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CCSectDefGrid window
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CCSectDefGrid : public CTBCommon
{
// Construction
public:
	CCSectDefGrid();
...
// Operations
public:
	void Initialize(T_SPFC_D* pData);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCSectDefGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CCSectDefGrid();

	// Generated message map functions
protected:
	//{{AFX_MSG(CCSectDefGrid)
...
#endif // !defined(AFX_CSECTDEFGRID_H__CDFDFD18_AC20_4ED3_B7DA_A881E933AE44__INCLUDED_)
