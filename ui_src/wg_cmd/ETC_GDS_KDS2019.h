#if !defined(AFX_ETC_GDS_KDS2019_H__764B3BE8_32DC_43AF_9CE2_0E11FB2C9D56__INCLUDED_)
#define AFX_ETC_GDS_KDS2019_H__764B3BE8_32DC_43AF_9CE2_0E11FB2C9D56__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// ETC_GDS_KDS2019.h : header file
//
...
class CETC_GDS_KDS2019 : public CMyChildDialog
{
// Construction
public:
    CETC_GDS_KDS2019(T_SPFC_D* pParamData, BOOL bUseTs, CWnd* pParent = NULL);   // standard constructor
    void End();
    void EndNotClose(){};
    BOOL ISVALID();
    void SetValue();
...
// Dialog Data
    //{{AFX_DATA(CETC_GDS_KDS2019)
    enum { IDD = IDD_ETC_GDS_KDS2019 };
...
protected:
    ...
    BOOL m_bUseTs;
    std::shared_ptr<CSpfcKDS2019Util> m_pSpfcUtil;
...
#endif // !defined(AFX_ETC_GDS_KDS2019_H__764B3BE8_32DC_43AF_9CE2_0E11FB2C9D56__INCLUDED_)
