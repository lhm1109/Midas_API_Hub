#if !defined(__IEHPYIELDPROPGRID_MEC_H__)
#define __IEHPYIELDPROPGRID_MEC_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// IehpYieldPropGrid_MEC.h : header file
//
#include "CMGXGridWnd.h"
#include "..\wg_db\wg_db_DBDoc.h"
/////////////////////////////////////////////////////////////////////////////
// CIehpYieldPropGrid_MEC window
class CIehpYieldPropDlgNew_MEC;
class CIehpYieldPropGrid_MEC : public CCMGXGridWnd
{
// Construction
public:
	CIehpYieldPropGrid_MEC(CIehpYieldPropDlgNew_MEC* pParent);
	virtual ~CIehpYieldPropGrid_MEC();
...
public:
	void Initialize();
	void SetFormatMode(int nMode);    // nMode : (0) 1st   (1) 2nd   (2) 1st & 2nd
...
// Overrides
	...
	//{{AFX_VIRTUAL(CIehpYieldPropGrid_MEC)
	//}}AFX_VIRTUAL
...
protected:
	//{{AFX_MSG(CIehpYieldPropGrid_MEC)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()

private:
	BOOL m_bConc;
	CIehpYieldPropDlgNew_MEC* m_pParent;
	BOOL m_bValueMode;
};
...
class CIehpYieldPropGraph_MEC : public CWnd
{
public:
	CIehpYieldPropGraph_MEC();
	virtual ~CIehpYieldPropGraph_MEC();
