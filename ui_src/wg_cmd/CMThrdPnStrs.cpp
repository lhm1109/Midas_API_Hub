// CMThrdPnStrs.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CCMThrdPnStrs dialog


CCMThrdPnStrs::CCMThrdPnStrs(CWnd* pParent /*=NULL*/)
	: CCMChildBarBase(CCMThrdPnStrs::IDD)
{
	//{{AFX_DATA_INIT(CCMThrdPnStrs)
	m_Name = _T("");
	m_KeyNdEl = _T("");
	m_ModNum = 0;
	m_Type = 0;
...
void CCMThrdPnStrs::DoDataExchange(CDataExchange* pDX)
{
	CCMChildBarBase::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMThrdPnStrs)
...
BEGIN_MESSAGE_MAP(CCMThrdPnStrs, CCMChildBarBase)
	//{{AFX_MSG_MAP(CCMThrdPnStrs)
...
/////////////////////////////////////////////////////////////////////////////
// CCMThrdPnStrs message handlers

BOOL CCMThrdPnStrs::PreTranslateMessage(MSG* pMsg)
{
...
void CCMThrdPnStrs::OnCmdCancel()
{
	DataInit();
	((CCMThMainDlg*)(GetParent()->GetParent()))->SetThrdMain(0, 3);
}

void CCMThrdPnStrs::OnCmdOK()
{
	if (OnExecute())
	{
		DataInit();
...
BOOL CCMThrdPnStrs::Dlg2Data()
{
	UpdateData(TRUE);

	m_pDlgData.nGraphStep = 0;
	m_pDlgData.nFunctionType = 5;
...
BOOL CCMThrdPnStrs::OnInitDialog()
{
...
void CCMThrdPnStrs::OnGpsBarThType()
{
	int		cur_type=m_Type;
	UpdateData(TRUE);
...
void CCMThrdPnStrs::OnGpsBarThmodnum()
{
...
void  CCMThrdPnStrs::SetPosCompList(int nType,BOOL bDefault/*=FALSE*/)
{
...
BOOL CCMThrdPnStrs::ExternalInit(UINT key)
{
