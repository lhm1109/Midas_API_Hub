#if !defined(AFX_ISOLATORDMPH16RBRDLG_H__139BCB41_1086_4603_9E75_059EC642B39E__INCLUDED_)
#define AFX_ISOLATORDMPH16RBRDLG_H__139BCB41_1086_4603_9E75_059EC642B39E__INCLUDED_
...
class CIsolatorDmpH16RbrDlg : public CDialogMove
{
	// Construction
public:
	CIsolatorDmpH16RbrDlg(CWnd* pParent = NULL);   // standard constructor

	// Dialog Data
		//{{AFX_DATA(CIsolatorDmpRbrDlg)
	enum { IDD = IDD_IEHP_ISOLATOR_DMPRBR_H16 };
...
public:
	T_IEHP_D m_Data;
	void SetIehpPropData(T_IEHP_D iehpD, T_IEHP_DMPRH16 data, int nModel, int nDof);
	bool SyncDialogData();
