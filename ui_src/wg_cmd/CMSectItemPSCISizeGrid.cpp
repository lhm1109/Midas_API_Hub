// CMSectItemPSCISizeGrid.cpp : implementation file
//
...
#define D_SIZE_END_ROW 19
#define D_SIZE_ROW_SIZE 16



/////////////////////////////////////////////////////////////////////////////
// CCMSectItemPSCISizeGrid

CCMSectItemPSCISizeGrid::CCMSectItemPSCISizeGrid()
{
	m_pSect = 0;
	m_bInitDone = FALSE;
	m_pParent=0;
...
BEGIN_MESSAGE_MAP(CCMSectItemPSCISizeGrid, CGXGridWnd)
	//{{AFX_MSG_MAP(CCMSectItemPSCISizeGrid)
...
/////////////////////////////////////////////////////////////////////////////
// CCMSectItemPSCISizeGrid message handlers

////////////////////////////////외부에서 호출되는 함수////////////////////////
void CCMSectItemPSCISizeGrid::InitGrid()
{
...
void CCMSectItemPSCISizeGrid::SetDataSource(T_SECT_D* pSect,CWnd* pParent)
{
	ASSERT(pSect);
	m_pSect = pSect;
	m_pParent=pParent;
...
void CCMSectItemPSCISizeGrid::SetStyleOnSizeCell()
{
	...
	CString aTitleLeft[] = {
		_T("H1"),_T("HL1"),_T("HL2"),_T("HL2-1"),_T("HL2-2"),_T("HL3"),_T("HL4"),_T("HL4-1"),_T("HL4-2"),_T("HL5"),_T("BL1"),_T("BL2"),_T("BL2-1"),_T("BL2-2"),_T("BL4"),_T("BL4-1"),_T("BL4-2"),
	};
	CString aTitleRight[] = {
		_T("HR1"),_T("HR2"),_T("HR2-1"),_T("HR2-2"),_T("HR3"),_T("HR4"),_T("HR4-1"),_T("HR4-2"),_T("HR5"),_T("BR1"),_T("BR2"),_T("BR2-1"),_T("BR2-2"),_T("BR4"),_T("BR4-1"),_T("BR4-2"),
	};
...
/////////////////////////데이터를 그리드에 보여주는 함수////////////////////
void CCMSectItemPSCISizeGrid::ShowData()
{
...
///////////////////////////그리드의 데이터를 저장하는 함수////////////////////
BOOL CCMSectItemPSCISizeGrid::SaveData()
{
	CString csNum;
	double dNum;
...
void CCMSectItemPSCISizeGrid::OnSizeChange()
{
	// 임시(다시 그려주기)
...
BOOL CCMSectItemPSCISizeGrid::SetLeftValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i, j;
...
BOOL CCMSectItemPSCISizeGrid::SetRightValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i, j;
...
BOOL CCMSectItemPSCISizeGrid::SetDownValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i,j;
	i=nRow+1;
	j=nCol;
...
BOOL CCMSectItemPSCISizeGrid::SetUpValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i,j;
	i = nRow-1;
	j = nCol;
...
BOOL CCMSectItemPSCISizeGrid::CopyRange(const CGXRangeList& selList)
{
...
BOOL CCMSectItemPSCISizeGrid::OnPasteFromClipboard(const CGXRange &range)
{
	CGXGridWnd x;
	CGXRange r;
	CGXRange toRange;
...
BOOL CCMSectItemPSCISizeGrid::VerifyPasteRange(CGXRange& from,CGXRange& to)
{
...
int CCMSectItemPSCISizeGrid::GetSelectedRowsCount(int top,int bottom)
{
	int toRows;
	toRows=bottom-top+1;
	if(top<=1&&bottom>=1)
...
int CCMSectItemPSCISizeGrid::GetSelectedColsCount(int left,int right)
{
	int toCols;
	toCols=0;
	if(left<=2&&right>=2)
...
void CCMSectItemPSCISizeGrid::DecideEnable()
{
	...
	SetStyleRange(CGXRange(D_SIZE_START_ROW+16,2), CGXStyle()
		.SetEnabled(m_Cell.JL3).SetInterior(::GetSysColor((m_Cell.JL3)?COLOR_WINDOW:COLOR_BTNFACE)));
	...
	if(!m_Cell.bSymmetric)
	{
		...
		SetStyleRange(CGXRange(D_SIZE_START_ROW+16,4), CGXStyle()
			.SetEnabled(m_Cell.JR3).SetInterior(::GetSysColor((m_Cell.JR3)?COLOR_WINDOW:COLOR_BTNFACE)));
...
void CCMSectItemPSCISizeGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CCMSectItemPSCISizeGrid::OnStartEditing(ROWCOL nRow, ROWCOL nCol)
{
	if (!CGXGridWnd::OnStartEditing(nRow, nCol)) return FALSE;
	return TRUE;
}
////////////////////////////////////////안 바뀌는 부분//////////////////////////////
BOOL CCMSectItemPSCISizeGrid::OnEndEditing(ROWCOL nRow, ROWCOL nCol)
{
...
CString CCMSectItemPSCISizeGrid::GetEditingValue(ROWCOL nRow, ROWCOL nCol)
{
	CString csNum;
	BOOL bGet = FALSE;
	ROWCOL ncRow, ncCol;
...
BOOL CCMSectItemPSCISizeGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
	CRowColArray awRows;
...
BOOL CCMSectItemPSCISizeGrid::OnValidateCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CCMSectItemPSCISizeGrid::OnActivateGrid(BOOL bActivate)
{
...
BOOL CCMSectItemPSCISizeGrid::GetDoubleValue(CString& csNum, double& dNum)
{
	int ecode;
...
BOOL CCMSectItemPSCISizeGrid::IsValidDoubleNumber(CString value, int &nErrCode)
{
	value.TrimLeft();
	value.TrimRight();
...
BOOL CCMSectItemPSCISizeGrid::ConvertFormulaToValue(CString& value)
{
...
BOOL CCMSectItemPSCISizeGrid::IsNumeric(CString str, int& ecode)
{
...
BOOL CCMSectItemPSCISizeGrid::InvalidDoubleNumber(int nErrCode)
{
	switch(nErrCode)
	{
...
BOOL CCMSectItemPSCISizeGrid::ValidateError(LPCTSTR lpszError)
{
