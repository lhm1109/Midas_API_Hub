#if !defined(AFX_SEISITEMKDS2019_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_)
#define AFX_SEISITEMKDS2019_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// SeisItemKDS2019.h : header file
//
...
class CSeisItemKDS2019 : public CChildDialog
{
	// Construction
public:
	CSeisItemKDS2019(CWnd* pParent = NULL); // standard constructor

	void SetData2Dlg(T_SEIS_KDS2019& data, BOOL bModify);
	BOOL SetDlg2Data(T_SEIS_KDS2019& data);

	// Dialog Data
	enum { IDD = IDD_ETC_SEIS_ITEM_KDS2019 };
	...
	mit::frx::MButton m_chkNotConsiderCu;
	CEditUnit m_editCu;
	CEditUnit m_editFa;
	CEditUnit m_editFv;
	CEditUnit m_editSds;
...
#endif // !defined(AFX_SEISITEMKDS2019_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_)
