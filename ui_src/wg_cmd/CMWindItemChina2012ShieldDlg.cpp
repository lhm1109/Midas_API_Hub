...
CMWindItemChina2012ShieldDlg::CMWindItemChina2012ShieldDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CMWindItemChina2012ShieldDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMWindItemChina2012ShieldDlg)  
	//}}AFX_DATA_INIT
}

void CMWindItemChina2012ShieldDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMWindItemChina2012ShieldDlg)  
	DDX_Control(pDX, IDC_CMD_GRID_SHIELD, m_wndGrid);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMWindItemChina2012ShieldDlg, CDialogMove)
	//{{AFX_MSG_MAP(CMWindItemChina2012ShieldDlg)
...
// Implementations
//////////////////////////////////////////////////////////////////////////////
BOOL CMWindItemChina2012ShieldDlg::OnInitDialog()//(CArray<T_CHINA_WARD, T_CHINA_WARD&>& arDataList) 
{
...
void CMWindItemChina2012ShieldDlg::OnOK() 
{
...
void CMWindItemChina2012ShieldDlg::OnCancel() 
{
...
void CMWindItemChina2012ShieldDlg::InitGrid()
{
...
void CMWindItemChina2012ShieldDlg::SetGridTitle()
{
    BOOL bOldLock = m_wndGrid.LockUpdate(TRUE);
...
// Data -> Grid
void CMWindItemChina2012ShieldDlg::Data2Grid()
{
...
// Grid -> Data
BOOL CMWindItemChina2012ShieldDlg::Grid2Data()
{
    CDBDoc* pDoc = CDBDoc::GetDocPoint();
    ASSERT(pDoc);
    int error;
