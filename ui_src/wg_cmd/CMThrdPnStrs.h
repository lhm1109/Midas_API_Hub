#if !defined(__WG_CMD_CMTHRDPNSTRS_H__)
#define __WG_CMD_CMTHRDPNSTRS_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMThrdPnStrs.h : header file
//
...
class CCMThrdPnStrs : public CCMChildBarBase
{
// Construction
public:
	CCMThrdPnStrs(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CCMThrdPnStrs)
	enum { IDD = IDD_DBAR_THRD_PNSTRS };
...
#endif // !defined(__WG_CMD_CMTHRDPNSTRS_H__)
