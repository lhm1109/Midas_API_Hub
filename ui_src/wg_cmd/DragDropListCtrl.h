...
public:
	...
	void SetBndrType() { m_nGrupType = GRUP_TYPE_BNDR; }
	void SetStrtType() { m_nGrupType = GRUP_TYPE_STRT; }
	void SetLoadType() { m_nGrupType = GRUP_TYPE_LOAD; }
	void SetTndnType() { m_nGrupType = GRUP_TYPE_TNDN; }
	int  GetSelItems(CArray<int, int>& aSelItem);
