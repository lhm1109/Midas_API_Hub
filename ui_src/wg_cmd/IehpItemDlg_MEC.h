...
#define __IEHPITEMDLG_MEC_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// IehpItemDlg_MEC.h : header file
//
...
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CIehpItemDlg_MEC : public CDialogMove, public CDBUpdateConnector
{
// Construction
public:
	CIehpItemDlg_MEC(CWnd* pParent = NULL);   // standard constructor
...
public:
	...
	enum ELEMENT_TYPE   { HT_BEAM_COLM=0, HT_WALL_CRB, HT_SPRING, HT_TRUSS, HT_POINT_SPRING };
...
// Dialog Data
	//{{AFX_DATA(CIehpItemDlg_MEC)
	enum { IDD = IDD_ETC_IEHP_ITEM_MEC };
