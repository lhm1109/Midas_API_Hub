// CMWindPressureDlgMover.cpp : implementation file
//
...
CCMWindPressureDlgMover::CCMWindPressureDlgMover(CWnd* pParent, CWnd* pBaseDlg)
{
	m_pDlgParent = NULL;
...
CCMWindPressureDlgMover::~CCMWindPressureDlgMover()
{
	m_caCtrls.RemoveAll();
}

void CCMWindPressureDlgMover::SetSubCtrls( const CArray<UINT, UINT>& caCtrls, UINT uiHolderID )
{
	m_caCtrls.RemoveAll();
...
BOOL CCMWindPressureDlgMover::IsRealWindow( CWnd* pWnd )
{
...
BOOL CCMWindPressureDlgMover::MoveDlgCtrls( int nMoveVal )
{
	if(nMoveVal == 0)
		return TRUE;
...
BOOL CCMWindPressureDlgMover::Execute( CWnd* pNewSubDlg )
{
