#if !defined(AFX_SEISITEMKBC2015_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_)
#define AFX_SEISITEMKBC2015_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// SeisItemKBC2015.h : header file
//
...
class CSeisItemKBC2015 : public CChildDialog
{
	// Construction
public:
	CSeisItemKBC2015(CWnd* pParent = NULL); // standard constructor

	void SetData2Dlg(T_SEIS_KBC2015& data, BOOL bModify);
	BOOL SetDlg2Data(T_SEIS_KBC2015& data);

	// Dialog Data
	enum { IDD = IDD_ETC_SEIS_ITEM_KBC2015 };
...
#endif // !defined(AFX_SEISITEMKBC2015_H__A87C3B44_CF70_4AA2_AF5E_3C30BBF05A2A__INCLUDED_)
