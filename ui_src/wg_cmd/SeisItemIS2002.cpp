...
CSeisItemIS2002::CSeisItemIS2002(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemIS2002::IDD, pParent)
{
...
void CSeisItemIS2002::SetData2Dlg(T_SEIS_IS2002& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemIS2002::SetDlg2Data(T_SEIS_IS2002& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemIS2002::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CSeisItemIS2002, CChildDialog)
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemIS2002 message handlers

BOOL CSeisItemIS2002::OnInitDialog()
{
...
void CSeisItemIS2002::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemIS2002::IDD, IDC_CMD_IS02_FRAME, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

BOOL CSeisItemIS2002::DestroyWindow()
{
...
void CSeisItemIS2002::OnCmdIs02TCalcBtn()
{
...
void CSeisItemIS2002::OnChangeCmdIs02DampingEdit()
{
...
void CSeisItemIS2002::InitDefaultData()
{
...
void CSeisItemIS2002::InitZoneCombo()
{
...
void CSeisItemIS2002::InitSoilCombo()
{
...
void CSeisItemIS2002::InitIFactorCombo()
{
...
void CSeisItemIS2002::InitRxRyCombo()
{
...
double CSeisItemIS2002::GetDampingFactor(double dDamping)
{
...
LRESULT CSeisItemIS2002::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
