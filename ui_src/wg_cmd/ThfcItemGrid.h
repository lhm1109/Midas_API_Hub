#if !defined(AFX_THFCITEMGRID_H__672479E1_E839_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_THFCITEMGRID_H__672479E1_E839_11D3_92DE_0000C0B0E6B3__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// CThfcItemGrid window
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CThfcItemGrid : public CTBCommon
{
// Construction
public:
	CThfcItemGrid();
...
// Operations
public:
	void Initialize(T_THFC_D* pData, int nValFmtPlace = 4);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CThfcItemGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CThfcItemGrid();

	// Generated message map functions
protected:
	//{{AFX_MSG(CThfcItemGrid)
