#if !defined(AFX_MPHISECTGRID_H__54CF3322_CF43_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_MPHISECTGRID_H__54CF3322_CF43_11D3_92DE_0000C0B0E6B3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// MPhiSectGrid.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CMPhiSectGrid window
...
struct T_SECT_DATA
{
	...
	T_SECT_DATA& operator=(const T_SECT_DATA& rData)
	{
		SectK				= rData.SectK;
...
class CMPhiSectGrid : public CTBBrowserWnd
{

	// Construction
public:
	CMPhiSectGrid();
	virtual ~CMPhiSectGrid();

	// Operations
public:
	void Initialize(BOOL bCodeExist[6]);  
	void SetData(CArray<T_SECT_DATA, T_SECT_DATA&> &aData);
	
	BOOL GetData(CArray<T_SECT_DATA, T_SECT_DATA&> &aData);
...
protected:
	...
	void GetValue(CStringArray& aValue, T_SECT_DATA& data);
	...
	CString GetPosString(const T_SECT_DATA& data);
	int GetPosVal(CString strPos);
	void SetShapeBitmap(ROWCOL nRow, T_SECT_DATA data);
	void SetSectionDataEdit(ROWCOL nRow, T_SECT_DATA& data);

	std::set<std::pair<ROWCOL, ROWCOL>> m_setRedFont;
	BOOL m_bCodeExist[6];
	// Generated message map functions

	//{{AFX_MSG(CMPhiSectGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
...
#endif // !defined(__CMPhiSectGrid_H__)
