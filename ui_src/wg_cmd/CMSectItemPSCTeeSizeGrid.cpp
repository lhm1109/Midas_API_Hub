// CMSectItemPSCTeeSizeGrid.cpp : implementation file
//
...
CCMSectItemPSCTeeSizeGrid::CCMSectItemPSCTeeSizeGrid()
{
	m_pSect = 0;
	m_bInitDone = FALSE;
	m_pParent=0;
...
BEGIN_MESSAGE_MAP(CCMSectItemPSCTeeSizeGrid, CGXGridWnd)
	//{{AFX_MSG_MAP(CCMSectItemPSCTeeSizeGrid)
...
/////////////////////////////////////////////////////////////////////////////
// CCMSectItemPSCTeeSizeGrid message handlers

////////////////////////////////외부에서 호출되는 함수////////////////////////
void CCMSectItemPSCTeeSizeGrid::InitGrid()
{
...
void CCMSectItemPSCTeeSizeGrid::SetDataSource(T_SECT_D* pSect,CWnd* pParent)
{
	ASSERT(pSect);
	m_pSect = pSect;
	m_pParent=pParent;
...
void CCMSectItemPSCTeeSizeGrid::SetStyleOnSizeCell()
{
	...
	CString aTitleLeft[] = {
		_T("H1"),_T("HL1"),_T("HL2"),_T("HL3"),_T("BL1"),_T("BL2"),_T("BL3"),_T("BL4"),_T("HL2-1"),_T("HL2-2"),_T("HL3-1"),_T("HL3-2"),_T("BL2-1"),_T("BL2-2"),_T("BL3-1"),_T("BL3-2"),
	};
	CString aTitleRight[] = {
		_T("HR1"),_T("HR2"),_T("HR3"),_T("BR1"),_T("BR2"),_T("BR3"),_T("BR4"),_T("HR2-1"),_T("HR2-2"),_T("HR3-1"),_T("HR3-2"),_T("BR2-1"),_T("BR2-2"),_T("BR3-1"),_T("BR3-2"),
	};
...
/////////////////////////데이터를 그리드에 보여주는 함수////////////////////
void CCMSectItemPSCTeeSizeGrid::ShowData()
{
...
///////////////////////////그리드의 데이터를 저장하는 함수////////////////////
BOOL CCMSectItemPSCTeeSizeGrid::SaveData()
{
	CString csNum;
	double dNum;
...
void CCMSectItemPSCTeeSizeGrid::OnSizeChange()
{
	// 임시(다시 그려주기)
	CCMSectItemPSCTee *pParent = (CCMSectItemPSCTee*)((CCMSectItemPSCTeeGridDlg*)m_pParent)->m_pWnd;
	if (pParent != 0)
	{
		pParent->UpdateCurDatas();
		pParent->UpdateCtrlsBySymmetry();
		pParent->UpdateCtrlsByJoint();
		pParent->RedrawSection();
		pParent->UpdateCurDatas();
		((CCMSectItemPSCTeeGridDlg*)m_pParent)->DecideEnable();
...
BOOL CCMSectItemPSCTeeSizeGrid::SetLeftValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i, j;
...
BOOL CCMSectItemPSCTeeSizeGrid::SetRightValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i, j;
...
BOOL CCMSectItemPSCTeeSizeGrid::SetDownValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i,j;
	i=nRow+1;
	j=nCol;
...
BOOL CCMSectItemPSCTeeSizeGrid::SetUpValidCell(ROWCOL nRow, ROWCOL nCol)
{
	ROWCOL i,j;
	i = nRow-1;
	j = nCol;
...
BOOL CCMSectItemPSCTeeSizeGrid::CopyRange(const CGXRangeList& selList)
{
...
BOOL CCMSectItemPSCTeeSizeGrid::OnPasteFromClipboard(const CGXRange &range)
{
	CGXGridWnd x;
	CGXRange r;
	CGXRange toRange;
...
BOOL CCMSectItemPSCTeeSizeGrid::VerifyPasteRange(CGXRange& from,CGXRange& to)
{
...
int CCMSectItemPSCTeeSizeGrid::GetSelectedRowsCount(int top,int bottom)
{
	int toRows;
	toRows=bottom-top+1;
	if(top<=1&&bottom>=1)
...
int CCMSectItemPSCTeeSizeGrid::GetSelectedColsCount(int left,int right)
{
	int toCols;
	toCols=0;
	if(left<=2&&right>=2)
...
void CCMSectItemPSCTeeSizeGrid::DecideEnable()
{
	
	T_SECT_D_PSC_I m_Cell;
...
void CCMSectItemPSCTeeSizeGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CCMSectItemPSCTeeSizeGrid::OnStartEditing(ROWCOL nRow, ROWCOL nCol)
{
	if (!CGXGridWnd::OnStartEditing(nRow, nCol)) return FALSE;
	return TRUE;
}
////////////////////////////////////////안 바뀌는 부분//////////////////////////////
BOOL CCMSectItemPSCTeeSizeGrid::OnEndEditing(ROWCOL nRow, ROWCOL nCol)
{
...
CString CCMSectItemPSCTeeSizeGrid::GetEditingValue(ROWCOL nRow, ROWCOL nCol)
{
	CString csNum;
	BOOL bGet = FALSE;
	ROWCOL ncRow, ncCol;
...
BOOL CCMSectItemPSCTeeSizeGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
	CRowColArray awRows;
...
BOOL CCMSectItemPSCTeeSizeGrid::OnValidateCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CCMSectItemPSCTeeSizeGrid::OnActivateGrid(BOOL bActivate)
{
...
BOOL CCMSectItemPSCTeeSizeGrid::GetDoubleValue(CString& csNum, double& dNum)
{
	int ecode;
...
BOOL CCMSectItemPSCTeeSizeGrid::IsValidDoubleNumber(CString value, int &nErrCode)
{
	value.TrimLeft();
	value.TrimRight();
...
BOOL CCMSectItemPSCTeeSizeGrid::ConvertFormulaToValue(CString& value)
{
...
BOOL CCMSectItemPSCTeeSizeGrid::IsNumeric(CString str, int& ecode)
{
...
BOOL CCMSectItemPSCTeeSizeGrid::InvalidDoubleNumber(int nErrCode)
{
	switch(nErrCode)
	{
...
BOOL CCMSectItemPSCTeeSizeGrid::ValidateError(LPCTSTR lpszError)
{
