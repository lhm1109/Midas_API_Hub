// SeisItemKBC2009.cpp : implementation file
//
...
CSeisItemKBC2009::CSeisItemKBC2009(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemKBC2009::IDD, pParent)
{
...
void CSeisItemKBC2009::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisItemKBC2009)
...
BEGIN_MESSAGE_MAP(CSeisItemKBC2009, CChildDialog)
	//{{AFX_MSG_MAP(CSeisItemKBC2009)
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemKBC2009 message handlers

BOOL CSeisItemKBC2009::OnInitDialog()
{
...
void CSeisItemKBC2009::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemKBC2009::IDD, IDC_WG_CMD_STATIC0, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

BOOL CSeisItemKBC2009::DestroyWindow()
{
	if (m_pParent != NULL)
	{
...
void CSeisItemKBC2009::CtrlManager()
{
	int nPeriodMethod;
...
void CSeisItemKBC2009::SetData2Dlg(T_SEIS_KBC2009& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemKBC2009::SetDlg2Data(T_SEIS_KBC2009& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemKBC2009::InitDefaultData()
{
...
void CSeisItemKBC2009::SetComboValue()
{
...
void CSeisItemKBC2009::SetFaFvSdsSd1()
{
	int nSeismicZone = m_cmbSeisZone.GetCurSel();
	CString str;
...
void CSeisItemKBC2009::SetSeisDesignCategory()
{
...
void CSeisItemKBC2009::SetImportanceFactor()
{
...
void CSeisItemKBC2009::OnSelchangeCmdSiteCmb()
{
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
}

void CSeisItemKBC2009::OnSelchangeCmdZoneCmb()
{
	SetComboValue();
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
...
void CSeisItemKBC2009::OnSelchangeCmdZoneFactorCmb()
{
...
void CSeisItemKBC2009::OnChangeCmdZoneFactor()
{
	SetFaFvSdsSd1();
	SetSeisDesignCategory();
}

void CSeisItemKBC2009::OnChangeCmdFaEdit()
{
	CString str;
...
void CSeisItemKBC2009::OnChangeCmdFvEdit()
{
	CString str;
...
void CSeisItemKBC2009::OnChangeCmdSdsEdit()
{
	SetSeisDesignCategory();
}

void CSeisItemKBC2009::OnChangeCmdSd1Edit()
{
	double dSd1 = m_editSd1.GetEditValue();
	double dCu;
...
void CSeisItemKBC2009::OnSelchangeCmdUseGroupCmb()
{
	SetImportanceFactor();
	SetSeisDesignCategory();
}

void CSeisItemKBC2009::OnCmdPeriodBtn()
{
...
void CSeisItemKBC2009::OnCmdPeriodRdo()
{
	CtrlManager();
	OnChangeCmdPeriodEdit();
}

void CSeisItemKBC2009::OnChangeCmdPeriodEdit()
{
...
void CSeisItemKBC2009::InitZoneCombo()
{
...
void CSeisItemKBC2009::InitZoneFactorCombo()
{
...
void CSeisItemKBC2009::InitSiteCombo()
{
...
void CSeisItemKBC2009::InitUseGroupCombo()
{
...
void CSeisItemKBC2009::InitImportanceFactorCombo()
{
...
void CSeisItemKBC2009::InitRxRyCombo()
{
	CString aItem[15] = {
...
void CSeisItemKBC2009::Data2Dlg()
{
	CString csValue;
...
BOOL CSeisItemKBC2009::Dlg2Data()
{
	CString str;
...
LRESULT CSeisItemKBC2009::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
