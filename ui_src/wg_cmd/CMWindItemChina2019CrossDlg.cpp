...
CMWindItemChina2019CrossDlg::CMWindItemChina2019CrossDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CMWindItemChina2019CrossDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMWindItemChina2019CrossDlg)
...
void CMWindItemChina2019CrossDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMWindItemChina2019CrossDlg)
...
BEGIN_MESSAGE_MAP(CMWindItemChina2019CrossDlg, CDialogMove)
	//{{AFX_MSG_MAP(CMWindItemChina2019CrossDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CMWindItemChina2019CrossDlg message handlers

void CMWindItemChina2019CrossDlg::SetData(T_WIND_CH2019& data)
{
...
BOOL CMWindItemChina2019CrossDlg::OnInitDialog()//(T_CHINA_WIND_TRANS TransWind) 
{
...
void CMWindItemChina2019CrossDlg::OnCheckCross() 
{
	UpdateData(TRUE);
	CDlgUtil::CtrlEnableDisable(this, IDC_CMD_WIND_RECT_RADIO, m_nCrossCheck == 1);
	CDlgUtil::CtrlEnableDisable(this, IDC_CMD_WIND_ROUND_RADIO, m_nCrossCheck == 1);
...
void CMWindItemChina2019CrossDlg::OnCheckTorsion() 
{
	UpdateData(TRUE);
	CDlgUtil::CtrlEnableDisable(this, IDC_CMD_PERIOD_EDIT, m_nTorsionCheck == 1);
	UpdateData(FALSE);
}
void CMWindItemChina2019CrossDlg::OnCheckRadio() 
{
	UpdateData(TRUE);
...
void CMWindItemChina2019CrossDlg::OnCancel() 
{
	// TODO: Add your control notification handler code here
	CDialogMove::OnCancel();	
}
void CMWindItemChina2019CrossDlg::OnOk() 
{
	// TODO: Add your control notification handler code here
	UpdateData();	
