...
// CBtnSTNew.h : header file
//

// Comment this if you don't want that CButtonSTNew hilights itself
...
#include "HeaderPre.h"      /////////
class __MY_EXT_CLASS__ CButtonSTNew : public CButton
{
public:
	CButtonSTNew();
	~CButtonSTNew();
