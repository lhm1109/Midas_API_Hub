...
CCMWindPressureVelo_CH2012::CCMWindPressureVelo_CH2012(CWnd* pParent /*=NULL*/)
: CChildDialog(CCMWindPressureVelo_CH2012::IDD, pParent)
{
	m_pParent = NULL;
	ASSERT(pParent);
...
void CCMWindPressureVelo_CH2012::SetData2Dlg(T_WVEP_CH2012& data)
{
	m_Data = data;
	Data2Dlg();
}

BOOL CCMWindPressureVelo_CH2012::SetDlg2Data(T_WVEP_CH2012& data)
{
...
void CCMWindPressureVelo_CH2012::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCMWindPressureVelo_CH2012, CChildDialog)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CCMWindPressureVelo_CH2012 message handlers

BOOL CCMWindPressureVelo_CH2012::OnInitDialog() 
{
...
BOOL CCMWindPressureVelo_CH2012::DestroyWindow() 
{
...
void CCMWindPressureVelo_CH2012::InitCategoryCombo()
{
...
void CCMWindPressureVelo_CH2012::Data2Dlg()
{
...
BOOL CCMWindPressureVelo_CH2012::Dlg2Data()
{
