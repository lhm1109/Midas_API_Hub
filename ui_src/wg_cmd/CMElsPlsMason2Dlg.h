#if !defined(__CMELSPLSMASON2DLG_H__)
#define __CMELSPLSMASON2DLG_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMElsPlsMason2Dlg.h : header file
//
...
class CCMElsPlsMason2Dlg : public CDialogMove
{
// Construction
public:
	CCMElsPlsMason2Dlg(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CCMElsPlsMason2Dlg)
	enum { IDD = IDD_CMD_PROP_ELS_PLS_MASON2 };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCMElsPlsMason2Dlg)
	protected:
...
#endif // !defined(__CMELSPLSMASON2DLG_H__)
