// SeisItemChina2010.cpp : implementation file
//
// 2003. 12. 29    by TAE
/////////////////////////////////////////////////////////////////////////////
...
CSeisItemChina2010::CSeisItemChina2010(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemChina2010::IDD, pParent)
{
	//{{AFX_DATA_INIT(CSeisItemChina2010)
	// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
	m_aCtrlRadio.Add(IDC_CMD_CHINA_ER_RDO1);
	m_aCtrlRadio.Add(IDC_CMD_CHINA_ER_RDO2);
	m_aCtrlRadio.Add(IDC_CMD_CHINA_ER_RDO3);
...
void CSeisItemChina2010::SetData2Dlg(T_SEIS_CH2010& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemChina2010::SetDlg2Data(T_SEIS_CH2010& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemChina2010::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisItemChina2010)
...
BEGIN_MESSAGE_MAP(CSeisItemChina2010, CChildDialog)
	ON_BN_CLICKED(IDC_CMD_CHINA_BTN_CALC_PERIOD, OnCmdChinaBtnCalcPeriod)
	ON_REGISTERED_MESSAGE(CFoldGroupBox::WM_FOLDGROUPBOX_STATE_CHANGED, OnFoldButtonClicked)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CSeisItemChina2010 message handlers

BOOL CSeisItemChina2010::OnInitDialog()
{
...
void CSeisItemChina2010::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemChina2010::IDD, IDC_CMD_CHINA_FRAME1, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

BOOL CSeisItemChina2010::DestroyWindow()
{
...
void CSeisItemChina2010::OnCmdChinaBtnCalcPeriod()
{
	...
	dlg.m_dHX = m_dHXCH2010;
	dlg.m_dHY = m_dHYCH2010;
	dlg.m_dBX = m_dBXCH2010;
	dlg.m_dBY = m_dBYCH2010;
	dlg.m_nNX = m_nNXCH2010;
	dlg.m_nNY = m_nNYCH2010;
	dlg.m_nXMethod = m_nMtdXCH2010;
	dlg.m_nYMethod = m_nMtdYCH2010;
	...
	if (dlg.DoModal() == IDOK)
	{
		...
		m_dHXCH2010 = dlg.m_dHX;
		m_dHYCH2010 = dlg.m_dHY;
		m_dBXCH2010 = dlg.m_dBX;
		m_dBYCH2010 = dlg.m_dBY;
		m_nNXCH2010 = dlg.m_nNX;
		m_nNYCH2010 = dlg.m_nNY;
		m_nMtdXCH2010 = dlg.m_nXMethod;
		m_nMtdYCH2010 = dlg.m_nYMethod;
	}
}
...
void CSeisItemChina2010::InitDefaultData()
{
	...
	m_dBXCH2010 = dBx;
	m_dBYCH2010 = dBy;
	m_dHXCH2010 = m_dHYCH2010 = dHn;
	m_nNXCH2010 = m_nNYCH2010 = nStorNum - 1; // added by KYM
	m_nMtdXCH2010 = 0;
	m_nMtdYCH2010 = 0;
...
void CSeisItemChina2010::InitCategoryCombo()
{
...
void CSeisItemChina2010::InitIntensityCombo()
{
...
void CSeisItemChina2010::InitSiteClassCombo()
{
	m_cobxSiteClass.ResetContent();
	m_cobxSiteClass.AddString(_T("I0"));
	m_cobxSiteClass.AddString(_T("I1"));
...
void CSeisItemChina2010::InitStrtTypeCombo()
{
...
void CSeisItemChina2010::Data2Dlg()
{
...
BOOL CSeisItemChina2010::Dlg2Data()
{
...
LRESULT CSeisItemChina2010::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
