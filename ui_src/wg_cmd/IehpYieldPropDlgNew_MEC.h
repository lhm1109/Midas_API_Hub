#if !defined(AFX_IEHPYIELDPROPDLGNEW_MEC_H__151F169E_46CE_4706_8C1E_91D3BE31E4F8__INCLUDED_)
#define AFX_IEHPYIELDPROPDLGNEW_MEC_H__151F169E_46CE_4706_8C1E_91D3BE31E4F8__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// IehpYieldPropDlgNew_MEC.h : header file
//
...
//class CIehpYieldPropGrid_MEC;
//class CIehpYieldPropGraph;

class CIehpYieldPropDlgNew_MEC : public CDialogMove
{
// Construction
public:
	CIehpYieldPropDlgNew_MEC(CWnd* pParent = NULL);   // standard constructor
	virtual ~CIehpYieldPropDlgNew_MEC();
...
// Dialog Data
	//{{AFX_DATA(CIehpYieldPropDlgNew_MEC)
	enum { IDD = IDD_ETC_IEHP_YLD_PROP_MEC };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CIehpYieldPropDlgNew_MEC)
	protected:
...
protected:
	...
	//{{AFX_MSG(CIehpYieldPropDlgNew_MEC)
...
protected:
	// Graph operations
	CIehpYieldPropGraph_MEC m_Draw;
	void InitGraph();
...
private:
	CIehpYieldPropGrid_MEC* m_wndGrid;
