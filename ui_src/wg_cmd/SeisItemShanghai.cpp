// SeisItemShanghai.cpp : implementation file
// Created By HP...
...
/////////////////////////////////////////////////////////////////////////////
// SeisItemShanghai dialog


CSeisItemShanghai::CSeisItemShanghai(CWnd* pParent /*=NULL*/)
	: CChildDialog(CSeisItemShanghai::IDD, pParent)
{
	//{{AFX_DATA_INIT(CSeisItemShanghai)
...
void CSeisItemShanghai::SetData2Dlg(T_SEIS_CHSH2003& data, BOOL bModify)
{
	m_Data = data;
	m_bModify = bModify;
}

BOOL CSeisItemShanghai::SetDlg2Data(T_SEIS_CHSH2003& data)
{
	BOOL bOK = Dlg2Data();
	data = m_Data;
	return bOK;
...
void CSeisItemShanghai::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSeisItemShanghai)
...
BEGIN_MESSAGE_MAP(CSeisItemShanghai, CChildDialog)
	//{{AFX_MSG_MAP(CSeisItemShanghai)
...
/////////////////////////////////////////////////////////////////////////////
// CSeisItemShanghai message handlers

BOOL CSeisItemShanghai::OnInitDialog()
{
...
void CSeisItemShanghai::SetFoldGroupCtrls()
{
	// After AlignControls
	m_grpFold.InitControl(this, CSeisItemShanghai::IDD, IDC_CMD_CHINA_FRAME1, TRUE, TRUE);
	m_grpFold.SetFoldState(FALSE); // open
}

BOOL CSeisItemShanghai::DestroyWindow()
{
...
void CSeisItemShanghai::OnCmdChinaBtnCalcPeriod()
{
...
void CSeisItemShanghai::InitDefaultData()
{
	...
	m_nNXCH2001 = m_nNYCH2001 = nStorNum - 1;
	m_nMtdXCH2001 = 0;
	m_nMtdYCH2001 = 0;
...
void CSeisItemShanghai::InitIntensityCombo()
{
...
void CSeisItemShanghai::InitSiteClassCombo()
{
...
void CSeisItemShanghai::InitStrtTypeCombo()
{
...
void CSeisItemShanghai::Data2Dlg()
{
...
BOOL CSeisItemShanghai::Dlg2Data()
{
...
LRESULT CSeisItemShanghai::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	CRect rcChild;
