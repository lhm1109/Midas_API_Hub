...
class CSeisItemTaiwan2022Sub : public CDialogMove
{
public:
    CSeisItemTaiwan2022Sub(CWnd* pParent = NULL);
    enum { IDD = IDD_ETC_SEIS_ITEM_TAIWAN22_SUB };

public:
    static CString GetSeismicZoneName(int nCode);
    static CString GetSoilTypeName(int nCode);
    void SetModifyData(T_SEIS_TAIWAN22* pData) { m_pData = pData; }
...
private:
    ...
    afx_msg void OnEdtChangeNSFactor();
    DECLARE_MESSAGE_MAP()
