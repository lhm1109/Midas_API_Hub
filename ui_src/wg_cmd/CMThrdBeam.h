#if !defined(__WG_CMD_CMTHRDBEAM_H__)
#define __WG_CMD_CMTHRDBEAM_H__
...
class CCMThrdBeam : public CCMChildBarBase
{
// Construction
public:
	CCMThrdBeam(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CCMThrdBeam)
	enum { IDD = IDD_DBAR_THRD_BEAM };
