#if !defined(AFX_CMMVHLITEMUSERLOADGRID_H__4FB51AF2_3F8C_4F6F_AB6A_B2B466EF1E06__INCLUDED_)
#define AFX_CMMVHLITEMUSERLOADGRID_H__4FB51AF2_3F8C_4F6F_AB6A_B2B466EF1E06__INCLUDED_
#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMMvhlItemUserLoadGrid.h : header file
//
#include "..\wg_db\wg_db_DBLib.h"
/////////////////////////////////////////////////////////////////////////////
// CCMMvhlItemUserLoadGrid window

class CCMMvhlItemUserLoadGrid : public CGXGridWnd
{
// Construction
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCMMvhlItemUserLoadGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CCMMvhlItemUserLoadGrid();
	void InitGrid();
...
protected:
	//{{AFX_MSG(CCMMvhlItemUserLoadGrid)
...
#endif // !defined(AFX_CMMVHLITEMUSERLOADGRID_H__4FB51AF2_3F8C_4F6F_AB6A_B2B466EF1E06__INCLUDED_)
