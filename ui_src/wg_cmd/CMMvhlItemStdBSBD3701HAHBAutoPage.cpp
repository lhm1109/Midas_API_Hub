// CMMvhlItemStdBSBD3701HAHBAutoPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CCMMvhlItemStdBSBD3701HAHBAutoPage dialog

CCMMvhlItemStdBSBD3701HAHBAutoPage::CCMMvhlItemStdBSBD3701HAHBAutoPage(T_MVHL_D* pData, CWnd* pParent /*=NULL*/)
	: CDialog(CCMMvhlItemStdBSBD3701HAHBAutoPage::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCMMvhlItemStdBSBD3701HAHBAutoPage)
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCMMvhlItemStdBSBD3701HAHBAutoPage)
...
BOOL CCMMvhlItemStdBSBD3701HAHBAutoPage::PreTranslateMessage(MSG* pMsg)
{
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::SetData2Dlg()
{
...
BOOL CCMMvhlItemStdBSBD3701HAHBAutoPage::SetDlg2Data()
{
	UpdateData(TRUE);
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::EnableDisableControls()
{
	UpdateData(TRUE);
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::InitUnit()
{
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::InitCombo()
{
...
BEGIN_MESSAGE_MAP(CCMMvhlItemStdBSBD3701HAHBAutoPage, CDialog)
	//{{AFX_MSG_MAP(CCMMvhlItemStdBSBD3701HAHBAutoPage)
...
/////////////////////////////////////////////////////////////////////////////
// CCMMvhlItemStdBSBD3701HAHBAutoPage message handlers
BOOL CCMMvhlItemStdBSBD3701HAHBAutoPage::OnInitDialog()
{
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::OnLaneFactorRdo()
{
	EnableDisableControls();
}

void CCMMvhlItemStdBSBD3701HAHBAutoPage::OnLaneFactorBtn()
{
...
void CCMMvhlItemStdBSBD3701HAHBAutoPage::OnAddDataChk()
{
	EnableDisableControls();
}