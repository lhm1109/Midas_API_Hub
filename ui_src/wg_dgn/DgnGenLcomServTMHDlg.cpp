...
#include "DgnGenLcomServTMHDlg.h"
...
CDgnGenLcomServTMHDlg::CDgnGenLcomServTMHDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CDgnGenLcomServTMHDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnGenLcomServTMHDlg)
...
void CDgnGenLcomServTMHDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnGenLcomServTMHDlg)
...
BEGIN_MESSAGE_MAP(CDgnGenLcomServTMHDlg, CDialog)
#undef CDialog
	//{{AFX_MSG_MAP(CDgnGenLcomServTMHDlg)
...
void CDgnGenLcomServTMHDlg::InitCtrl()
{
	InitLcomData();
...
void CDgnGenLcomServTMHDlg::InitLcomData()
{
	m_mUnSel.RemoveAll();
	m_mComb1.RemoveAll();
	m_mComb2.RemoveAll();
...
void CDgnGenLcomServTMHDlg::Write_ListCtrl(CListCtrl& LoadList, CMap<int, int, _DGN_LCOM_D, _DGN_LCOM_D&>& LoadMap)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDgnGenLcomServTMHDlg message handlers

BOOL CDgnGenLcomServTMHDlg::OnInitDialog()
{
...
void CDgnGenLcomServTMHDlg::OnDgnAddComb1Btn()
{
...
void CDgnGenLcomServTMHDlg::OnDgnDelComb1Btn()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDgnGenLcomServTMHDlg::OnDgnAddComb2Btn()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDgnGenLcomServTMHDlg::OnDgnDelComb2Btn()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDgnGenLcomServTMHDlg::OnOK()
{
...
void CDgnGenLcomServTMHDlg::OnCancel()
{
