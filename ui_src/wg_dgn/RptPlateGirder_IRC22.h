// RptPlateGirder_IRC22.h: interface for the CRptPlateGirder_IRC22 class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_RptPlateGirder_IRC22_H__)
#define AFX_RptPlateGirder_IRC22_H__
...
class __MY_EXT_CLASS__ CRptPlateGirder_IRC22 : public CXLOut
{
public:
	CRptPlateGirder_IRC22();
	virtual ~CRptPlateGirder_IRC22();
...
protected:
	...
	void PrintDesignInfo_Mod(CMSExcel* pXL, int& iStRow, int iElemNo, int nPosi,CSG_MEMB_RES_AASHTO_LRFD_D& RptData , T_SECT_STIFFNESS& SpscSect);
 ...
 // virtual void SetValue_I_P_02_02   (CMSExcel* pExcel, CString& RptBlock, CSG_MEMB_RES_AASHTO_LRFD_STR_SECT_PROP_D& RptData , int& stRow);
	...
	void PrintBendingResistance(CMSExcel* pXL, int& iStRow, int iChapIndex, int nPosiNega, T_PGBR_BASE& PgbrBaseGd, T_PGBR_BASE& PgbrBase, T_PGBR_DETAIL& PgbrDetail,CSG_MEMB_RES_AASHTO_LRFD_D& RptData , T_SECT_STIFFNESS& SpscSect,T_PGLS_D& PglsD);
...
#endif // !defined(AFX_RptPlateGirder_IRC22_H__)
