// DgnSteelSPCSectGrid.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnSteelSPCSectGrid

CDgnSteelSPCSectGrid::CDgnSteelSPCSectGrid(int nElemCount)
{ 
	m_nOldCol = -1;
...
CDgnSteelSPCSectGrid::~CDgnSteelSPCSectGrid()
{
}


#define CWnd CGXGridWnd
BEGIN_MESSAGE_MAP(CDgnSteelSPCSectGrid, CWnd)
#undef CWnd
	//{{AFX_MSG_MAP(CDgnSteelSPCSectGrid)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnSteelSPCSectGrid message handlers

void CDgnSteelSPCSectGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
	CGXGridWnd::OnModifyCell(nRow, nCol);	
}

void CDgnSteelSPCSectGrid::OnInitCurrentCell(ROWCOL nRow, ROWCOL nCol)
{
	CGXGridWnd::OnInitCurrentCell(nRow, nCol);
}

BOOL CDgnSteelSPCSectGrid::OnPasteFromClipboard(const CGXRange &range)
{
...
BOOL CDgnSteelSPCSectGrid::OnStartEditing(ROWCOL nRow, ROWCOL nCol)
{
...
// Delete 를 막아줌 
BOOL CDgnSteelSPCSectGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
...
BOOL CDgnSteelSPCSectGrid::OnLButtonClickedRowCol(ROWCOL nRow, ROWCOL nCol, UINT nFlags, CPoint pt)
{
	if(nRow != 0)
...
//--------------------------------------------------------------------------
// Interface
void CDgnSteelSPCSectGrid::Initialize(CDgnStlSPCSectITabDlg* pParent)
{
...
void CDgnSteelSPCSectGrid::MakeItemEx()
{
...
//--------------------------------------------------------------------------
// Implementation
void CDgnSteelSPCSectGrid::SetColInfo()
{
...
void CDgnSteelSPCSectGrid::SetHeaderTitle()
{
	BOOL bOldLock = LockUpdate(TRUE);  
...
BOOL CDgnSteelSPCSectGrid::PasteFromClipboard(const CGXRange &range, CString* aDefVal, int nKeyCol, 
...
BOOL CDgnSteelSPCSectGrid::OnValidateField(ROWCOL nRow, ROWCOL nCol)
{
	CString value;
	//int nColID;
...
BOOL CDgnSteelSPCSectGrid::ValidateField(CString& value, int nColID)
{
	int nErrCode=0;
