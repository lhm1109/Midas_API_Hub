#if !defined(AFX_DGNSTEELKRGRID_H__)
#define AFX_DGNSTEELKRGRID_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnSteelKRGrid.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnSteelKRGrid window

class CDBDoc;

class CDgnSteelKRGrid : public CTBBrowserWnd
{
// Construction
public:
	CDgnSteelKRGrid(int nElemCount);
	virtual ~CDgnSteelKRGrid();
...
protected:
	...
	CArray<T_ELEM_K, T_ELEM_K> m_arStdpK;
...
#endif // !defined(AFX_DGNSTEELKRGRID_H__)
