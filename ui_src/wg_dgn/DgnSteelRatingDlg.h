...
#if !defined(AFX_DgnSteelRatingDlg_H__)
#define AFX_DgnSteelRatingDlg_H__
...
class CDgnSteelRatingDlg : public MChildFormView, public CDBUpdateConnector
{
protected:
	CDgnSteelRatingDlg();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CDgnSteelRatingDlg)
...
#endif // !defined(AFX_DgnSteelRatingDlg_H__)
