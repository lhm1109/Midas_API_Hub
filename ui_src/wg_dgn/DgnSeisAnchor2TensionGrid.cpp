// DgnSeisAnchor2TensionGrid.cpp : implementation file
...
CDgnSeisAnchor2TensionGrid::CDgnSeisAnchor2TensionGrid()
{
...
void CDgnSeisAnchor2TensionGrid::SetData2Grid(T_ANEV_D& Data)
{
...
BOOL CDgnSeisAnchor2TensionGrid::GetGrid2Data(T_ANEV_D& Data)
{
	...
	for (int i = 0; i < nRow; i++)
	{
		...
		for (int j = 0; j < nCol; j++)
		{
			...
			if(strVal == _T("None"))
			{
				ElnkNodeKs.aNodeK1[j] = 0; // 0 : 비어있음
				ElnkNodeKs.aNodeK2[j] = 0;
			}
			else
			{
...
void CDgnSeisAnchor2TensionGrid::SetDataToRow(ROWCOL nRow, CStringArray& raValue)
{
...
BOOL CDgnSeisAnchor2TensionGrid::GetRowToData(ROWCOL nRow, CStringArray& raValue)
{
	int nColCount = GetColCount();
	ASSERT(nColCount == raValue.GetSize());
...
CString CDgnSeisAnchor2TensionGrid::GetEditingValue(ROWCOL nRow, ROWCOL nCol)
{
	CString strNum(_T(""));
	BOOL bGet = FALSE;
	ROWCOL ncRow, ncCol;
...
BEGIN_MESSAGE_MAP(CDgnSeisAnchor2TensionGrid, CWnd)
#undef CWnd
	//{{AFX_MSG_MAP(CDgnSeisAnchor2TensionGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

///////////////////////////////////////////////////////////////////////////
// CDgnSeisAnchor2TensionGrid message handlers

// 그리드 초기화 
void CDgnSeisAnchor2TensionGrid::Initialize()
{
...
BOOL CDgnSeisAnchor2TensionGrid::GetStyleRowCol(ROWCOL nRow, ROWCOL nCol, CGXStyle& style, GXModifyType mt, int nType)
{
	BOOL bCurrentRow;
	BOOL bCurrentCell;
	BOOL bEnabled;
...
void CDgnSeisAnchor2TensionGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
	CGXGridWnd::OnModifyCell(nRow, nCol);
}

BOOL CDgnSeisAnchor2TensionGrid::OnPasteFromClipboard(const CGXRange &range)
{
...
BOOL CDgnSeisAnchor2TensionGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
	CRowColArray awRows;
...
BOOL CDgnSeisAnchor2TensionGrid::SetRightValidCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CDgnSeisAnchor2TensionGrid::SetLeftValidCell(ROWCOL nRow, ROWCOL nCol)
{
