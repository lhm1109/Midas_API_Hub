#if !defined(AFX_INTERFACESHEARTABIDLG_CSA_H__)
#define AFX_INTERFACESHEARTABIDLG_CSA_H__
...
class __MY_EXT_CLASS__ CInterfaceShearTabDlg_CSA : public CChildDialog
{
	// Construction
public:
	CInterfaceShearTabDlg_CSA(int nIJ, CWnd* pParent = NULL/*T_SECT_D& SectD*/);   // standard constructor


	enum { IDD = IDD_DGN_DESIGN_INTERFACE_SHEAR_TAB_CSA_DLG };
	CEditUnit m_edtBvi;
	CTextUnit m_untBvi;
	CEditUnit m_edtAvf;
	CTextUnit m_untAvf;
