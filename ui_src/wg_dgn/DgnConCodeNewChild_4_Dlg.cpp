// DgnConCodeNewChild_4_Dlg.cpp : implementation file
//
...
CDgnConCodeNewChild4Dlg::CDgnConCodeNewChild4Dlg(CDgnConCodeNewDlg* pParent /*=NULL*/, T_DCON_D* pData, BOOL bExistData/*=FALSE*/)
	: CDconChildDialog(CDgnConCodeNewChild4Dlg::IDD, pParent, pData, bExistData)
{
...
void CDgnConCodeNewChild4Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDgnConCodeNewChild4Dlg, CDconChildDialog)
...
BOOL CDgnConCodeNewChild4Dlg::OnInitDialog() 
{
...
void CDgnConCodeNewChild4Dlg::SetComboCdAndIe()
{
	...
	if(!m_bExistData) m_CmbCd.SetCurSel(11);
	else
	{
		CString strText = _T("");
...
void CDgnConCodeNewChild4Dlg::SetComboBox()
{
#if defined(_MGEN)
	SetComboCdAndIe();
#endif
}
void CDgnConCodeNewChild4Dlg::InitCtrl()
{
	m_grpSeisParam.InitControl(this, CDgnConCodeNewChild4Dlg::IDD, IDC_DGN_SEIS_PARAM_GRB, TRUE, TRUE);
...
void CDgnConCodeNewChild4Dlg::OnDgnRcctrlSpecial() 
{
...
void CDgnConCodeNewChild4Dlg::GetInitValue(CString strCode)
{
	if(!m_bExistData)
	{
		m_iAlphaType1 = 1;
...
void CDgnConCodeNewChild4Dlg::OnChangeFrameType()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild4Dlg::OnChkSpecialWall()
{
	UpdateData(TRUE);
	EnableWindowBySpecialWall();
}

void CDgnConCodeNewChild4Dlg::OnChangeBndrElemMethodType()
{
	UpdateData(TRUE);
	EnableWindowByBndrElemMethod();
}

void CDgnConCodeNewChild4Dlg::EnableWindowByBndrElemMethod()
{
...
void CDgnConCodeNewChild4Dlg::EnableWindowByBeamColmJointDesign(BOOL bChangeValue/*=TRUE*/)
{
	BOOL bEnable = (m_iFrameType==0) ? TRUE : FALSE;	
...
void CDgnConCodeNewChild4Dlg::OnChangeAlphaType()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild4Dlg::OnUpdateByCode()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild4Dlg::UpdateChildData()
{
...
void CDgnConCodeNewChild4Dlg::ChangeDesignCode()
{
...
void CDgnConCodeNewChild4Dlg::ResizeChildDlg()
{
	...
	aControls.Add(IDC_DGN_EUROCODE204_N17);
	...
	nIDTgt = IDC_DGN_RCCTRL_MRFT_STATIC;
	if(m_bSpecialEQ)
	{
	...
	///////////////////////////////////////////////////////////////
	if(m_pData->DesignCode == _T("NSR-10"))
	{
...
void CDgnConCodeNewChild4Dlg::ReAlingShearDesignCtrl()
{
	...
	CDlgUtil::CtrlMoveDistY(this, m_aSCWBDesign, DY_SDR, TRUE);
	CDlgUtil::CtrlMoveDistY(this, m_aMembTypeSeisDgn, DY_SDR, TRUE);
	CDlgUtil::CtrlMoveDistY(this, m_aSelectPosGroup, DY_SDR, TRUE);
}

void CDgnConCodeNewChild4Dlg::EnableWindowBySpecialWall()
{
...
void CDgnConCodeNewChild4Dlg::SetEQCtrl(const CString& strCode)
{
	...
	if(m_iFrameType==0) //Speical
	{
		...
		GetDlgItem(IDC_DGN_EQ_FACTOR8)->SetWindowText(_LS(IDS_DGN_TEXT_SUFS_ALPHA2_ACI_BEAM));
	}
...
BOOL CDgnConCodeNewChild4Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild4Dlg::OnBCJoint()//PMS:4562 (Tel. 4022) MNET:XXXX-BSCHOI-20121108 #1
{
	UpdateData(TRUE);
...
LRESULT CDgnConCodeNewChild4Dlg::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	BOOL bSeisParamFolded = m_grpSeisParam.GetFoldState();
	ResizeChildDlg();
	if(!bSeisParamFolded)
