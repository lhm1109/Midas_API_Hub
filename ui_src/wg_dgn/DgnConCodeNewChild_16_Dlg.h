#if !defined(__DGN_CON_CODE_NEW_CHILD_16_DLG_H__)
#define __DGN_CON_CODE_NEW_CHILD_16_DLG_H__
...
class __MY_EXT_CLASS__ CDgnConCodeNewChild16Dlg : public CDconChildDialog
{
    // Construction
public:
    CDgnConCodeNewChild16Dlg(CDgnConCodeNewDlg* pParent = NULL, T_DCON_D* pData = NULL, BOOL bExistData = FALSE);   // standard constructor

// Dialog Data
    //{{AFX_DATA(CDgnConCodeNewDlg)
    enum { IDD = IDD_DGN_CON_CODE_CHILD16_DLG };
...
#endif // !defined(__DGN_CON_CODE_NEW_CHILD_12_DLG_H__)
