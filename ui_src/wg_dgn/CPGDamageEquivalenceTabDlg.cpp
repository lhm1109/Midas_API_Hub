...
CCPGDamageEquivalenceTabDlg::CCPGDamageEquivalenceTabDlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCPGDamageEquivalenceTabDlg::IDD, pParent)
{
	//전역변수 초기화
	

	//{{AFX_DATA_INIT(CCPGDamageEquivalenceTabDlg)
	m_bUse = TRUE;	
	m_dLamdaV2 = 0.0;
	m_dLamdaV4 = 0.0;
...
void CCPGDamageEquivalenceTabDlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCPGDamageEquivalenceTabDlg)
...
BEGIN_MESSAGE_MAP(CCPGDamageEquivalenceTabDlg, CChildDialog)
	//{{AFX_MSG_MAP(CCPGDamageEquivalenceTabDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCPGDamageEquivalenceTabDlg message handlers


BOOL CCPGDamageEquivalenceTabDlg::OnInitDialog() 
{
...
BOOL CCPGDamageEquivalenceTabDlg::DestroyWindow() 
{
	Dlg2Data();
...
void CCPGDamageEquivalenceTabDlg::SetInitUnit()
{
	
}


void CCPGDamageEquivalenceTabDlg::OnUseChk() 
{
	UpdateData(TRUE);
...
void CCPGDamageEquivalenceTabDlg::InitialDlgData()
{
	//m_Data.Initialize();
...
BOOL CCPGDamageEquivalenceTabDlg::Data2Dlg()
{
...
BOOL CCPGDamageEquivalenceTabDlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CCPGDamageEquivalenceTabDlg::GetCgfrData()
{
	Dlg2Data();
...
void CCPGDamageEquivalenceTabDlg::SetCgfrData()
{
	Data2Dlg();
}

void CCPGDamageEquivalenceTabDlg::SetAllControlEnable()
{
	bool enable = true;
