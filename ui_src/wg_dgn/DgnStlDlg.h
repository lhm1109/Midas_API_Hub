#if !defined(AFX_DGNSTLDLG_H__BE8B36E2_D0BC_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_DGNSTLDLG_H__BE8B36E2_D0BC_11D3_92DE_0000C0B0E6B3__INCLUDED_
...
class CDgnStlDlg : public MChildFormView, public CDBUpdateConnector
{
protected:
	CDgnStlDlg();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CDgnStlDlg)
...
// #if defined(_MGEN)
// 	#if defined(_CH)
// 		CString m_ComboMenuStr[15];
// 	#else
// 		CString m_ComboMenuStr[7];
// 	#endif
// #else if
// 	CString m_ComboMenuStr[7];
// #endif
