#if !defined(AFX_CPGLATERALTORSIONTABJ_IRC_DLG_H__)
#define AFX_CPGLATERALTORSIONTABJ_IRC_DLG_H__
...
class __MY_EXT_CLASS__ CCPGLateralTorsionTabJ_IRC_Dlg : public CChildDialog
{
// Construction
public:
	CCPGLateralTorsionTabJ_IRC_Dlg(CWnd* pParent = NULL);   // standard constructor

	
// Dialog Data
	//{{AFX_DATA(CCPGLateralTorsionTabJ_IRC_Dlg)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCPGLateralTorsionTabJ_IRC_Dlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CCPGLateralTorsionTabJ_IRC_Dlg)
