...
/////////////////////////////////////////////////////////////////////////////
// CCPGTranShearTabJ_IRC_Dlg dialog


CCPGTranShearTabJ_IRC_Dlg::CCPGTranShearTabJ_IRC_Dlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCPGTranShearTabJ_IRC_Dlg::IDD, pParent)
{
	//전역변수 초기화


	//{{AFX_DATA_INIT(CCPGTranShearTabJ_IRC_Dlg)
	m_bUseShear = TRUE;	
	m_iShearNum = 0;
...
void CCPGTranShearTabJ_IRC_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCPGTranShearTabJ_IRC_Dlg)
...
BEGIN_MESSAGE_MAP(CCPGTranShearTabJ_IRC_Dlg, CChildDialog)
	//{{AFX_MSG_MAP(CCPGTranShearTabJ_IRC_Dlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCPGTranShearTabJ_IRC_Dlg message handlers


BOOL CCPGTranShearTabJ_IRC_Dlg::OnInitDialog() 
{
...
BOOL CCPGTranShearTabJ_IRC_Dlg::DestroyWindow() 
{
	Dlg2Data();
...
void CCPGTranShearTabJ_IRC_Dlg::SetInitUnit()
{
...
void CCPGTranShearTabJ_IRC_Dlg::OnUseShearChk() 
{
	UpdateData(TRUE);
...
void CCPGTranShearTabJ_IRC_Dlg::InitialDlgData()
{
	//m_Data.Initialize();
...
BOOL CCPGTranShearTabJ_IRC_Dlg::Data2Dlg()
{
...
BOOL CCPGTranShearTabJ_IRC_Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CCPGTranShearTabJ_IRC_Dlg::GetCgscData()
{
	Dlg2Data();
...
void CCPGTranShearTabJ_IRC_Dlg::SetCgscData()
{
	Data2Dlg();
}

void CCPGTranShearTabJ_IRC_Dlg::SetAllControlEnable(bool enable)
{
	//bool enable = true;
