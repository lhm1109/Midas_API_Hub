...
class CSeismicDesignSimd_H24 : public iSeismicDesignSimd, public CSeismicDesignSimd
{
public:
	CSeismicDesignSimd_H24() {};
	virtual ~CSeismicDesignSimd_H24() {};
...
class CSeismicDesignSimd_H24_Upper : public CSeismicDesignSimd
{
private:
	P_SIMD_Upper* m_PUpper;

public:
	CSeismicDesignSimd_H24_Upper(CDgnProgressDlg* pProgress);
	virtual ~CSeismicDesignSimd_H24_Upper() {};
...
private:
	...
	BOOL CalcDeltaA_ConsiderAlpha(const T_THIS_K& kThis, IN T_SIMD_SPLD_D* pSpld, OUT doubleArray& aDeltaA);
};

class CSeismicDesignSimd_H24_Lower : public CSeismicDesignSimd
{
private:
...
public:
	CSeismicDesignSimd_H24_Lower(CDgnProgressDlg* pProgress);
	virtual ~CSeismicDesignSimd_H24_Lower() {};
...
private:
	...
	BOOL CalcDeltaA_fromkMphi_Dy_forRc_ByShearDir(const int& nDirShear, OUT doubleArray& aDeltaA);
