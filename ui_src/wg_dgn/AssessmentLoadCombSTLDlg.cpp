// AssessmentLoadCombSTLDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombSTLDlg dialog
CAssessmentLoadCombSTLDlg::CAssessmentLoadCombSTLDlg(CWnd* pParent)
	: CDgnDlgBase(CAssessmentLoadCombSTLDlg::IDD, pParent)
{
	// *^^*  여기를 바꾸시오.

	//{{AFX_DATA_INIT(CAssessmentLoadCombSTLDlg)
	...
	m_pLoadCombList = new CAssessmentLoadCombMainGridSTL(this);

	m_pContentList = new CAssessmentLoadCombSubGridSTL();
	m_bSetGridEditMode = FALSE;
}

CAssessmentLoadCombSTLDlg::~CAssessmentLoadCombSTLDlg()
{
	if (m_pLoadCombList)
	{
...
void CAssessmentLoadCombSTLDlg::DoDataExchange(CDataExchange* pDX)
{
	CDgnDlgBase::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CAssessmentLoadCombSTLDlg)
...
BEGIN_MESSAGE_MAP(CAssessmentLoadCombSTLDlg, CDgnDlgBase)
	//{{AFX_MSG_MAP(CAssessmentLoadCombSTLDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombSTLDlg message handlers
BOOL CAssessmentLoadCombSTLDlg::OnInitDialog()
{
...
void CAssessmentLoadCombSTLDlg::SetControl()
{
...
void CAssessmentLoadCombSTLDlg::CtrlEnable()
{
	UpdateData(TRUE);
...
void CAssessmentLoadCombSTLDlg::OnDlgClose()
{
...
void CAssessmentLoadCombSTLDlg::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
	switch (lHint)
	{
	case D_UPDATE_DBALL:
...
void CAssessmentLoadCombSTLDlg::UpdateBuffer()
{
	...
	while (pos != NULL)
	{
		...
		case(UR_ALCS_ADD):
			...
			((CAssessmentLoadCombMainGridSTL*)m_pLoadCombList)->InsertRecordByKey(Key, Data);
			break;
		case(UR_ALCS_DEL):
			// 삭제될 위치(nRow)를 찾아서 지운다.
			pViewBuff->GetAlcs(nKey, Key, Data);
			((CAssessmentLoadCombMainGridSTL*)m_pLoadCombList)->DeleteRecordByKey(Key, Data);
			break;
		default:
			break;
		}
...
void CAssessmentLoadCombSTLDlg::OnStageChanged()
{
...
void CAssessmentLoadCombSTLDlg::UpdateStld()
{
	CViewBuff* pViewBuff = m_pDoc->m_pViewBuff;
	int nCount = pViewBuff->GetCount();
	if (nCount == 0) return;
...
void CAssessmentLoadCombSTLDlg::OnPaint()
{
...
void CAssessmentLoadCombSTLDlg::OnWindowPosChanged(WINDOWPOS FAR* lpwndpos)
{
...
void CAssessmentLoadCombSTLDlg::OnClose()
{
...
void CAssessmentLoadCombSTLDlg::PostNcDestroy()
{
	CChildDialogMove::PostNcDestroy();
}

void CAssessmentLoadCombSTLDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
	// TODO: Add your message handler code here and/or call default
...
BOOL CAssessmentLoadCombSTLDlg::PreTranslateMessage(MSG* pMsg)
{
...
void CAssessmentLoadCombSTLDlg::SetMainGridModeEdit()
{
...
void CAssessmentLoadCombSTLDlg::OnMovTypeRdo()
{
	SetMainGridModeEdit();
	CtrlEnable();
}

void CAssessmentLoadCombSTLDlg::OnCombinedVhlCmb()
{
	SetMainGridModeEdit();
}

void CAssessmentLoadCombSTLDlg::OnCombinedVhlEdt()
{
	SetMainGridModeEdit();
}

void CAssessmentLoadCombSTLDlg::OnSpecialVhlCmb()
{
	SetMainGridModeEdit();
}

void CAssessmentLoadCombSTLDlg::OnSpecialVhlEdt()
{
	SetMainGridModeEdit();
}

void CAssessmentLoadCombSTLDlg::OnCopy()
{
	ROWCOL ncRow, ncCol;
...
void CAssessmentLoadCombSTLDlg::OnCopyToLCom()
{
...
void CAssessmentLoadCombSTLDlg::SetCombinedVhlCmb(MComboBox& cobxMv)
{
...
void CAssessmentLoadCombSTLDlg::SetSpecialVhlCmb(MComboBox& cobxMv)
{
	BOOL bOld = m_bSetGridEditMode;
	m_bSetGridEditMode = FALSE;
...
BOOL CAssessmentLoadCombSTLDlg::Dlg2Data(T_ALCS_D &AlcsD)
{
	UpdateData(TRUE);
...
BOOL CAssessmentLoadCombSTLDlg::GetData(T_ALCS_D &AlcsD)
{
	return Dlg2Data(AlcsD);
}

void CAssessmentLoadCombSTLDlg::Data2Dlg(const T_ALCS_D &AlcsD)
{
	BOOL bOld = m_bSetGridEditMode;
	m_bSetGridEditMode = FALSE;
...
void CAssessmentLoadCombSTLDlg::SetData(T_ALCS_K AlcsK)
{
	m_bSetGridEditMode = FALSE;
