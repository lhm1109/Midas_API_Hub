...
#if !defined(__DGN_CsgMANAGER_AASHTO12_H__)
#define __DGN_CsgMANAGER_AASHTO12_H__
...
class CDgn_CSGManager_AASHTO12 : public CDgn_CSGManager
{
public:
	CDgn_CSGManager_AASHTO12();
	virtual ~CDgn_CSGManager_AASHTO12();
...
class CDgn_CSGManager_AASHTO07 : public CDgn_CSGManager_AASHTO12
{
public:
	CDgn_CSGManager_AASHTO07();
	virtual ~CDgn_CSGManager_AASHTO07();
};


#endif // !defined(__DGN_CsgMANAGER_AASHTO12_H__)
