...
/////////////////////////////////////////////////////////////////////////////
// CRatingLoadCombPSCRCSubGrid

CRatingLoadCombPSCRCSubGrid::CRatingLoadCombPSCRCSubGrid(int nType)
:CRatingLoadCombCommonSubGrid(nType)
{
	
}

CRatingLoadCombPSCRCSubGrid::~CRatingLoadCombPSCRCSubGrid()
{
}

BEGIN_MESSAGE_MAP(CRatingLoadCombPSCRCSubGrid, CRatingLoadCombCommonSubGrid)
	//{{AFX_MSG_MAP(CRatingLoadCombPSCRCSubGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()


/////////////////////////////////////////////////////////////////////////////
// CRatingLoadCombPSCRCSubGrid message handlers
void CRatingLoadCombPSCRCSubGrid::SetData(CString sKey)
{
	m_sKey = sKey;
...
void CRatingLoadCombPSCRCSubGrid::GetData(T_RKLC_D &data)
{
	if(m_nGridType == 0)		
	{
		int nAnalType;
...
CString CRatingLoadCombPSCRCSubGrid::GetDefFactorVal(int nGridType)
{
	if (nGridType == 0)
	{
		return _T("1.3");
