#if !defined(AFX_CPGTRANSTIFTABDLG_H__823E992D_C5CC_4048_B8B3_21B0B19F8F64__INCLUDED_)
#define AFX_CPGTRANSTIFTABDLG_H__823E992D_C5CC_4048_B8B3_21B0B19F8F64__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CPGTranStifTabDlg.h : header file
//
...
class __MY_EXT_CLASS__ CCPGTranStifTabDlg : public CChildDialog
{
// Construction
public:
	CCPGTranStifTabDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CCPGTranStifTabDlg();
	
// Dialog Data
	//{{AFX_DATA(CCPGTranStifTabDlg)
	enum { IDD = IDD_DGN_CPG_TRAN_STIF_TAB_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCPGTranStifTabDlg)
	protected:
...
#endif // !defined(AFX_CPGTRANSTIFTABDLG_H__823E992D_C5CC_4048_B8B3_21B0B19F8F64__INCLUDED_)
