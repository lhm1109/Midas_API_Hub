#if !defined(__DGNREBARPSCMOMENTGRID_H__)
#define __DGNREBARPSCMOMENTGRID_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnRebarPscMomentGrid.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnRebarPscMomentGrid window
// Browser Style의 윈도우, 가로, 세로 방향으로 늘어난다.
// Row, Column 이동이 금지.
class CDgnRebarPscMoment;
class CDgnRebarPscMomentGrid : public CTBBrowserWnd
{
// Construction
public:
	CDgnRebarPscMomentGrid(CDgnRebarPscMoment* pParent);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDgnRebarPscMomentGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CDgnRebarPscMomentGrid();

	// Generated message map functions
protected:
	//{{AFX_MSG(CDgnRebarPscMomentGrid)
...
#endif // !defined(__DGNREBARPSCMOMENTGRID_H__)
