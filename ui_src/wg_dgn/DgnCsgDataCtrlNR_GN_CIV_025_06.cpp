...
CDgnCsgDataCtrlNR_GN_CIV_025_06::CDgnCsgDataCtrlNR_GN_CIV_025_06() : CDgnCsgDataCtrl()
{
}

CDgnCsgDataCtrlNR_GN_CIV_025_06::~CDgnCsgDataCtrlNR_GN_CIV_025_06()
{
}

void CDgnCsgDataCtrlNR_GN_CIV_025_06::SetDataCtrlPointer(CCRCDataCtrl *pDataCtrl)
{
...
BOOL CDgnCsgDataCtrlNR_GN_CIV_025_06::MakeMemberResultData(ElemPairK ElemK, CSG_MEMB_POSD_KSCE_LSD &CsgMembD, CSG_MEMB_RESULT_D &rData)
{
...
BOOL CDgnCsgDataCtrlNR_GN_CIV_025_06::Check_Strength(ElemPairK ElemK, int nPos, CSG_MEMB_POSD_KSCE_LSD &InD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes, CSG_CHK_RES_DTR_PARAM &DtrR)
{
...
BOOL CDgnCsgDataCtrlNR_GN_CIV_025_06::Check_Service(ElemPairK ElemK, int nPos, CSG_MEMB_POSD_KSCE_LSD &InD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes, CSG_CHK_RES_DTR_PARAM &DtrR)
{
    if ( MembRes.pNRGN ==NULL ) return FALSE;
    if ( ChkRes.pNRGN ==NULL ) return FALSE;
