#if !defined(__DGNCPGMATDLG_H__)
#define __DGNCPGMATDLG_H__
...
class __MY_EXT_CLASS__ CDgnCpgMatDlg : public CDialogMove
{
// Construction
public:
	CDgnCpgMatDlg(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDgnCpgMatDlg)
	enum { IDD = IDD_DGN_CPG_MAT_DLG };
	CTextUnit	m_FuUnit;
	CTextUnit	m_Fy1Unit;
	CTextUnit	m_Fy2Unit;
	CTextUnit	m_Fy3Unit;
	...
	double	m_Fyr;
	double	m_Fys;
	mit::frx::MButton m_chkHybrid;
	mit::frx::MButton m_btnHybrid;
	//}}AFX_DATA

	CArray<UINT, UINT> m_arSubRbarCtrlID;
...
public:
	...
	BOOL ErrorCheck();
	BOOL EnableDiableCtrl();
	BOOL InitDefaultMatlD(CString& strSteel, CString& strConcrete, CString& strMainRebar, CString& strSubRebar);

// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CDgnCpgMatDlg)
	protected:
...
protected:
	...
	afx_msg void OnDgnClickedHybridCheck();
	afx_msg void OnDgnClickedBtnHybrid();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
