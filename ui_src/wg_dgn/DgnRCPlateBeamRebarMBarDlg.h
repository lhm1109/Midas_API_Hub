...
class CDgnRCPlateBeamRebarMBarDlg : public CChildDialog
{
public:
	CDgnRCPlateBeamRebarMBarDlg(T_RPBM_D* pData, CWnd* pParent = NULL);
	~CDgnRCPlateBeamRebarMBarDlg();
...
private:
	...
	void CalcAs(T_RPBM_D& RchkBeamD, double& dAsTop, double& dAsBot);
...
private:
	CDBDoc* m_pDoc;
	T_RPBM_D* m_pData; // I만 사용, Layer 최대갯수 3개
	int m_iThik;
};
