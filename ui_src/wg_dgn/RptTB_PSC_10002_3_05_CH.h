//////////////////////////////////////////////////////////////////////
// RptTB_PSC_10002_3_05_CH.h: interface for the RptTB_PSC_10002_3_05_CH class.
// author: maxiao
// time  : 2007-04-09
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_RPTTB_PSC_10002_3_05_CH_H__INCLUDED_)
#define AFX_RPTTB_PSC_10002_3_05_CH_H__INCLUDED_
...
class CDBDoc;
class CPSCrailway;
class CRCDataCtrl_CH;

class __MY_EXT_CLASS__ CRptTB_PSC_10002_3_05_CH : public CReportBase , public CPrtKSCE_USD03  
{
public:
	CRptTB_PSC_10002_3_05_CH();
	virtual ~CRptTB_PSC_10002_3_05_CH();
...
protected:  
	...
	CPSCrailway* m_pTB_10002_3_05_CH;
...
protected:
	...
	//渡壇제졺駱炬杰痰돕돨변鑒
	BOOL MakeBeam_PSCdegree(int& iChapID, T_PARA_RPT& paraD);        //渡壇제졺渡壇제똑駱炬
	BOOL MakeBeam_con_CS(int& iChapID, T_PARA_RPT& paraD);           //渡속壇제쌓뙈－살퀸皐랬蕨壇제駱炬
	BOOL MakeBeam_tendon_CS(int& iChapID, T_PARA_RPT& paraD);        //渡속壇제쌓뙈－渡壇제멀쏘챗苟왠齡壇제駱炬  
	BOOL MakeBeam_cross_fracture(int& iChapID, T_PARA_RPT& paraD);   //頓檀쌓뙈－攣쌔충예죙駱炬 
	BOOL MakeBeam_incline_fracture(int& iChapID, T_PARA_RPT& paraD); //頓檀쌓뙈－閨쌔충예죙駱炬  
	BOOL MakeBeam_incline_tp(int& iChapID, T_PARA_RPT& paraD);       //頓檀쌓뙈－살퀸皐寮윗壇제 
	BOOL MakeBeam_con_c_SS(int& iChapID, T_PARA_RPT& paraD);         //頓檀쌓뙈－살퀸皐箕壇제駱炬  
	BOOL MakeBeam_con_t_SS(int& iChapID, T_PARA_RPT& paraD);         //頓檀쌓뙈－살퀸皐윗壇제駱炬 
	BOOL MakeBeam_tendon_SS(int& iChapID, T_PARA_RPT& paraD);        //頓檀쌓뙈－渡壇제멀쏘壇제駱炬 
	BOOL MakeBeam_delta_tendon(int& iChapID, T_PARA_RPT& paraD);     //頓檀쌓뙈－渡壇제멀쏘壇제류駱炬
	BOOL MakeBeam_shear(int& iChapID, T_PARA_RPT& paraD);            //頓檀쌓뙈－살퀸皐숏壇제駱炬 
	BOOL MakeBeam_crack(int& iChapID, T_PARA_RPT& paraD);            //頓檀쌓뙈－죙룹욱똑駱炬 
	BOOL MakeBeam_crossbend(int& iChapID, T_PARA_RPT& paraD);        //攣쌔충예琨駱炬
	BOOL MakeBeam_inclineshear(int& iChapID, T_PARA_RPT& paraD);     //閨쌔충예숏駱炬  

	//渡壇제料駱炬杰痰돕돨변鑒
	BOOL MakeColumn_PSCdegree(int& iChapID, T_PARA_RPT& paraD);      //渡壇제料渡壇제똑駱炬
	BOOL MakeColumn_con_CS(int& iChapID, T_PARA_RPT& paraD);         //渡속壇제쌓뙈－渡壇제料살퀸皐랬蕨壇제駱炬 
	BOOL MakeColumn_tendon_CS(int& iChapID, T_PARA_RPT& paraD);      //渡속壇제쌓뙈－渡壇제멀쏘챗苟왠齡壇제駱炬  
	BOOL MakeColumn_cross_fracture(int& iChapID, T_PARA_RPT& paraD); //頓檀쌓뙈－渡壇제料攣쌔충예죙駱炬 
	BOOL MakeColumn_con_c_SS(int& iChapID, T_PARA_RPT& paraD);       //頓檀쌓뙈－渡壇제料살퀸皐箕壇제駱炬  
	BOOL MakeColumn_con_t_SS(int& iChapID, T_PARA_RPT& paraD);       //頓檀쌓뙈－渡壇제料살퀸皐윗壇제駱炬
	BOOL MakeColumn_tendon_SS(int& iChapID, T_PARA_RPT& paraD);      //頓檀쌓뙈－渡壇제멀쏘壇제駱炬 
	BOOL MakeColumn_shear(int& iChapID, T_PARA_RPT& paraD);          //頓檀쌓뙈－渡壇제料살퀸皐숏壇제駱炬
	BOOL MakeColumn_compressive(int& iChapID, T_PARA_RPT& paraD);    //渡壇제料攣쌔충예箕퓻똑駱炬
	BOOL MakeColumn_tension(int& iChapID, T_PARA_RPT& paraD);        //渡壇제料攣쌔충예윗퓻똑駱炬
...
#endif // !defined(AFX_RPTTB_PSC_10002_3_05_CH_H__INCLUDED_)
