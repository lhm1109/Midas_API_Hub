// Dgn_PSCRptManager_IRS.cpp: implementation of the CDgn_PSCRptManager_IRS class.
//
//////////////////////////////////////////////////////////////////////
...
CDgn_PSCRptManager_IRS::CDgn_PSCRptManager_IRS()
...
BOOL CDgn_PSCRptManager_IRS::InitialData(int iNationType)
{
	...
	{	
		...
		//
		m_pShearDetail = (PSC_Print_Detail_Design_Shear_EC*)GetProcAddress(hDllCalc, "Print_DetailReport_ShearDesign_IRS");
...
BOOL CDgn_PSCRptManager_IRS::Initialize(int iDgncode, LPCTSTR szProgramDir, LPCTSTR szProjectFileDir, LPCTSTR szSaveFileName)
{ 
...
BOOL CDgn_PSCRptManager_IRS::Terminate(int iDgnCode, BOOL bIsAborted)
{
	CDgnPscCommon PscCommon; 
	int nDgnCode = PscCommon.GetConvertCodeCvlToEng( iDgnCode);
...
BOOL CDgn_PSCRptManager_IRS::Print_AllowableStresses_Conc_ConstructionStage_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_FYSG_BASE& FysgBase)
{
...
BOOL CDgn_PSCRptManager_IRS::Print_AllowableStresses_Conc_ServiceLoad_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_FYCM_BASE& FycmBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_AllowablePrincipalStress_Conc_ConstructionStage_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_FPSG_BASE& FpsgBase)
{
	if(!m_bInitialized) return FALSE;	
...
BOOL CDgn_PSCRptManager_IRS::Print_AllowablePrincipalStress_Conc_ServiceLoad_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_FPMS_BASE& FpmsBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_AllowableStress_Tendon_EC(int iDgnCode, UINT iTndn, BOOL bFinal, PSC_FYPC_D& FypcBase)
{
	if(!m_bInitialized) return FALSE;
...
// Summary Report!
BOOL CDgn_PSCRptManager_IRS::Print_FlexureDesign_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_FRCR_D& BdcwBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_ShearDesign_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_CUMS_BASE& CumsBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_TorsionDesign_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_CRMT_BASE& CrmtBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_CrackCheck_EC(int iDgnCode, ElemPairK iElemKey, UINT iIJ, BOOL bFinal, PSC_BDCW_BASE& BdcwBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_DgnCondition(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_FRCR_D& FrcrD)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_FlexureDesign(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_FRCR_D& FrcrD)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_ShearDesign_IRS(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_CUMS_BASE& CumsBase,PSC_FRCR_D& FrcrD)
{
	if(!m_bInitialized) return FALSE;
	...
	bCheck = (*m_pShearDetail)(nDgnCode, iElemKey.first, iIJ, &InData, sizeof(PSC_DATA_POSI), &CumsBase, sizeof(PSC_CUMS_BASE), &FrcrD, sizeof(PSC_FRCR_D), bVersionOK);

	return (bVersionOK && bCheck);
}

BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_TorsionDesign(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_CRMT_BASE& CrmtBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_ZeroStressDesign(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_BDCW_BASE& BdcwBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_CrackDesign(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_BDCW_BASE& BdcwBase)
{
	if(!m_bInitialized) return FALSE;
...
BOOL CDgn_PSCRptManager_IRS::Print_DetailReport_FatigueDesign(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_FATG_BASE& FatgBase)
{
	if(!m_bInitialized) return FALSE;
...
CString CDgn_PSCRptManager_IRS::Get_StageName(T_STAG_K StagK)
{
...
CString CDgn_PSCRptManager_IRS::Get_LcomName(T_LCOM_K LcomK)
{
