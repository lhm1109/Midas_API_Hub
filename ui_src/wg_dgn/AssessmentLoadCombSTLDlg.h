#if !defined(__CMAssessmentLoadCombSTLDlg_H__)
#define __CMAssessmentLoadCombSTLDlg_H__
...
#include "HeaderPre.h"
class __MY_EXT_CLASS__ CAssessmentLoadCombSTLDlg : public CDgnDlgBase, public CDBUpdateConnector
{
	// Construction
public:
	CAssessmentLoadCombSTLDlg(CWnd* pParent = NULL);   // standard constructor
	~CAssessmentLoadCombSTLDlg();

	// Dialog Data
	//{{AFX_DATA(CAssessmentLoadCombSTLDlg)
	enum { IDD = IDD_DGN_ASSESSMENT_LOADCOMB_STL_DLG };	
	//}}AFX_DATA
	...
	//{{AFX_VIRTUAL(CAssessmentLoadCombSTLDlg)
...
protected:
	...
	//{{AFX_MSG(CAssessmentLoadCombSTLDlg)
...
protected:  
	...
	CAssessmentLoadCombMainGridSTL* m_pLoadCombList;
	CAssessmentLoadCombSubGridSTL*  m_pContentList;   
...
#endif // !defined(__CMAssessmentLoadCombSTLDlg_H__)