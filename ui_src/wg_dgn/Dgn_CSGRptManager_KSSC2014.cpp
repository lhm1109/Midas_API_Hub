...
CDgn_CSGRptManager_KSSC2014::CDgn_CSGRptManager_KSSC2014()
{
	m_pCSGDetail_KSSC2014  = NULL;
}
...
BOOL CDgn_CSGRptManager_KSSC2014::InitialData(int iNationType)
{
	...
	{	
		m_pCSGDetail_KSSC2014 = (CSG_Print_DetailReport_KSSC2014*)GetProcAddress(hDllCalc, "Print_CSGDetailReport_KSSC2014");
		if(!m_pCSGDetail_KSSC2014) return FALSE;
	}

	return TRUE;
}

BOOL CDgn_CSGRptManager_KSSC2014::Print_DetailReport(int iDgnCode, LPCTSTR szProgramDir, LPCTSTR szProjectFileDir, LPCTSTR szSaveFileName,
																										 CArray<CSG_MEMB_POSD_KSCE_LSD, CSG_MEMB_POSD_KSCE_LSD&>& aInData,   CArray<CSG_MEMB_RES_AASHTO_LRFD_D,  CSG_MEMB_RES_AASHTO_LRFD_D&>& aRptData)
{
	...
	bCheck = (*m_pCSGDetail_KSSC2014)(&ROpt, pProInte, 
