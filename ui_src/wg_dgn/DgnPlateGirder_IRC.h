// DgnPlateGirder_IRC.h: interface for the CDgnPlateGirder_IRC class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(_DgnPlateGirder_IRC_H__INCLUDED_)
#define AFX_DgnPlateGirder_IRC_H__INCLUDED_
...
struct CLASS_BASE_UNIT_IRC
{
	...
	CLASS_BASE_UNIT_IRC() { Initialize(); }
};

struct T_CLASS_IN_UNIT_D_IRC
{
	...
	T_CLASS_IN_UNIT_D_IRC(){ Initialize(); }

	T_CLASS_IN_UNIT_D_IRC(const T_CLASS_IN_UNIT_D_IRC& rData) {*this = rData; }
	T_CLASS_IN_UNIT_D_IRC& operator=(const T_CLASS_IN_UNIT_D_IRC& rData) 
	{
		nType			= rData.nType;
...
struct T_CLASS_IN_D_IRC
{
	CArray<T_CLASS_IN_UNIT_D_IRC, T_CLASS_IN_UNIT_D_IRC&> aTopFlangeD;
	CArray<T_CLASS_IN_UNIT_D_IRC, T_CLASS_IN_UNIT_D_IRC&> aBotFlangeD;
	CArray<T_CLASS_IN_UNIT_D_IRC, T_CLASS_IN_UNIT_D_IRC&> aWebD;
	...
	T_CLASS_IN_D_IRC(){ Initialize(); }

	T_CLASS_IN_D_IRC(const T_CLASS_IN_D_IRC& rData) {*this = rData; }
	T_CLASS_IN_D_IRC& operator=(const T_CLASS_IN_D_IRC& rData) 
	{
...
struct T_VERTICAL_SHAER_RES_UNIT_D_IRC
{
	...
	T_VERTICAL_SHAER_RES_UNIT_D_IRC(){ Initialize(); }
	T_VERTICAL_SHAER_RES_UNIT_D_IRC(const T_VERTICAL_SHAER_RES_UNIT_D_IRC& rData) {*this = rData; }
	T_VERTICAL_SHAER_RES_UNIT_D_IRC& operator=(const T_VERTICAL_SHAER_RES_UNIT_D_IRC& rD) 
	{
...
struct T_VERTICAL_SHAER_RES_D_IRC
{
	double dVbw_Rd;
	double dVbf_Rd;
	T_VERTICAL_SHAER_RES_UNIT_D_IRC ShearResD[2]; // 0 : Left Web,  1 : Right Web
	...
	T_VERTICAL_SHAER_RES_D_IRC(){ Initialize(); }
	T_VERTICAL_SHAER_RES_D_IRC(const T_VERTICAL_SHAER_RES_D_IRC& rData) {*this = rData; }
	T_VERTICAL_SHAER_RES_D_IRC& operator=(const T_VERTICAL_SHAER_RES_D_IRC& rD) 
	{
		dVbw_Rd = rD.dVbw_Rd;
		dVbf_Rd = rD.dVbf_Rd;
...
class CDgnPlateGirder_IRC : public CDgnPscCommon
{
// Member Functions.
public:
	CDgnPlateGirder_IRC();
	virtual ~CDgnPlateGirder_IRC();
...
public:
	...
	BOOL Make_ClassInD(BOOL bPosiI, double aGirderForce[6], double aCptForce[6], CPG_SECT_ELEM& rSectD, T_CLASS_IN_D_IRC& ClassInD);
	BOOL Make_ClassInD_I(BOOL bPosiI, double aGirderForce[6], double aCptForce[6], CPG_SECT_ELEM& rSectD, T_CLASS_IN_D_IRC& ClassInD);
	BOOL Make_ClassInD_Box(BOOL bPosiI, double aGirderForce[6], double aCptForce[6], CPG_SECT_ELEM& rSectD, T_CLASS_IN_D_IRC& ClassInD);
	BOOL Make_ClassInD_Tub(BOOL bPosiI, double aGirderForce[6], double aCptForce[6], CPG_SECT_ELEM& rSectD, T_CLASS_IN_D_IRC& ClassInD);
...
protected:
	...
	BOOL Get_SectionClass(bool bPosiI,BOOL bChkRestrained, const T_SECT_D& SectD, const T_CLASS_IN_D_IRC& crClassInD, const T_MATL_DESIGN& DgnMatD, T_CLAS_BASE& ClassD);
	BOOL Calc_OutstandClassUnit(const T_CLASS_IN_UNIT_D_IRC& ClassInD, double dfy, double dfy1, int& iClass,CLASS_BASE_UNIT_IRC& ClassBase);
	...
	BOOL Calc_InternalPlateClassUnit(bool bPosiI, const T_SECT_D& SectD,const T_CLASS_IN_UNIT_D_IRC& ClassInD, double dfy, double dfy1,int& iClass, CLASS_BASE_UNIT_IRC& ClassBase, bool bWeb = true);
	BOOL Calc_ClassifyClassSection4GenSect(BOOL bChkRestrained, double dfy, double dfy1, double* aGirderForce, double* dForce, double dPlasticNA, T_SECT_STIFFNESS& GirStiffD, T_SECT_STIFFNESS& CptStiffD, T_SECT_STIFFNESS& OrgStiffD, const T_GENL_DATA& GLineData, const T_GLINE_DGN_D& GLineDgn, T_DLINE_CALC_D& DLineCalcD);
	...
	BOOL Get_SectionClass(bool bPosiI,BOOL bChkRestrained, const T_SECT_D& SectD, const T_CLASS_IN_D_IRC& crClassInD, const T_MATD_D& DgnMatD, T_CLAS_BASE& ClassD);
	...
	BOOL Get_LineDgnInfo4SectDB(bool bPosiI, double dfy1, double dfy2, double dEs, double dPoisson, double* aForce, T_SECT_D& SectD, double da, T_SECT_STIFFNESS& AppStiff, CArray<CPG_LSTI_DATA,CPG_LSTI_DATA&>& arLstiPosi, CArray<T_GLINE_DGN_B,T_GLINE_DGN_B&>& aLineDgnBase, T_DGNLINE_LBD& LineLBD);
	...
	// General Section
public:
	BOOL Get_CalcSectInfo4EffeSect(double dfy1, double dfy2, double da, double* dForce, double dCzm_gap, double dStiff[3], const T_GENL_DATA& GLineData, const T_GLINE_DGN_D& GLineDgn, T_DLINE_CALC_D& DlineInfo);
	...
	BOOL Get_EffectiveSectData(BOOL bPosiI, BOOL bAfter, double dfy1, double dfy2, double da, double* dForce, CPG_SECT_ELEM& SectElem, const T_GENL_DATA& GLineData, T_DLINE_CALC_D& DLineInfo, T_GENL_DATA& EffGLineD, T_GLINE_DGN_D& EffGLineDgn);
...
protected:
	...
	BOOL Calc_Vbw_Rd(bool bPosiI,CPG_MATL_ELEM& MatlElem, T_SECT_D& SectD, CArray<CPG_LSTI_DATA,CPG_LSTI_DATA&>& arLstiPosi,  
					CPG_TRST_POSI& TrstPosi, CPG_TSES_POSI& TsesPosi, double& dVbw_Rd, T_VERTICAL_SHAER_RES_D_IRC& ResD);
	...
	BOOL Calc_Lambda_w(bool bPosiI, CPG_MATL_ELEM& MatdD, T_SECT_D& SectD, CArray<CPG_LSTI_DATA,CPG_LSTI_DATA&>& arLstiPosi, CPG_TRST_POSI& TrstPosi, 
					CPG_TSES_POSI& TsesPosi, double& Lambda_w, T_VERTICAL_SHAER_RES_UNIT_D_IRC& ResD);
...
protected:
	...
	void Convert_VerbShearResD(const T_VERTICAL_SHAER_RES_UNIT_D_IRC& InD, T_PRVS_BASE_UNIT& rData);
	// 임시 계산서 생성. 
public:
...
#endif // !defined(AFX_DgnPlateGirder_IRC_H__INCLUDED_)
