#if !defined(AFX_DGNSTEELSPCSECTGRID_H__)
#define AFX_DGNSTEELSPCSECTGRID_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnSteelSPCSectGrid.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnSteelSPCSectGrid window

class CDBDoc;
class CDgnStlSPCSectITabDlg;

class CDgnSteelSPCSectGrid : public CTBBrowserWnd
{
// Construction
public:
	CDgnSteelSPCSectGrid(int nElemCount);
	virtual ~CDgnSteelSPCSectGrid();
...
// Interface
public:
	void Initialize(CDgnStlSPCSectITabDlg* pParent);
	void MakeItemEx();
...
protected:
	...
	int m_nColHeader;
	int m_nColCount;
	CDgnStlSPCSectITabDlg* m_pParent;

	void SetHeaderTitle();  

	//{{AFX_MSG(CDgnSteelSPCSectGrid)
...
#endif // !defined(AFX_DGNSTEELSPCSECTGRID_H__)
