// AssessmentLoadCombSubGrid.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombSubGrid
CAssessmentLoadCombSubGrid::CAssessmentLoadCombSubGrid()
{
	m_pMainGrid = 0;
...
BEGIN_MESSAGE_MAP(CAssessmentLoadCombSubGrid, CTBBrowserWnd)
	//{{AFX_MSG_MAP(CAssessmentLoadCombSubGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()


/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombSubGrid message handlers
void CAssessmentLoadCombSubGrid::Initialize(CDBDoc* pDoc)
{
...
// Column별 헤더 이름을 설정한다.
void CAssessmentLoadCombSubGrid::SetHeaderTitle()
{
	CString title;
	int i;
	ROWCOL nCol;
...
void CAssessmentLoadCombSubGrid::SetLoadCaseColumnStyle(ROWCOL nCol)
{
...
BOOL CAssessmentLoadCombSubGrid::IsMainAppendRow()
{
	return m_sKey == _LS(IDS_WG_CMD__ADDD__Append_Row);
}

BOOL CAssessmentLoadCombSubGrid::IsMainNewRow()
{
	return m_sKey == _LS(IDS_WG_CMD__ADDD__New_Row);
}

BOOL CAssessmentLoadCombSubGrid::OnAddNewRecord(ROWCOL nRow)
{
...
BOOL CAssessmentLoadCombSubGrid::OnModifyRecord(ROWCOL nRow)
{
...
BOOL CAssessmentLoadCombSubGrid::OnDeleteRecord(ROWCOL nRow)
{
...
BOOL CAssessmentLoadCombSubGrid::OnDeleteRecords(CRowColArray &awRows)
{
...
BOOL CAssessmentLoadCombSubGrid::OnCanceledAddNew()
{
	BOOL bRetVal = CTBBrowserWnd::OnCanceledAddNew();
	return bRetVal;
}

BOOL CAssessmentLoadCombSubGrid::OnCanceledModify()
{
	BOOL bRetVal = CTBBrowserWnd::OnCanceledModify();
	return bRetVal;
}

BOOL CAssessmentLoadCombSubGrid::OnInsertEmptyRecord(ROWCOL nRow)
{
...
void CAssessmentLoadCombSubGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
	m_pMainGrid->SetModeEdit();// 먼저 호출되어야 한다. 주1 참조
	CTBBrowserWnd::OnModifyCell(nRow, nCol);
}

void CAssessmentLoadCombSubGrid::OnChangeStld()
{
	// 지워진 하중들은 제거한다.
	T_STLD_D stldData;
	T_SPLC_D splcData;
...
BOOL CAssessmentLoadCombSubGrid::OnValidateField(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CAssessmentLoadCombSubGrid::OnStartEditing(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CAssessmentLoadCombSubGrid::ValidataFieldDbl( ROWCOL nRow, ROWCOL nCol )
{
	CString value;
	int nErrCode;
...
void CAssessmentLoadCombSubGrid::SetData(CString sKey)
{
	m_sKey = sKey;
...
void CAssessmentLoadCombSubGrid::GetData(T_ALCS_D &data)
{
	int nAnalType;
	T_STLD_K nKey;
