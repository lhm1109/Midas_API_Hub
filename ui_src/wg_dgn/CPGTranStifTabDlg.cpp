// CPGTranStifTabDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CCPGTranStifTabDlg dialog


CCPGTranStifTabDlg::CCPGTranStifTabDlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCPGTranStifTabDlg::IDD, pParent)
{
	//전역변수 초기화
	

	//{{AFX_DATA_INIT(CCPGTranStifTabDlg)
	m_bUseStif = TRUE;
...
CCPGTranStifTabDlg::~CCPGTranStifTabDlg()
{
	
}

void CCPGTranStifTabDlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCPGTranStifTabDlg)
...
BEGIN_MESSAGE_MAP(CCPGTranStifTabDlg, CChildDialog)
	//{{AFX_MSG_MAP(CCPGTranStifTabDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCPGTranStifTabDlg message handlers


BOOL CCPGTranStifTabDlg::OnInitDialog() 
{
...
BOOL CCPGTranStifTabDlg::DestroyWindow() 
{
	Dlg2Data();
...
void CCPGTranStifTabDlg::SetInitUnit()
{
...
void CCPGTranStifTabDlg::OnUseStifChk() 
{
	UpdateData(TRUE);
...
void CCPGTranStifTabDlg::OnRigidChk() 
{
	UpdateData(TRUE);
...
void CCPGTranStifTabDlg::OnNonRigidChk() 
{
	UpdateData(TRUE);
...
void CCPGTranStifTabDlg::InitialDlgData()
{
	//m_Data.Initialize();
...
BOOL CCPGTranStifTabDlg::Data2Dlg()
{
...
BOOL CCPGTranStifTabDlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CCPGTranStifTabDlg::GetCgtsData()
{
	Dlg2Data();
...
void CCPGTranStifTabDlg::SetCgtsData()
{
	Data2Dlg();
}

void CCPGTranStifTabDlg::SetAllControlEnable(bool enable)
{
	//bool enable = true;
	...
	if(enable)
	{
		...
		//m_Ctrl_UseCheck.EnableWindow(enable);
		OnUseStifChk();
	}
	else
	{
