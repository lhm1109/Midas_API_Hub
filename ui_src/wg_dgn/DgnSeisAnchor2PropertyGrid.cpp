// DgnSeisAnchor2PropertyGrid.cpp : implementation file
...
CDgnSeisAnchor2PropertyGrid::CDgnSeisAnchor2PropertyGrid(CWnd* pParent/* = NULL*/)
{
	m_pParent = (CDgnSeisAnchorEvalItem2NewSubPropertyDlg*)pParent;

	m_pDoc = CDBDoc::GetDocPoint();

}

CDgnSeisAnchor2PropertyGrid::~CDgnSeisAnchor2PropertyGrid()
{
}

/////////////////////////////////////////////////////////////////////////////
// User Defined Function
void CDgnSeisAnchor2PropertyGrid::SetData2Grid(T_ANEV_BRPR_D& Data)
{
	...
	if (nRow > 0)
	{
		nCol = Data.aBrprKs[0].aBrprK.GetSize();  // 여기서는 NxM 행렬로 값이 채워져 있다.
	}
...
BOOL CDgnSeisAnchor2PropertyGrid::GetGrid2Data(T_ANEV_BRPR_D& Data)
{
...
void CDgnSeisAnchor2PropertyGrid::SetDataToRow(ROWCOL nRow, CStringArray& raValue)
{
...
BOOL CDgnSeisAnchor2PropertyGrid::GetRowToData(ROWCOL nRow, CStringArray& raValue)
{
	int nColCount = GetColCount();
	ASSERT(nColCount == raValue.GetSize());
...
CString CDgnSeisAnchor2PropertyGrid::GetEditingValue(ROWCOL nRow, ROWCOL nCol)
{
	CString strNum(_T(""));
	BOOL bGet = FALSE;
	ROWCOL ncRow, ncCol;
...
BEGIN_MESSAGE_MAP(CDgnSeisAnchor2PropertyGrid, CWnd)
#undef CWnd
	//{{AFX_MSG_MAP(CDgnSeisAnchor2PropertyGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

///////////////////////////////////////////////////////////////////////////
// CDgnSeisAnchor2PropertyGrid message handlers

// 그리드 초기화 
void CDgnSeisAnchor2PropertyGrid::Initialize()
{
...
BOOL CDgnSeisAnchor2PropertyGrid::GetStyleRowCol(ROWCOL nRow, ROWCOL nCol, CGXStyle& style, GXModifyType mt, int nType)
{
	BOOL bCurrentRow;
	BOOL bCurrentCell;
	BOOL bEnabled;
...
void CDgnSeisAnchor2PropertyGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CDgnSeisAnchor2PropertyGrid::OnPasteFromClipboard(const CGXRange &range)
{
	CGXGridWnd x;
	CGXRange r;
	CGXRange toRange;
...
BOOL CDgnSeisAnchor2PropertyGrid::VerifyPasteRange(CGXRange& from, CGXRange& to)
{
...
int CDgnSeisAnchor2PropertyGrid::GetSelectedRowsCount(int top, int bottom)
{
	int toRows;
	toRows = bottom - top + 1;
	return toRows;
...
int CDgnSeisAnchor2PropertyGrid::GetSelectedColsCount(int left, int right)
{
	int toCols;
	toCols = right - left + 1;
	return toCols;
...
void CDgnSeisAnchor2PropertyGrid::ShowData()
{
	ROWCOL nRow, nCol;
...
void CDgnSeisAnchor2PropertyGrid::SetViewData()
{
	m_pParent->SetViewData();
}

BOOL CDgnSeisAnchor2PropertyGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
	CRowColArray awRows;
...
BOOL CDgnSeisAnchor2PropertyGrid::SetRightValidCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CDgnSeisAnchor2PropertyGrid::SetLeftValidCell(ROWCOL nRow, ROWCOL nCol)
{
