// RptTB_PSC_10002_3_05_CH.cpp: implementation of the RptTB_PSC_10002_3_05_CH class.
//
//////////////////////////////////////////////////////////////////////
...
#include "RptTB_PSC_10002_3_05_CH.h"
#include <winbase.h>
...
CRptTB_PSC_10002_3_05_CH::CRptTB_PSC_10002_3_05_CH()
{
    ...
    if(m_PscdD.iDgnCode==TB_10002_3_05)
    {
     ...
     //++++++++++++++++++++++++++++++++++++++
        ...
        if(aSelElemK.GetSize()==0)	// All Design.
        {
            ...
            for(int i=0; i<iTotElemNum; i++)
            {
                ...
                int iPoscNum = m_pDoc->m_pAttrCtrl->GetCountPosc();
                BOOL bGetOK = m_pDoc->m_pAttrCtrl->GetPosc(ElemK, PoscD);
...
CString CRptTB_PSC_10002_3_05_CH::GetFilePathName()
{
...
BOOL CRptTB_PSC_10002_3_05_CH::Get_DetailBdcyPos(T_ELEM_K ElemK)
{
    //++++++++++++by maxiao
return TRUE; 
}

BOOL CRptTB_PSC_10002_3_05_CH::Get_DetailBdcyNeg(T_ELEM_K ElemK)
{
    //++++++++++++by maxiao
return TRUE; 
}
...
//!/
BOOL CRptTB_PSC_10002_3_05_CH::MakeData()
{
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeDataFromDB()
{
    GetMaterialProperty();
...
void CRptTB_PSC_10002_3_05_CH::InitializeData()
{
    m_pRptData->m_TitleType[3] = 1; // Title4ÀÇ Çü½ÄÀ» (1)·Î º¯°æ
    m_iChapNum = 1;
}

BOOL CRptTB_PSC_10002_3_05_CH::MakeDefaultStyle()
{
...
// 0-1. Ç¥Áö Data ±¸¼º.
BOOL CRptTB_PSC_10002_3_05_CH::MakeCoverData()
{
...
// 0-2. ¸ñÂ÷ Data¸¦ ±¸¼º.
BOOL CRptTB_PSC_10002_3_05_CH::MakeContents()
{
    return TRUE;  
}

// 1. è¼Æ¹æ·?
BOOL CRptTB_PSC_10002_3_05_CH::MakeCodes()
{
    ...
    arStringCode[0] = _T("ÌúÂ·ÇÅº­");
    arStringCode[1] = _T("ÌúÂ·¸Ö½î»ìÄýÍÁºÍÔ¤Ó¦Á¦»ìÄýÍÁ½á¹¹");
    arStringCode[2] = _T("ÌúÂ·¹¤³Ì¿¹Õð");
...
// 2. ¼³°èÀÚ·á Data¸¦ ±¸¼ºÇÔ.
BOOL CRptTB_PSC_10002_3_05_CH::MakeDesignParameter()
{
    T_CHAP_K ChapK, Chap2K;
    T_CHAP_RPT ChapD; ChapD.Initialize();
    T_CHAP_RPT Chap2D; Chap2D.Initialize();
...
// 3. ÀçÁú Data¸¦ ±¸¼ºÇÔ.
BOOL CRptTB_PSC_10002_3_05_CH::MakeMaterialData()
{
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeModelData()
{
    CString strTitle, strText;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeLComData()
{
    CString strText;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeCheckResultTable()
{
    ...
    //////////////////////////////////////////////////////////////////////////
    //////////Ô¤Ó¦Á¦ÁºµÄÑéËã
    if (m_PscdD.bBeamPrintCH[0])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­Ô¤Ó¦Á¦¶ÈÑéËã(6.1.3)"));
        if (MakeBeam_PSCdegree(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[1])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­´«Á¦Ãª¹Ì½×¶Î»ìÄýÍÁ·¨ÏòÓ¦Á¦ÑéËã(6.4.4)"));
        if (MakeBeam_con_CS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[2])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­´«Á¦Ãª¹Ì½×¶ÎÔ¤Ó¦Á¦¸Ö½îÓ¦Á¦ÑéËã(6.4.3)"));
        if (MakeBeam_tendon_CS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[3])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶ÎÕý½ØÃæ¿¹ÁÑÑéËã(6.3.9-2)"));
        if (MakeBeam_cross_fracture(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[4])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶ÎÐ±½ØÃæ¿¹ÁÑÑéËã(6.3.9-4, 6.3.9-5)"));
        if (MakeBeam_incline_fracture(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[6])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶Î»ìÄýÍÁÖ÷À­Ó¦Á¦(6.3.12)"));
        if (MakeBeam_incline_tp(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[5])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶Î»ìÄýÍÁÑ¹Ó¦Á¦ÑéËã(6.3.10)"));
        if (MakeBeam_con_c_SS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[7])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶Î»ìÄýÍÁÀ­Ó¦Á¦ÑéËã(6.3.11)"));
        if (MakeBeam_con_t_SS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[8])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶ÎÔ¤Ó¦Á¦¸Ö½îÓ¦Á¦ÑéËã(6.3.13)"));
        if (MakeBeam_tendon_SS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[9])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶ÎÔ¤Ó¦Á¦¸Ö½îÓ¦Á¦·ùÑéËã(6.3.14)"));
        if (MakeBeam_delta_tendon(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[10])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶Î»ìÄýÍÁ¼ôÓ¦Á¦ÑéËã(6.3.15)"));
    ...
    if (m_PscdD.bBeamPrintCH[11])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­ÔËÓª½×¶ÎÁÑ·ì¿í¶ÈÑéËã(6.3.18)"));
    ...
    if (m_PscdD.bBeamPrintCH[12])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­Õý½ØÃæ¿¹ÍäÑéËã(6.2.2, 6.2.3)"));
        if (MakeBeam_crossbend(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bBeamPrintCH[13])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÁº£­Ð±½ØÃæ¿¹¼ôÑéËã(C.0.2)"));
        if (MakeBeam_inclineshear(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    //////////Ô¤Ó¦Á¦ÖùµÄÑéËã
    if (m_PscdD.bColumnPrintCH[0])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­Ô¤Ó¦Á¦¶ÈÑéËã(6.1.3)"));
        if (MakeColumn_PSCdegree(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[1])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­´«Á¦Ãª¹Ì½×¶Î»ìÄýÍÁ·¨ÏòÓ¦Á¦ÑéËã(6.4.4)"));
        if (MakeColumn_con_CS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[2])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­´«Á¦Ãª¹Ì½×¶ÎÔ¤Ó¦Á¦¸Ö½îÓ¦Á¦ÑéËã(6.4.3)"));
        if (MakeColumn_tendon_CS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[3])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­ÔËÓª½×¶ÎÕý½ØÃæ¿¹ÁÑÑéËã(6.3.9-2, 6.3.9-2)"));
        if (MakeColumn_cross_fracture(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[4])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­ÔËÓª½×¶Î»ìÄýÍÁÑ¹Ó¦Á¦ÑéËã(6.3.10)"));
        if (MakeColumn_con_c_SS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[5])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­ÔËÓª½×¶Î»ìÄýÍÁÀ­Ó¦Á¦ÑéËã(6.3.11)"));
        if (MakeColumn_con_t_SS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[6])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­ÔËÓª½×¶ÎÔ¤Ó¦Á¦¸Ö½îÓ¦Á¦ÑéËã(6.3.13)"));
        if (MakeColumn_tendon_SS(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[7])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­ÔËÓª½×¶Î»ìÄýÍÁ¼ôÓ¦Á¦ÑéËã(6.3.15)"));
    ...
    if (m_PscdD.bColumnPrintCH[8])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­Õý½ØÃæ¿¹Ñ¹Ç¿¶ÈÑéËã(6.2.5)"));
        if (MakeColumn_compressive(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
    ...
    if (m_PscdD.bColumnPrintCH[9])
    {
        Chap2D = MakeChapter(2, iChap2DCount, _T("PSCÖù£­Õý½ØÃæ¿¹À­Ç¿¶ÈÑéËã(6.2.7)"));
        if (MakeColumn_tension(iChap2DCount, ParaD))
        {
            m_pRptData->AddParaData(ParaK, ParaD);
            Chap2D.arParaK.Add(ParaK);
            m_pRptData->AddChapData(Chap2K, Chap2D);
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeConcData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
// 3.2. ÇÁ¸®½ºÆ®·¹½º Ã¶±Ù.
BOOL CRptTB_PSC_10002_3_05_CH::MakePrestressRebar(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
    ...
    strText = _LS(IDS_DGN_PSC_RPTJTG_Elastic_Modulus);
    thData.arTDK.Add(AddTDwithUnit(strText, m_strStressUnit, 1)); // _T("Åº¼º°è¼ö")
    strText = _LS(IDS_DGN_PSC_RPTJTG_Density);          // _T("´ÜÀ§Áß·®")
    arCharK.RemoveAll();
    AddChar(arCharK, m_strDensityUnit, 1, 5, 1);
    ...
    int iTdntNumber = 0;// m_pTB_10002_3_05_CH->->m_arTndnTdnt.GetSize();
    for (int i = 0; i < iTdntNumber; i++)
    {
        _PSC_TNDN_TDNT TndnTdnt;
        //TndnTdnt = m_pTB_10002_3_05_CH->m_arTndnTdnt.GetAt(i);
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeTensionRebar(int& iChapID, T_PARA_RPT& paraD)
{
    //++++++++++++by maxiao
    return TRUE;
}
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeShearRebar(int& iChapID, T_PARA_RPT& paraD)
{
    //++++++++++++++by maxiao
    return FALSE;
}
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeRebar(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
// 4.5. Stage Data ±¸¼º.
BOOL CRptTB_PSC_10002_3_05_CH::MakeStageGroupSummaryData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeElemGroupData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBoundaryGroupData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeLoadGroupData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeServiceStageLoadData(int iChapID, T_CHAP_RPT& chapD)
{
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeLiveLoadData(T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeSystemTempData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeNodalTempData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeElemTempData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeTempGradientData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeamSectTempData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeSpecifiedDispData(T_PARA_RPT& paraD)
{
    int iExistCount = 0;
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeStaticLoadCaseData(int& iChapID, T_PARA_RPT& paraD)
{
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeResponseSpectrumData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = 0;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeTimeHistoryData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeMovingLoadData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeSettlementData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeGridLoadData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeLoadCombCaseData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeLoadCombData(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_PSCdegree(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.Initialize();
    CString strText = _T("");
    CString aHeadNames1[] = { _LS(IDS_TB_PSCD_FYSG_JTG_ELEM),_LS(IDS_TB_PSCD_FYSG_JTG_PART),_LS(IDS_TB_PSCD_CUMS_JTG_LOAD),
        _LS(IDS_TB_PSCD_CUMS_JTG_TYPE),_LS(IDS_TB_PSCD_FYSG_JTG_OK) };
    for (int i = 0; i < 5; i++)
    {
        thData.arTDK.Add(AddTDString(aHeadNames1[i], 1, 1, 1));
    }
    CString ctype[] = { _T("-"),_T("Fxmax"),_T("Fymax"),_T("Fzmax"),_T("Mxmax"),_T("Mymax"),_T("Mzmax"),_T("Fxmin"),_T("Fymin"),_T("Fzmin"),_T("Mxmin"),_T("Mymin"),_T("Mzmin") };
    thData.arTDK.Add(AddTDString(_T("¦Ë_TL"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("¦Ë_TR"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("¦Ë_BR"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("¦Ë_BL"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("¦Ë_T "), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("¦Ë_B "), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("¦Ëmax"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("[¦Ë] "), 1, 1, 1));
    ...
    {
        T_BEAM_PREDEGREE_CH predegree;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamPscTBData(m_arElemKeyList[i], predegree);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            PREDEGREE predegreeBase = predegree.dataBase[j];
            if (predegreeBase.bCHK)
            {
                ...
                strText = GetLoadCombName(predegreeBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = ctype[predegreeBase.itype];
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (predegreeBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                if (predegreeBase.dTL > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dTL);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                if (predegreeBase.dTR > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dTR);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                if (predegreeBase.dBR > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dBR);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                if (predegreeBase.dBL > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dBL);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                if (predegreeBase.dT > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dT);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                if (predegreeBase.dB > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dB);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                if (predegreeBase.dLamda > -m_dZero) strText = _T("-"); else strText.Format(_T("%.3f"), predegreeBase.dLamda);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), predegreeBase.dALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_con_CS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    CString aHeadNames1[] = { _LS(IDS_TB_PSCD_FYSG_JTG_ELEM),_LS(IDS_TB_PSCD_FYSG_JTG_PART),_LS(IDS_TB_PSCD_FYSG_JTG_MAX_MIN),
         _LS(IDS_TB_PSCD_FYSG_JTG_STAGE), _LS(IDS_TB_PSCD_FYSG_JTG_OK) };
    ...
    {
        T_CON_CS_CH con_cs;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamConCSTBData(m_arElemKeyList[i], con_cs);
        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            CON_CS con_csBase = con_cs.dataBase[j];
            if (con_csBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));
                ...
                T_STAG_D stagD;
                m_pDoc->m_pAttrCtrl->GetStag(con_csBase.StagK, stagD);
                tdData.arTDK.Add(AddTDString(stagD.StageName, 0, 1, 2, m_TDCenterCssK));

                strText = (con_csBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_T);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_TL);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_TR);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_MAX);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));
                ...
                strText.Format(_T("%.3f"), con_csBase.dSig_B);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_BL);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_csBase.dSig_BR);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_tendon_CS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    CString aHeadNames1[] = { _LS(IDS_TB_PSCD_FYPC_JTG_TNDN),_LS(IDS_TB_PSCD_FYSG_JTG_ELEM),_LS(IDS_TB_PSCD_FYSG_JTG_PART),
        _LS(IDS_TB_PSCD_FYSG_JTG_OK),_LS(IDS_TB_TDGR_ARRG_STAGE) };
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("¦Òp"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("[¦Òp]"), m_strStressUnit, 1, 1, 1));
    ...
    {
        T_TENDON_CS_CH tendon;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamTendonCSTBData(m_arTdnaK[i], tendon);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            TENDON_CS tendonBase = tendon.dataBase[j];
            if (tendonBase.bCHK)
            {

                //strText.Format(_T("%d"), tendonBase.iTendon);
                T_TDNA_D TdnaD;
                if (CDBDoc::GetDocPoint()->m_pAttrCtrl->GetTdna(tendonBase.iTendon, TdnaD))
                    strText = TdnaD.TendonName;
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%d"), tendonBase.iElem);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (tendonBase.iPos < 1) ? _T("I") : _T("J");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (tendonBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                T_STAG_D stagD;
                m_pDoc->m_pAttrCtrl->GetStag(tendonBase.iStage, stagD);
                tdData.arTDK.Add(AddTDString(stagD.StageName, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), tendonBase.dSigP);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), tendonBase.dSig_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_cross_fracture(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    CString aHeadNames1[] = { _LS(IDS_TB_PSCD_FYSG_JTG_ELEM),_LS(IDS_TB_PSCD_FYSG_JTG_PART),_LS(IDS_TB_PSCD_CUMS_JTG_TYPE),
        _LS(IDS_TB_PSCD_CUMS_JTG_LOAD),_LS(IDS_TB_PSCD_FYSG_JTG_OK) };
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("¦Ò"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("¦Òc"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("¦Ãfct"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("Kf"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("[Kf]"), 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("¦Òct"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("[¦Òct]"), m_strStressUnit, 1, 1, 1));
    ...
    CString aType[] = { _T("TL"),_T("TR"),_T("BR"),_T("BL"),_T("T"),_T("B") };

    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_CON_CROSS_FRACTURE_CH con_cross_fracture;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamCrossFractureTBData(m_arElemKeyList[i], con_cross_fracture);
        for (int j = 0; j < 12; j++)
        {
            tdData.Initialize();
            CON_CROSS_FRACTURE con_cross_fractureBase = con_cross_fracture.dataBase[j];
            if (con_cross_fractureBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText = aType[con_cross_fractureBase.iCheckPos];
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = GetLoadCombName(con_cross_fractureBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (con_cross_fractureBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                if (con_cross_fractureBase.itype == 1) strText = _T("-");
                else strText.Format(_T("%.4f"), con_cross_fractureBase.dSig);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                if (con_cross_fractureBase.itype == 1) strText = _T("-");
                else 	strText.Format(_T("%.4f"), con_cross_fractureBase.dSigc);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                if (con_cross_fractureBase.itype == 1) strText = _T("-");
                else strText.Format(_T("%.4f"), con_cross_fractureBase.drfct);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                //by maxiao 2010-4-20
                if (con_cross_fractureBase.itype == 1
                    || con_cross_fractureBase.dSig >= 0.0) strText = _T("-");
                else strText.Format(_T("%.4f"), con_cross_fractureBase.dKf);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                if (con_cross_fractureBase.itype == 1) strText = _T("-");
                else 	strText.Format(_T("%.4f"), con_cross_fractureBase.dKf_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.4f"), con_cross_fractureBase.dSigct);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.4f"), con_cross_fractureBase.dSigct_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_incline_fracture(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    CString aHeadNames1[] = { _LS(IDS_TB_PSCD_FPMS_JTG_ELEM), _LS(IDS_TB_PSCD_FPMS_JTG_PART),_LS(IDS_TB_PSCD_FPMS_JTG_MAX_MIN),
        _LS(IDS_TB_PSCD_FPMS_JTG_LOAD),  _LS(IDS_TB_PSCD_FYSG_JTG_OK) };
    for (int i = 0; i < 5; i++)
    {
        thData.arTDK.Add(AddTDString(aHeadNames1[i], 1, 1, 2));
    }
    ...
    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_CON_INCLINE_FRACTURE_CH	 con_incline_fracture;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamInclineFractureTBData(m_arElemKeyList[i], con_incline_fracture);

        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            CON_INCLINE_FRACTURE con_incline_fractureBase = con_incline_fracture.dataBase[j];

            if (con_incline_fractureBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));
                ...
                strText = GetLoadCombName(con_incline_fractureBase.LcomK);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText = (con_incline_fractureBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_incline_fractureBase.dSig_MAX);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_incline_fractureBase.dSig_AP);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                double dFP1[] = { con_incline_fractureBase.dSig_P1, con_incline_fractureBase.dSig_P2, con_incline_fractureBase.dSig_P3,
                                    con_incline_fractureBase.dSig_P4, con_incline_fractureBase.dSig_P5 };
                for (int k = 0; k < 5; k++)
                {
                ...
                tdData.Initialize();
                double dFp6[] = { con_incline_fractureBase.dSig_P6, con_incline_fractureBase.dSig_P7, con_incline_fractureBase.dSig_P8,
                                    con_incline_fractureBase.dSig_P9, con_incline_fractureBase.dSig_P10 };
                for (int k = 0; k < 5; k++)
                {
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_incline_tp(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_CON_TP_CH con_tp;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamInclineTpTBData(m_arElemKeyList[i], con_tp);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();

            int index = j * 2 + 1;
            CON_TP con_tpBase = con_tp.dataBase[index];
            ...
            if (con_tpBase.bCHK)
            {
                ...
                strText = GetLoadCombName(con_tpBase.LcomK);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText = (con_tpBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_tpBase.dSig_MAX);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_tpBase.dSig_AP);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 2, m_TDCenterCssK));

                double dFP1[] = { con_tpBase.dSig_P1, con_tpBase.dSig_P2, con_tpBase.dSig_P3,
                                    con_tpBase.dSig_P4, con_tpBase.dSig_P5 };
                for (int k = 0; k < 5; k++)
                {
                    strText.Format(_T("%.3f"), dFP1[k]);
                    tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                tdData.Initialize();
                double dFp6[] = { con_tpBase.dSig_P6, con_tpBase.dSig_P7, con_tpBase.dSig_P8,
                                    con_tpBase.dSig_P9, con_tpBase.dSig_P10 };
                for (int k = 0; k < 5; k++)
                {
                    strText.Format(_T("%.3f"), dFp6[k]);
                    tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_con_c_SS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    CString aHeadNames1[] = { _LS(IDS_TB_PSCD_FYSG_JTG_ELEM),_LS(IDS_TB_PSCD_FYSG_JTG_PART),
        _LS(IDS_TB_PSCD_CUMS_JTG_TYPE),_LS(IDS_TB_PSCD_CUMS_JTG_LOAD), _LS(IDS_TB_PSCD_FYSG_JTG_OK) };
    ...
    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_CON_SS_CH con_ss;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamConCSSTBData(m_arElemKeyList[i], con_ss);
        for (int j = 0; j < 12; j++)
        {
            tdData.Initialize();
            CON_SS con_ssBase = con_ss.dataBase[j];
            if (con_ssBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText = aType[con_ssBase.itype];
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = GetLoadCombName(con_ssBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (con_ssBase.bOK) ? _T("OK") : _T("NG");
                if (con_ssBase.dSig < -m_dZero) strText = _T("-");//By maxiao 2010-5-6 BJ[Luoyan]	
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_ssBase.dSig);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), con_ssBase.dSig_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_con_t_SS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_BEAM_CON_SS_CH con_ss;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamConTSSTBData(m_arElemKeyList[i], con_ss);
        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            CON_SS con_ssBase = con_ss.dataBase[j];
            if (con_ssBase.bCHK)
            {
                ...
                strText = GetLoadCombType(con_ssBase.itype);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_tendon_SS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    for (int i = 0; i < m_iTendonNum; i++)
    {
        T_BEAM_TENDON_CH tendon;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamTendonSSTBData(m_arTdnaK[i], tendon);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            TENDON tendonBase = tendon.dataBase[j];
            if (tendonBase.bCHK)
            {
                ...
                strText = (tendonBase.iPosi < 1) ? _T("I") : _T("J");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = GetLoadCombName(tendonBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                //        strText = GetLoadCombType(tendonBase.itype);
                //        tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_delta_tendon(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_BEAM_TENDON_CH tendon;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamDeltaTendonTBData(m_arTdnaK[i], tendon);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            TENDON tendonBase = tendon.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_shear(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_xz5"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_xz6"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_xz7"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_xz8"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_xz9"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_xz10"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_MAX"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_Axz"), m_strStressUnit, 1, 1, 1));
    ...
    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_SHEAR_CH shear;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamShearTBData(m_arElemKeyList[i], shear);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            SHEAR shearBase = shear.dataBase[j];
            if (shearBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText = GetLoadCombName(shearBase.Lcomk);
                strText = _T("-");  T_LCOM_D lcomD;
                if (m_pDoc->m_pAttrCtrl->GetLcom(D_LCOMTYPE_CONCRETE, shearBase.Lcomk, lcomD))
                    strText = lcomD.LoadCombName;

                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (shearBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear5);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear6);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear7);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear8);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear9);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear10);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshearc);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), shearBase.dshear_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_crack(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("Wfk"), m_strLengthUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("[Wfk]"), m_strLengthUnit, 1, 1, 1));
    ...
    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_PSCCRACK_CH crack;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamCrackTBData(m_arElemKeyList[i], crack);
        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            PSCCRACK crackBase = crack.dataBase[j];
            if (crackBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText.Format(_T("%.3f"), crackBase.dwfk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), crackBase.dwfk_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_crossbend(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("Mn"), m_strMomentUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("K"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("[K]"), 1, 1, 1));
    ...
    {
        T_BEAM_BEND_CH bend;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamCrossBendTBData(m_arElemKeyList[i], bend);
        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            BEND bendBase = bend.dataBase[j];
            if (bendBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText = GetLoadCombName(bendBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = GetLoadCombType(bendBase.itype);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (bendBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), bendBase.dMy*m_dMomentkNM);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), bendBase.dMn*m_dMomentkNM);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), bendBase.dK);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), bendBase.dK_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeBeam_inclineshear(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("Vn"), m_strForceUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("K"), 1, 1, 1));
    thData.arTDK.Add(AddTDString(_T("[K]"), 1, 1, 1));
    ...
    for (int i = 0; i < m_iElemNum; i++)
    {
        T_BEAM_INCLINE_SHEAR_CH incline_shear;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetBeamInclineShearTBData(m_arElemKeyList[i], incline_shear);
        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            INCLINE_SHEAR incline_shearBase = incline_shear.dataBase[j];
            if (incline_shearBase.bCHK)
            {
                strText.Format(_T("%d"), m_arElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText = GetLoadCombName(incline_shearBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = GetLoadCombType(incline_shearBase.itype);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (incline_shearBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), incline_shearBase.dVz* m_dForcekN);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), incline_shearBase.dVn* m_dForcekN);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), incline_shearBase.dK);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), incline_shearBase.dK_ALW);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_PSCdegree(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_COLUMN_PREDEGREE_CH predegree;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnPSCTBData(m_arColumnElemKeyList[i], predegree);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            PREDEGREE predegreeBase = predegree.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_con_CS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_CON_CS_CH con_cs;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnConCSTBData(m_arColumnElemKeyList[i], con_cs);
        for (int j = 0; j < 4; j++)
        {
            tdData.Initialize();
            CON_CS con_csBase = con_cs.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_tendon_CS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_TENDON_CS_CH tendon;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnTendonCSTBData(m_arTdnaK[i], tendon);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            TENDON_CS tendonBase = tendon.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_cross_fracture(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    for (int i = 0; i < m_iColumnElemNum; i++)
    {
        T_COLUMN_CON_CROSS_FRACTURE_CH con_cross_fracture;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnCrossFractureTBData(m_arColumnElemKeyList[i], con_cross_fracture);
        for (int j = 0; j < 12; j++)
        {
            tdData.Initialize();
            CON_CROSS_FRACTURE con_cross_fractureBase = con_cross_fracture.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_con_c_SS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    for (int i = 0; i < m_iColumnElemNum; i++)
    {
        T_COLUMN_CON_SS_CH con_ss;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnConCSSTBData(m_arColumnElemKeyList[i], con_ss);
        for (int j = 0; j < 12; j++)
        {
            tdData.Initialize();
            CON_SS con_ssBase = con_ss.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_con_t_SS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_COLUMN_CON_SS_CH con_ss;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnConTSSTBData(m_arColumnElemKeyList[i], con_ss);
        for (int j = 0; j < 8; j++)
        {
            tdData.Initialize();
            CON_SS con_ssBase = con_ss.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_tendon_SS(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    for (int i = 0; i < m_iTendonNum; i++)
    {
        T_COLUMN_TENDON_CH tendon;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnTendonSSTBData(m_arTdnaK[i], tendon);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            TENDON tendonBase = tendon.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_shear(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("Shear-y"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Shear-z"), m_strStressUnit, 1, 1, 1));
    //  thData.arTDK.Add(AddTDwithUnit(_T("Sig_MyMax"), m_strStressUnit, 1, 1, 1));
    //  thData.arTDK.Add(AddTDwithUnit(_T("Sig_MyMin"), m_strStressUnit, 1, 1, 1));
    //  thData.arTDK.Add(AddTDwithUnit(_T("Sig_MzMax"), m_strStressUnit, 1, 1, 1));
    //  thData.arTDK.Add(AddTDwithUnit(_T("Sig_Mzmin"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_MAX"), m_strStressUnit, 1, 1, 1));
    thData.arTDK.Add(AddTDwithUnit(_T("Sig_Axz"), m_strStressUnit, 1, 1, 1));
    ...
    for (int i = 0; i < m_iColumnElemNum; i++)
    {
        T_COLUMN_SHEAR_CH shear;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnShearTBData(m_arColumnElemKeyList[i], shear);
        for (int j = 0; j < 2; j++)
        {
            tdData.Initialize();
            SHEAR shearBase = shear.dataBase[j];
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_compressive(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    thData.arTDK.Add(AddTDwithUnit(_T("KN"), m_strForceUnit, 1, 1, 1));
    ...
    CString aType[] = { _LS(IDS_TB_PSCD_FX_MAX), _LS(IDS_TB_PSCD_FY_MAX),_LS(IDS_TB_PSCD_FZ_MAX),
                              _LS(IDS_TB_PSCD_MX_MAX), _LS(IDS_TB_PSCD_MY_MAX),_LS(IDS_TB_PSCD_MZ_MAX),
                              _LS(IDS_TB_PSCD_FX_MIN), _LS(IDS_TB_PSCD_FY_MIN),_LS(IDS_TB_PSCD_FZ_MIN),
                                                    _LS(IDS_TB_PSCD_MX_MIN), _LS(IDS_TB_PSCD_MY_MIN),  _LS(IDS_TB_PSCD_MZ_MIN) };

    for (int i = 0; i < m_iColumnElemNum; i++)
    {
        T_COLUMN_STRENGTH_CH strength;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnCompressiveTBData(m_arColumnElemKeyList[i], strength);
        for (int j = 0; j < 12; j++)
        {
            tdData.Initialize();
            COLUMN_STRENGTH strengthBase = strength.dataBase[j];
            if (strengthBase.bCHK)
            {
                strText.Format(_T("%d"), m_arColumnElemKeyList[i]);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
                ...
                strText = GetLoadCombName(strengthBase.Lcomk);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = aType[strengthBase.itype];
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText = (strengthBase.bOK) ? _T("OK") : _T("NG");
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), strengthBase.dKN * m_dForcekN);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));

                strText.Format(_T("%.3f"), strengthBase.dN * m_dForcekN);
                tdData.arTDK.Add(AddTDString(strText, 0, 1, 1, m_TDCenterCssK));
...
BOOL CRptTB_PSC_10002_3_05_CH::MakeColumn_tension(int& iChapID, T_PARA_RPT& paraD)
{
    int iExistCount = FALSE;
    paraD.Initialize();
    ...
    {
        T_COLUMN_STRENGTH_CH strength;
        m_pDoc->m_pPostCtrl->GetAnalysisResult()->GetColumnTensionTBData(m_arColumnElemKeyList[i], strength);
        for (int j = 0; j < 12; j++)
        {
            tdData.Initialize();
            COLUMN_STRENGTH strengthBase = strength.dataBase[j];
...
CString CRptTB_PSC_10002_3_05_CH::GetFileDate()
{
    CString strDate = _T("");
...
// Ãæ°Ý°è¼ö °ªÀ» °¡Á®¿È.
CString CRptTB_PSC_10002_3_05_CH::GetImpactCoefficient()
{
...
CString CRptTB_PSC_10002_3_05_CH::GetBeamSectTempLoadDirection(int iDir)
{
    CString strText = _T("");
    if (iDir == 0)
    {
...
CString CRptTB_PSC_10002_3_05_CH::GetLcombActiveType(int iActiveType)
{
    CString strText = _T("");
...
CString CRptTB_PSC_10002_3_05_CH::GetStageActivationType(int iCondition)
{
    CString strText = _T("");
...
CString CRptTB_PSC_10002_3_05_CH::GetStageTotalType(int iSummary)
{
    return (iSummary == 1) ? _T("O") : _T("");
}

// ¼³°è¿ë ÇÏÁßÁ¶ÇÕ Key¸¦ ÀÔ·Â¹Þ¾Æ ½ÇÁ¦ ÇÏÁßÁ¶ÇÕÀÇ ÀÌ¸§ ±¸ÇÔ.
CString CRptTB_PSC_10002_3_05_CH::GetLoadCombName(T_LCOM_K lcomK)
{
    T_LCOM_K orglcomK;
    T_LCOM_D lcomD;
...
CString CRptTB_PSC_10002_3_05_CH::GetStaticLoadCaseName(T_STLD_K stldK)
{
    T_STLD_D stldD;
...
CString CRptTB_PSC_10002_3_05_CH::GetLoadCombType(int iMaxType)
{
...
CString CRptTB_PSC_10002_3_05_CH::GetTopBottomType(int iLocType)
{
...
CString CRptTB_PSC_10002_3_05_CH::GetMaxMinType(int iMaxType)
{
...
CString CRptTB_PSC_10002_3_05_CH::GetMaxMinTypeShear(int iMaxType)
{
...
void CRptTB_PSC_10002_3_05_CH::GetElementGroupList(T_STAG_K stagK, CArray<T_TEXT_K, T_TEXT_K>& arActiveK, CArray<T_TEXT_K, T_TEXT_K>& arDeactiveK)
{
    arActiveK.RemoveAll();
...
void CRptTB_PSC_10002_3_05_CH::GetBoundaryGroupList(T_STAG_K stagK, CArray<T_TEXT_K, T_TEXT_K>& arActiveK, CArray<T_TEXT_K, T_TEXT_K>& arDeactiveK)
{
    arActiveK.RemoveAll();
    arDeactiveK.RemoveAll();
...
void CRptTB_PSC_10002_3_05_CH::GetLoadGroupList(T_STAG_K stagK, CArray<T_TEXT_K, T_TEXT_K>& arActiveK, CArray<T_TEXT_K, T_TEXT_K>& arDeactiveK)
{
    arActiveK.RemoveAll();
    arDeactiveK.RemoveAll();
...
//   iNumber : ¹Ù²Ü ¼ýÀÚ.
CString CRptTB_PSC_10002_3_05_CH::GetNumberCharacterForChina(int iNumber)
{
    CString result = _T("");
    switch (iNumber)
    {
...
//   iYY : ³âµµ.
//   iMM : ´Þ.
CString CRptTB_PSC_10002_3_05_CH::GetFileDateForChina(int iYY, int iMM)
{
    TCHAR i_str[32] = _T("");
...
BOOL CRptTB_PSC_10002_3_05_CH::GetTendonMatlData(CString strTndnName, double& dEc, double& dDensity, double& dThermal)
{
    //++++++++++++++++++++++++++++++++++++++++++++
    // <Remember> Get Data by Code Units.
    T_UNIT_INDEX CurIndex;
...
CString CRptTB_PSC_10002_3_05_CH::GetLiveLoadTypeDescription(CString strTypeName)
{
    CString result = _T("");
...
CString CRptTB_PSC_10002_3_05_CH::GetLoadCaseDescription(CString strCaseName)
{
    CString result = _T("");
...
void CRptTB_PSC_10002_3_05_CH::GetLoadCombinationCases(CMap<CString, LPCTSTR, CString, CString&>& mapLcom)
{
...
CString CRptTB_PSC_10002_3_05_CH::GetConstructionStageLoadCaseSymbol(T_SGLD_K sgldK)
{
...
BOOL CRptTB_PSC_10002_3_05_CH::CheckExistTemperatureLoad()
{  
    int iTempCount = 0;
    CArray<T_STLD_K, T_STLD_K> arStldKeyList;
    m_pDoc->m_pAttrCtrl->GetStldKeyList(arStldKeyList);
...
BOOL CRptTB_PSC_10002_3_05_CH::CheckExistResultTableItem()
{
    int iTableCount = 0;

    for(int i=0; i<14; i++)
    {   
        if (m_PscdD.bBeamPrintCH[i]) iTableCount += 1;
    }
    for (int i=0; i<10; i++) {
        if (m_PscdD.bColumnPrintCH[i]) iTableCount += 1;
    }
...
// T_CHAP_RPT Data »ý¼º.
T_CHAP_RPT CRptTB_PSC_10002_3_05_CH::MakeChapter(int iLevel, int iChapID, CString strText, T_CSS_K cssK/*0*/)
{
    T_CHAP_RPT chapD;
    chapD.Initialize();
    chapD.nLevel = iLevel;
...
BOOL CRptTB_PSC_10002_3_05_CH::GetDesignStringPara(CStringArray& arrString)
{ 
    CString strText;
    // ¼³°è´Ü¸é·Â ¼ººÐ.  
...
BOOL CRptTB_PSC_10002_3_05_CH::GetMaterialProperty()
{  
...
CString CRptTB_PSC_10002_3_05_CH::GetModifyString(int iMaxLength, CString strText)
{
    CString str = strText;
...
T_TD_K CRptTB_PSC_10002_3_05_CH::AddTDwithUnit(CArray<T_CHAR_K, T_CHAR_K>& arCharK, CString strUnit, int iTDType/*0*/, int iMergeCols/*1*/, int iMergeRows/*1*/, T_CSS_K CssK/*0*/)
{
...
T_TD_K CRptTB_PSC_10002_3_05_CH::AddTDwithUnit(CArray<T_CHAR_K, T_CHAR_K>& arCharK, CArray<T_CHAR_K, T_CHAR_K>& arCharUnitK, int iTDType/*0*/, int iMergeCols/*1*/, int iMergeRows/*1*/, T_CSS_K CssK/*0*/)
{
    CArray<T_TEXT_K, T_TEXT_K> arTextK; arTextK.RemoveAll();
...
T_TD_K CRptTB_PSC_10002_3_05_CH::AddTDwithUnit(LPCTSTR strText, CString strUnit, int iTDType/*0*/, int iMergeCols/*1*/, int iMergeRows/*1*/, T_CSS_K CssK/*0*/)
{
    CArray<T_TEXT_K, T_TEXT_K> arTextK; arTextK.RemoveAll();
...
T_TD_K CRptTB_PSC_10002_3_05_CH::AddTDwithUnit(LPCTSTR strText, CArray<T_CHAR_K, T_CHAR_K>& arCharUnitK, int iTDType/*0*/, int iMergeCols/*1*/, int iMergeRows/*1*/, T_CSS_K CssK/*0*/)
{
    CArray<T_TEXT_K, T_TEXT_K> arTextK; arTextK.RemoveAll();
...
void CRptTB_PSC_10002_3_05_CH::InitialarCharK()
{
    CString strText;
...
// 7.ÁºµÄÏêÏ¸¼ÆËã¹ý³Ì.
BOOL CRptTB_PSC_10002_3_05_CH::MakeCheckBeamResultData()
{
    CString strPathName=m_pDoc->GetPathName();
    CFileCtrl FileCtrl(strPathName);
...
// 8. ÖùµÄÏêÏ¸¼ÆËã¹ý³Ì
BOOL CRptTB_PSC_10002_3_05_CH::MakeCheckColumnResultData()
{
    CString strPathName=m_pDoc->GetPathName();
    CFileCtrl FileCtrl(strPathName);
    CString strInputFilePathName = FileCtrl.GetFilePathAndNameWithoutExtension()+_T("Column.mrpt");
