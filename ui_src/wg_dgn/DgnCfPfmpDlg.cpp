...
/////////////////////////////////////////////////////////////////////////////
// CDgnCfPfmpDlg dialog


CDgnCfPfmpDlg::CDgnCfPfmpDlg(CWnd* pParent /*=NULL*/)
	: CMenuBarChildDlg(CDgnCfPfmpDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnCfPfmpDlg)
	m_nOption = 0;
	//}}AFX_DATA_INIT
...
void CDgnCfPfmpDlg::DoDataExchange(CDataExchange* pDX)
{
	CMenuBarChildDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnCfPfmpDlg)
	DDX_Radio(pDX, IDC_DGN_PFMP_PL, m_nOption);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDgnCfPfmpDlg, CMenuBarChildDlg)
	//{{AFX_MSG_MAP(CDgnCfPfmpDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnCfPfmpDlg message handlers

BOOL CDgnCfPfmpDlg::OnInitDialog() 
{
...
void CDgnCfPfmpDlg::OnDgnClose() 
{
	// TODO: Add your control notification handler code here
	CTreeMenuBarBase::SetModeST(__TMMODE_TREEMENU__);
}

void CDgnCfPfmpDlg::OnDgnExecute() 
{
...
void CDgnCfPfmpDlg::Initial_SelectItem() 
{
	// Unselected All.
...
void CDgnCfPfmpDlg::Initial_Data()
{
...
void CDgnCfPfmpDlg::OnDgnPfmpPl() 
{
	m_nOption  = 0;			//	add/replace
	UpdateData(FALSE);
}

void CDgnCfPfmpDlg::OnDgnPfmpNp() 
{
	m_nOption  = 1;			//	Delete
	UpdateData(FALSE);
}
...
// Add by ZINU.('02.3.21).
void CDgnCfPfmpDlg::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
...
// Add by ZINU.('02.3.21).
void CDgnCfPfmpDlg::Update_InitDataByCode()
{
	...
	CString strTitle = _T("");
	BOOL bShow = FALSE;
	m_pDoc->GetDesignTitleCfs(ID_DGN_PERFOR_MEMBER_COEFFICIENT_CFS, strTitle, bShow);

	EnableItems(bShow);
}

void CDgnCfPfmpDlg::EnableItems(BOOL bEnable)
{
