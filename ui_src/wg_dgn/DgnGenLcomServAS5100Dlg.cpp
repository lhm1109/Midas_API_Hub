...
#include "DgnGenLcomServAS5100Dlg.h"
...
CDgnGenLcomServAS5100Dlg::CDgnGenLcomServAS5100Dlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CDgnGenLcomServAS5100Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnGenLcomServAS5100Dlg)
...
void CDgnGenLcomServAS5100Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnGenLcomServAS5100Dlg)
...
BEGIN_MESSAGE_MAP(CDgnGenLcomServAS5100Dlg, CInternationalDlg)
#undef CDialog
	//{{AFX_MSG_MAP(CDgnGenLcomServAS5100Dlg)
	ON_BN_CLICKED(IDC_DGN_GEN_SERV_SELECT,   OnDgnAddSelectBtn )
	ON_BN_CLICKED(IDC_DGN_GEN_SERV_UNSELECT, OnDgnDelSelectBtn )
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDgnGenLcomServAS5100Dlg::InitCtrl()
{
...
void CDgnGenLcomServAS5100Dlg::InitLcomData()
{
	m_arServLcomMAP.RemoveAll();
	m_arServLcomSelectMAP.RemoveAll();
...
void CDgnGenLcomServAS5100Dlg::Write_ListCtrl(CListCtrl& LoadList, CMap<int, int, _DGN_LCOM_D, _DGN_LCOM_D&>& LoadMap)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDgnGenLcomServAS5100Dlg message handlers

BOOL CDgnGenLcomServAS5100Dlg::OnInitDialog() 
{
...
void CDgnGenLcomServAS5100Dlg::OnDgnAddSelectBtn() 
{
...
void CDgnGenLcomServAS5100Dlg::OnDgnDelSelectBtn() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDgnGenLcomServAS5100Dlg::OnOK() 
{
...
void CDgnGenLcomServAS5100Dlg::OnCancel() 
{
