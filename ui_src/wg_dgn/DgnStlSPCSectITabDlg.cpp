// DgnStlSPCSectITabDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnStlSPCSectITabDlg dialog


CDgnStlSPCSectITabDlg::CDgnStlSPCSectITabDlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CDgnStlSPCSectITabDlg::IDD, pParent)
{
	...
	m_Grid = NULL;
	//{{AFX_DATA_INIT(CDgnStlSPCSectITabDlg)	
	//}}AFX_DATA_INIT
}


void CDgnStlSPCSectITabDlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnStlSPCSectITabDlg)  
...
BEGIN_MESSAGE_MAP(CDgnStlSPCSectITabDlg, CChildDialog)
	//{{AFX_MSG_MAP(CDgnStlSPCSectITabDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnStlSPCSectITabDlg message handlers

void CDgnStlSPCSectITabDlg::PostNcDestroy() 
{
...
BOOL CDgnStlSPCSectITabDlg::OnInitDialog() 
{
	InitLineData();
	if (m_Grid == nullptr)
		m_Grid = new CDgnSteelSPCSectGrid(m_nRowCount);
...
void CDgnStlSPCSectITabDlg::SetInitUnit()
{
...
void CDgnStlSPCSectITabDlg::InitLineData()
{
	m_nRowCount = 0;
...
void CDgnStlSPCSectITabDlg::SelectLineRedraw(ROWCOL nRow)
{ 
	m_pParent->SelectLineRedraw(nRow); 
}

void CDgnStlSPCSectITabDlg::DataToDlg()
{
...
BOOL CDgnStlSPCSectITabDlg::DlgToData()
{
...
void CDgnStlSPCSectITabDlg::DataToGrid()
{	
...
void CDgnStlSPCSectITabDlg::GridToData()
{
	double dLength = 0.;
	double dThickness = 0.;
	int nPanel = 0;
...
void CDgnStlSPCSectITabDlg::OnClickRedrawBtn() 
{
	if(!DlgToData()) return;
	GridToData();	
...
void CDgnStlSPCSectITabDlg::PointRedraw() 
{
	if(!DlgToData()) return;
	GridToData();	
...
void CDgnStlSPCSectITabDlg::InitPoint1Combo()
{
	double dY, dZ = 0.0;
...
void CDgnStlSPCSectITabDlg::InitPoint2Combo()
{
	double dY, dZ = 0.0;
...
void CDgnStlSPCSectITabDlg::InitPoint3Combo()
{
	double dY, dZ = 0.0;
...
void CDgnStlSPCSectITabDlg::InitPoint4Combo()
{
	double dY, dZ = 0.0;
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint1YEdit() 
{	
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint2YEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint3YEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint4YEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint1ZEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
	dX = m_edit1_Y.GetEditValue();
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint2ZEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
	dX = m_edit2_Y.GetEditValue();
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint3ZEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
	dX = m_edit3_Y.GetEditValue();
...
void CDgnStlSPCSectITabDlg::OnKillfocusPoint4ZEdit() 
{	
	//(2009.01.05) Add by Unsang :: MinLength와 비교 후 만족하지 않을 경우 Message생성!!
	double dX, dY;
	dX = m_edit4_Y.GetEditValue();
...
void CDgnStlSPCSectITabDlg::SetPointComboItem()
{
	InitPoint1Combo();
	InitPoint2Combo();
	InitPoint3Combo();
...
void CDgnStlSPCSectITabDlg::SetPointEdit(int nPointMode, double dPositionX, double dPositionY)
{
