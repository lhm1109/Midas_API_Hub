...
class CDgnRCPlateColRebarSBarDlg : public CChildDialog
{
public:
	CDgnRCPlateColRebarSBarDlg(T_RPCS_D* pData, CWnd* pParent = NULL);
	~CDgnRCPlateColRebarSBarDlg();
...
protected:
	...
	void CalcAs(T_RPCS_D& RchkD, double& dAsTop, double& dAsBot);
...
private:
	CDBDoc* m_pDoc;
	T_RPCS_D* m_pData; // I만 사용, Layer 최대갯수 3개
	int m_iThik;
};
