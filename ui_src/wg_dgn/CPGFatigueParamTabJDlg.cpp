// CPGFatigueParamTabJDlg.cpp : implementation file
//
...
CCPGFatigueParamTabJDlg::CCPGFatigueParamTabJDlg(CWnd* pParent /*=NULL*/, int* pElemType/*=NULL*/)
	: CChildDialog(CCPGFatigueParamTabJDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCPGFatigueParamTabJDlg)
...
void CCPGFatigueParamTabJDlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCPGFatigueParamTabJDlg)
...
BEGIN_MESSAGE_MAP(CCPGFatigueParamTabJDlg, CChildDialog)
	//{{AFX_MSG_MAP(CCPGFatigueParamTabJDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCPGFatigueParamTabJDlg message handlers

BOOL CCPGFatigueParamTabJDlg::OnInitDialog() 
{
	...
	m_chkGroup.InitControl(this, CCPGFatigueParamTabJDlg::IDD, IDC_CPFP_FOLDE_GROUP_BOX,TRUE,TRUE);
	ResizeWindow();
...
BOOL CCPGFatigueParamTabJDlg::DestroyWindow() 
{
	Dlg2Data();
...
void CCPGFatigueParamTabJDlg::InitCombo()
{
...
void CCPGFatigueParamTabJDlg::InitUnit()
{
...
void CCPGFatigueParamTabJDlg::OnWarpingStressTypeRdo() 
{
	ControlsEnableDisable();
}

void CCPGFatigueParamTabJDlg::Data2Dlg()
{
...
BOOL CCPGFatigueParamTabJDlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CCPGFatigueParamTabJDlg::GetCpfpData()
{
	Dlg2Data();
...
void CCPGFatigueParamTabJDlg::SetCpfpData()
{
	Data2Dlg();
}

void CCPGFatigueParamTabJDlg::ControlsEnableDisable()
{
	if (m_pElemType)
	{
...
CRect CCPGFatigueParamTabJDlg::GetResizeHeight()
{	
	CRect r;
...
void CCPGFatigueParamTabJDlg::ResizeWindow()
{
...
LRESULT CCPGFatigueParamTabJDlg::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	m_pParent->ResizeWindow();
	return 0L;
}