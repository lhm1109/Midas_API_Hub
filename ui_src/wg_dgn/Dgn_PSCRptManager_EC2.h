// Dgn_PSCRptManager_EC2.h: interface for the CDgn_PSCRptManager_EC2 class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_Dgn_PSCRptManager_EC2_H__320D0EDD_A144_432B_A6E6_1B91E6B8F83C__INCLUDED_)
#define AFX_Dgn_PSCRptManager_EC2_H__320D0EDD_A144_432B_A6E6_1B91E6B8F83C__INCLUDED_
...
class CDgn_PSCRptManager_EC2 : public CDgn_DllManager_Base       
{
public:
	CDgn_PSCRptManager_EC2();
	virtual ~CDgn_PSCRptManager_EC2();
...
protected:
	...
	PSC_Print_Detail_Design_EC*     m_pAsminDetail;
    ...
    //
    PDGNENGINE_RPT_PROG*                 m_pBSDetail;
...
public:
	...
	BOOL Print_DetailReport_AsminCHKDesign(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_BDCW_BASE& BdcwBase);
    ...
    // BS5400:4, BD44/15
    BOOL Print_DetailReport_BS(dgn::lib::IExcel* pExcel, D_XL_PROGRESS_INTERFACE* pProgDlg, int iDgnCode, LPCTSTR szProgramDir, LPCTSTR szProjectFileDir, LPCTSTR szSaveFileName, PSC_RPT_BS_D &rData);
