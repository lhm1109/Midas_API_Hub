// DgnClassIREDAPI.cpp : implementation file
// IDEA RS EXPORT : Write Class

#include "stdafx.h"
#include "DgnClassIREW_API.h"
...
CDgnIDEAArchiveAPI::CDgnIDEAArchiveAPI(LPCTSTR lpszTxtFile, CFile* pFile, UINT nMode, int nBufSize, void* lpBuf)
...
CDgnIDEAArchiveAPI::~CDgnIDEAArchiveAPI()
{
	if (m_pTextFile)
	{
		fclose(m_pTextFile);
...
CString CDgnIDEAArchiveAPI::GetDoubleStr(double dVal)
{
	CString csVal;
...
void CDgnIDEAArchiveAPI::WriteText(LPCTSTR lpszFmt, ...)
{
...
void CDgnIDEAArchiveAPI::Write(const void* pData, UINT nSize, vtype type)
{
	int nCount;
	switch(type)
	{
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(BYTE by)
{
	WriteText(_T(" %u"), by);
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(WORD w)
{
	WriteText(_T(" %u"), w);
	CArchive::operator<<(w);
	return *this;
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(LONG l)
{
	WriteText(_T(" %ld"), l);
	CArchive::operator<<(l);
	return *this;
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(DWORD dw)
{
	WriteText(_T(" %ld"), dw);
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(float f)
{
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(double d)
{
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(int i)
{
	WriteText(_T(" %d"), i);
	CArchive::operator<<(i);
	return *this;
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(short w)
{
	WriteText(_T(" %d"), w);
	CArchive::operator<<(w);
	return *this;
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(TCHAR ch)
{
	WriteText(_T(" %c"), ch);
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(unsigned u)
{
	WriteText(_T(" %u"), u);
	CArchive::operator<<(u);
	return *this;
...
CDgnIDEAArchiveAPI& CDgnIDEAArchiveAPI::operator<<(const CString& string)  
{
...
CDgnClassIREWAPI::CDgnClassIREWAPI()
{
	Initialize(); 
}
...
void CDgnClassIREWAPI::Initialize()
{
	m_Data.Initialize();
...
BOOL CDgnClassIREWAPI::IsExistData(UINT nKey, KEYArray& ar)
{
...
void CDgnClassIREWAPI::AddData(UINT nKey, KEYArray& ar)
{
	if (IsExistData(nKey, ar) == TRUE) return;
	ar.Add(nKey);
}

BOOL CDgnClassIREWAPI::IsCompositeSection(int& nType, BOOL bGeneral)
{
...
BOOL CDgnClassIREWAPI::IsCompositeGeneralSection(int& nType)
{
	return (nType == D_SECT_TYPE_COMPO_G);
}


void CDgnClassIREWAPI::MakePSCOutLine(CDBDoc* pDoc, double SectionSize[D_SECT_SIZE_NUM_MAX], T_SECT_SECTION_D& CSectD, S_GSEC_POLYGON_LIST& aOuter, S_GSEC_POLYGON_LIST& aInner, BOOL bPosI)
{
...
void CDgnClassIREWAPI::MakePSCOutLineCSCS(CDBDoc* pDoc, double SectionSize[D_SECT_SIZE_NUM_MAX], T_SECT_D& CSectD, T_CSCS_D&  CCscsD, S_GSEC_POLYGON_LIST& aOuter, BOOL bIncludeJ)
{
	// 좌표를 생성할 조건을 판단한다.
...
void CDgnClassIREWAPI::MakeCOMPOutLine(CDBDoc* pDoc, T_SECT_D& CSectD, S_GSEC_POLYGON_LIST& aOuter, S_GSEC_POLYGON_LIST& aInner, BOOL bTap, BOOL bPosI)
{
	aOuter.RemoveAll();
	aInner.RemoveAll();
...
void CDgnClassIREWAPI::MakeCOMPOutLineCSCS(CDBDoc* pDoc, double SectionSize[D_SECT_SIZE_NUM_MAX], T_SECT_D& CSectD, T_CSCS_D&  CCscsD, S_GSEC_POLYGON_LIST& aOuter, S_GSEC_POLYGON_LIST& aInner, BOOL bTap, BOOL bIncludeJ)
{
...
void CDgnClassIREWAPI::MakeCOMPGeneralOutLineCSCS(T_SECT_D& CSectD, S_SECT_D& SSectD, T_CSCS_D&  CCscsD, BOOL bIncludeJ)
{
	if (CCscsD.nCompType != 2) return;
...
void CDgnClassIREWAPI::CopyCompGeneralOutLine(const S_SECT_D& SSectD, S_CSET_D& CsetD, int nCSetPart)
{
...
BOOL CDgnClassIREWAPI::ExportIDEAData(CDgnIDEAArchiveAPI& ar, KEYArray& aElement, CString& szMCTPath)
{
...
BOOL CDgnClassIREWAPI::GenerateData(KEYArray& aElement)
{
	Initialize();    
...
void CDgnClassIREWAPI::MakeArrayData(CDBDoc* pDoc, KEYArray& aElement)
{
...
void CDgnClassIREWAPI::CD2ID_NODE(T_NODE_D& cNode, S_NODE_D& iNode)
{
	iNode.Initialize();
...
void CDgnClassIREWAPI::CD2ID_ELEM(T_ELEM_D& cElem, S_ELEM_D& iElem)
{
	iElem.Initialize();
...
void CDgnClassIREWAPI::CD2ID_MEMB(T_MEMB_D& cMemb, S_MEMB_D& iMemb)
{
	iMemb.Initialize();
...
void CDgnClassIREWAPI::CD2ID_MTAN(T_MATL_ANALYSIS& cMatl, S_MATL_PROP& iMatl)
{  
...
void CDgnClassIREWAPI::CD2ID_MTSD(T_MATL_DESIGN& cMtst, S_MATL_STEEL_D& iMtst)
{ 
...
void CDgnClassIREWAPI::CD2ID_MTST(T_MATD_D& cMatd, S_MATL_STEEL_D& iMtst)
{
	iMtst.Initialize();
...
void CDgnClassIREWAPI::CD2ID_MTCC(T_MATD_D& cMtcc, S_MATL_CONCRETE_D& iMtcc)
{
	iMtcc.Initialize();
...
void CDgnClassIREWAPI::CD2ID_MTRB(T_MATL_REBAR& cMtrb, S_MATL_REBAR& iMtrb)
{
	iMtrb.Initialize();
...
void CDgnClassIREWAPI::CD2ID_MTRI(T_MATD_D& cMtri, S_MATL_REBAR_INFO& iMtri)
{
...
void CDgnClassIREWAPI::CD2ID_MTAD(T_MATL_D& cMtad, S_MATL_ADIF_D& iMtad)
{
	iMtad.Initialize();
...
void CDgnClassIREWAPI::CD2ID_SGVT(T_GSEC_VERTEX& cSgvt, S_GSEC_VERTEX& iSgvt)
{
	iSgvt.Initialize();
	iSgvt.dX = cSgvt.dX;
	iSgvt.dY = cSgvt.dY;
...
void CDgnClassIREWAPI::CD2ID_SGPG(T_GSEC_POLYGON& cSgpg, S_GSEC_POLYGON& iSgpg)
{
	iSgpg.Initialize();
...
void CDgnClassIREWAPI::CD2ID_SRSF(T_SECT_STIFFNESS& cStsf, S_SECT_STIFFNESS& iStsf)
{
	iStsf.Initialize();
...
void CDgnClassIREWAPI::CD2ID_SGPT(T_SECT_SECTBASE_D& cStbs, T_GSEC_PART& cPart, S_GSEC_PART& iSgpt)
{
	iSgpt.Initialize();
...
void CDgnClassIREWAPI::CD2ID_LINE(const T_SECT_SECTION_D& cStsn, S_SECT_D& iSect)
{
...
void CDgnClassIREWAPI::CD2ID_LNLP(const T_SECT_SECTION_D& cStsn, S_SECT_D& iSect)
{
	iSect.SectI.aLineLoop.Copy(cStsn.SectI.aLineLoop);
	iSect.SectJ.aLineLoop.Copy(cStsn.SectJ.aLineLoop);
}

void CDgnClassIREWAPI::CD2ID_STBS(int nType,  T_SECT_SECTBASE_D& cStbs, S_SECT_SECTBASE_D& iStbs)
{
	iStbs.Initialize();
	iStbs.nStype   = nType;
...
void CDgnClassIREWAPI::CD2ID_SECT(CDBDoc* pDoc, T_SECT_D& cSectD, S_SECT_D& iSectD)
{
	iSectD.Initialize();
	T_SECT_SECTION_D* pSection = NULL;
...
void CDgnClassIREWAPI::IDDATA_POLYGON(S_SECT_SECTBASE_D&  rSect, DGN_GSEC_POLYGON_LIST&  arOut1, DGN_GSEC_POLYGON_LIST& arOut2, DGN_GSEC_POLYGON_LIST& arIn1, DGN_GSEC_POLYGON_LIST& arIn2)
{
...
void CDgnClassIREWAPI::CD2ID_CONS(T_CONS_D& cCons, S_CONS_D& iCons)
{
	iCons.Initialize();  
	memcpy(iCons.sConstraint, cCons.Constraint, sizeof(iCons.sConstraint));
}

void CDgnClassIREWAPI::CD2ID_STLD(T_STLD_D& cStld, S_STLD_D& iStld)
{
	iStld.Initialize();
...
void CDgnClassIREWAPI::CD2ID_LCMB(CDBDoc* pDoc, T_LCOM_BASE& cLcmb, S_LCOM_BASE& iLcmb)
{
	iLcmb.Initialize();
...
void CDgnClassIREWAPI::CD2ID_LCOM(CDBDoc* pDoc, T_LCOM_D& cLcom, S_LCOM_D& iLcom)
{
	iLcom.Initialize();
...
void CDgnClassIREWAPI::CD2ID_LENG(T_LENG_D& cLeng, S_LENG_D& iLeng)
{
	iLeng.Initialize();
...
void CDgnClassIREWAPI::CD2ID_KFAC(T_KFAC_D& cKfac, S_KFAC_D& iKfac)
{
	iKfac.Initialize();
...
void CDgnClassIREWAPI::CD2ID_LTSR(T_LTSR_D& cLtsr, S_LTSR_D& iLtsr)
{
	iLtsr.Initialize();
...
void CDgnClassIREWAPI::CD2ID_CMFT(T_CMFT_D& cCmft, S_CMFT_D& iCmft)
{
	iCmft.Initialize();
...
void CDgnClassIREWAPI::CD2ID_FMAG(T_FMAG_D& cFmag, S_FMAG_D& iFmag)
{
	iFmag.Initialize();
...
void CDgnClassIREWAPI::CD2ID_DCON(T_DCON_D& cDcon, S_DCON_D& iDcon)
{
	iDcon.Initialize();
...
void CDgnClassIREWAPI::CD2ID_RDBM(T_RDGN_BEAM& cRdbm, S_RDGN_BEAM& iRdbm)
{
	// Before_Release_v825_Check - Rebar 구조체 변경되면서 수정되어야 하는 부분 
	// 일단 0 으로 고정해두었다~	
...
void CDgnClassIREWAPI::CD2ID_RDCN(T_RDGN_COLM& cRdcn, S_RDGN_COLM& iRdcn)
{
	// Before_Release_v825_Check - Rebar 구조체 변경되면서 수정되어야 하는 부분 
	// 일단 0 으로 고정해두었다~	
...
void CDgnClassIREWAPI::CD2ID_RCBM(T_RCHK_BEAM& cRcbm, S_RCHK_BEAM& iRcbm)
{
	iRcbm.Initialize();
	for (int i=0; i<3; i++)
	{
...
void CDgnClassIREWAPI::CD2ID_RCCN(T_RCHK_COLM& cRccn, S_RCHK_COLM& iRccn)
{
	// Before_Release_v825_Check - Rebar 구조체 변경되면서 수정되어야 하는 부분 
	// 일단 0 으로 고정해두었다~	
...
void CDgnClassIREWAPI::CD2ID_RBMB(T_REBT_MABR& cRbmb, S_REBT_MABR& iRbmb)
{
	iRbmb.Initialize();
...
void CDgnClassIREWAPI::CD2ID_RBSB(T_REBT_SHBR& cRbsb, S_REBT_SHBR& iRbsb)
{
	iRbsb.Initialize();
...
void CDgnClassIREWAPI::CD2ID_REBT(T_REBT_D& cRebt, S_REBT_D& iRebt)
{
	// Before_Release_v825_Check - Rebar 구조체 변경되면서 수정되어야 하는 부분 
	iRebt.Initialize();
...
void CDgnClassIREWAPI::CD2ID_PTSM(T_POINT_SSM& cPtsm, S_POINT_SSM& iPtsm)
{
	iPtsm.Initialize();
...
void CDgnClassIREWAPI::CD2ID_RPMS(T_RPSC_MBAR_SSM& cRpms, S_RPSC_MBAR_SSM& iRpms)
{
	iRpms.Initialize();
...
void CDgnClassIREWAPI::CD2ID_RPSS(T_RPSC_SBAR_SSM& cRpss, S_RPSC_SBAR_SSM& iRpss)
{
	iRpss.Initialize();
...
// [Check before Release...!!] cjjeong-20120405 : 
void CDgnClassIREWAPI::CD2ID_RPSD(T_RPSC_SSM_D& cRpsd, S_RPSC_SSM_D& iRpsd)
{
	iRpsd.Initialize();
...
void CDgnClassIREWAPI::CD2ID_TNDN(T_GSEC_TNDN& cTnsn, S_SECG_TNDN& iTnsn, CString& szTName, UINT nTendonKey)
{
	iTnsn.Initialize();
...
BOOL CDgnClassIREWAPI::MakeTdlsData(CDBDoc* pDoc, T_KEY& nTndnK, T_KEY& nStagK, T_KEY& nStepK, S_TDLS_D& TdlsD)
{
	int nStep;
...
void CDgnClassIREWAPI::CD2ID_THIK(T_THIK_D& cThik, S_THIK_D& iThik)
{
	iThik.Initialize();
...
void CDgnClassIREWAPI::CD2ID_STRP(T_STRP_DL& cStrp, S_STRP_DL& iStrp)
{
	iStrp.Initialize();
...
void CDgnClassIREWAPI::CD2ID_STPN(T_STPN_D& cStrp, S_STRP_DL& iStrp)  // Plane Strain
{
	iStrp.Initialize();
...
void CDgnClassIREWAPI::CD2ID_STRM(T_STRM_DL& cStrp, S_STRP_DL& iStrp)  // Plane Stress
{
	iStrp.Initialize();
...
// for construction Stage
void CDgnClassIREWAPI::CD2ID_CSLC(T_STLD_D& cStld, S_STLD_D& iCslc)
{
	iCslc.Initialize();
...
void CDgnClassIREWAPI::CD2ID_CLAT(T_STLD_D& cStld, S_STLD_D& iClat)
{
	CD2ID_CSLC(cStld, iClat);
}

void CDgnClassIREWAPI::CD2ID_STAG(T_STAG_D& cStag, S_STAG_D& iStag)
{
	iStag.Initialize();
...
void CDgnClassIREWAPI::CD2ID_CSCS(T_CSCS_D& cCscs, S_CSCS_D& iCscs)
{
	iCscs.Initialize();
...
void CDgnClassIREWAPI::CD2ID_GRUP(T_GRUP_D& cGrup, S_GRUP_D& iGrup)
{
	iGrup.Initialize();
...
void CDgnClassIREWAPI::CD2ID_BNGR(T_BNGR_D& cBngr, S_BNGR_D& iBngr)
{
	iBngr.Initialize();
...
void CDgnClassIREWAPI::CD2ID_LDGR(T_LDGR_D& cLdgr, S_LDGR_D& iLdgr)
{
	iLdgr.Initialize();
...
void CDgnClassIREWAPI::CD2ID_PREA(T_REAC_D& cReac, S_REAC_D& iReac)
{
	iReac.Initialize();
...
void CDgnClassIREWAPI::CD2ID_PDIS(T_DISP_D& cDisp, S_DISP_D& iDisp)
{
	iDisp.Initialize();
	// MNET:XXXX-CJJEONG-20130829 (2088) : 자유도 갯수 변경으로 인한 수정 -> 7자유도 반영해야 하나?
...
void CDgnClassIREWAPI::CD2ID_PTFO(T_STRT_D& cTfor, S_TFOR_D& iTfor)
{
	iTfor.Initialize();
	// MNET:XXXX-CJJEONG-20130829 (2088) : 자유도 갯수 변경으로 인한 수정 -> 7자유도 반영해야 하나?
...
void CDgnClassIREWAPI::CD2ID_PBFO(T_STRB_D& cPbfo, S_BFOR_D& iPbfo)
{
	iPbfo.Initialize();
	// MNET:XXXX-CJJEONG-20130829 (2088) : 자유도 갯수 변경으로 인한 수정 -> 7자유도 반영해야 하나?
	for (int i=0; i<4; ++i)
...
void CDgnClassIREWAPI::CD2ID_PREC(T_REAC_D& cRecx, T_REAC_D& cRecn, S_RECC_D& iReac)
{
	iReac.Initialize();
...
void CDgnClassIREWAPI::CD2ID_PDIC(T_DISP_D& cDspx, T_DISP_D& cDspn, S_DSPC_D& iDspc)
{
	iDspc.Initialize();
	// MNET:XXXX-CJJEONG-20130829 (2088) : 자유도 갯수 변경으로 인한 수정 -> 7자유도 반영해야 하나?
...
void CDgnClassIREWAPI::CD2ID_PBCF(T_SBCF_D& cPbcx, T_SBCF_D& cPbcfn, S_BCFO_B& iPbcf)
{
	iPbcf.Initialize();
	int i(0), j(0), k(0), l(0);
	for (i=0; i<4; i++)
...
void CDgnClassIREWAPI::CD2ID_CPUR(T_SECT_D& cSectD, S_SECT_D& iSectD)
{
...
BOOL CDgnClassIREWAPI::WriteBASC(CDgnIDEAArchiveAPI&  ar, CString& szMCTPath)
{
	// Version
	ar.endl();
...
BOOL CDgnClassIREWAPI::WriteUNIT(CDgnIDEAArchiveAPI&  ar, S_UNIT_D&  UnitD)
{
...
BOOL CDgnClassIREWAPI::WriteNODE(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_NODE_D& NodeD)
{
	ar << nKey;
	ar << NodeD.dx;
	ar << NodeD.dy;
...
BOOL CDgnClassIREWAPI::WriteELEM(CDgnIDEAArchiveAPI&ar, UINT nKey, S_ELEM_D& ElemD)
{
	ar << nKey;
	ar << ElemD.nEltype;
	ar << ElemD.MatlK;
...
BOOL CDgnClassIREWAPI::WriteMEMB(CDgnIDEAArchiveAPI&ar, UINT nKey, S_MEMB_D& MembD)
{
	ar << nKey;
	ar << MembD.nMbType;
...
BOOL CDgnClassIREWAPI::WriteMtPr(CDgnIDEAArchiveAPI&ar, S_MATL_PROP& MtPrD)
{
...
BOOL CDgnClassIREWAPI::WriteMTST(CDgnIDEAArchiveAPI& ar, UINT nKey, S_MATL_STEEL_D& MtstD)
{
	ar << nKey;
	ar << MtstD.szCode;
	ar << MtstD.szMatName;
...
BOOL CDgnClassIREWAPI::WriteMTCC(CDgnIDEAArchiveAPI& ar, UINT nKey, S_MATL_CONCRETE_D& MtccD)
{
	ar << nKey;
	ar << MtccD.szCode;
	ar << MtccD.szMatName;
...
BOOL CDgnClassIREWAPI::WriteMTRB(CDgnIDEAArchiveAPI& ar, UINT nKey, S_MATL_REBAR_INFO& MtrbD)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteMTAD(CDgnIDEAArchiveAPI& ar, UINT nKey, S_MATL_ADIF_D& MtadD)
{
	ar << nKey;
	ar << MtadD.szType;
	ar << MtadD.szName;
...
BOOL CDgnClassIREWAPI::WriteSTSF(CDgnIDEAArchiveAPI& ar, S_SECT_STIFFNESS& StsfD)
{
...
BOOL CDgnClassIREWAPI::WriteSTPG(CDgnIDEAArchiveAPI& ar, S_GSEC_POLYGON& StpgD)
{  
...
BOOL CDgnClassIREWAPI::WriteSECT(CDgnIDEAArchiveAPI& ar, UINT nKey, S_SECT_D& SectD)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteELST(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nSKey, S_ELST_D& ElstD)
{
	ar << nEKey;
	ar << nSKey;
...
BOOL CDgnClassIREWAPI::WriteCSET(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nSKey, UINT nPKey, S_CSET_D& CsetD)
{
	ar << nEKey;
	ar << nSKey;
	ar << nPKey;
...
BOOL CDgnClassIREWAPI::WriteSTCS(CDgnIDEAArchiveAPI& ar, UINT nKey, S_PROP_D& StcsD)
{
...
BOOL CDgnClassIREWAPI::WriteGSPO(CDgnIDEAArchiveAPI& ar, S_GSPO_D& GspoD)
{
...
BOOL CDgnClassIREWAPI::WriteGSPI(CDgnIDEAArchiveAPI& ar, S_GSPI_D& GspiD)
{  
...
BOOL CDgnClassIREWAPI::WriteCSPT(CDgnIDEAArchiveAPI&  ar, UINT nSkey, UINT nPkey, UINT nIJ, S_GSEC_PART& CsptD, BOOL bPrintKey)
{
	ar.endl();
...
BOOL CDgnClassIREWAPI::WriteLINE(CDgnIDEAArchiveAPI& ar, const CArray<S_GSEC_LINE, S_GSEC_LINE&>& aLine)
{
...
BOOL CDgnClassIREWAPI::WriteLNLP(CDgnIDEAArchiveAPI& ar, const CArray<int, int>& aLineLoop)
{  
...
BOOL CDgnClassIREWAPI::WriteCONS(CDgnIDEAArchiveAPI& ar, UINT nKey, S_CONS_D& ConsD)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteSTLD(CDgnIDEAArchiveAPI& ar, UINT nKey, S_STLD_D& StldD)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteLCBS(CDgnIDEAArchiveAPI& ar, S_LCOM_BASE& LcbsD)
{  
...
BOOL CDgnClassIREWAPI::WriteLCOM(CDgnIDEAArchiveAPI& ar, UINT nType, UINT nKey, S_LCOM_D& LcomD)
{
	ar << nType;
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteLENG(CDgnIDEAArchiveAPI& ar, UINT nKey, S_LENG_D& LengD)
{
	ar << nKey;
	ar << LengD.dBLy;
	ar << LengD.dBLz;
...
BOOL CDgnClassIREWAPI::WriteKFAC(CDgnIDEAArchiveAPI& ar, UINT nKey, S_KFAC_D& KfacD)
{
	ar << nKey;
	ar << KfacD.dBKy;
	ar << KfacD.dBKz;
...
BOOL CDgnClassIREWAPI::WriteLTSR(CDgnIDEAArchiveAPI& ar, UINT nKey, S_LTSR_D& LtsrD)
{
	ar << nKey;
	ar << LtsrD.bNotCheck;
	ar << LtsrD.dCLMT;
...
BOOL CDgnClassIREWAPI::WriteCMFT(CDgnIDEAArchiveAPI& ar, UINT nKey, S_CMFT_D& CmftD)
{
	ar << nKey;
	ar << CmftD.bAuto;
	ar << CmftD.dCmy;
...
BOOL CDgnClassIREWAPI::WriteFMAG(CDgnIDEAArchiveAPI& ar, UINT nKey, S_FMAG_D& FmagD)
{
	ar << nKey;
	ar << FmagD.dB1y;
	ar << FmagD.dB1z;
...
BOOL CDgnClassIREWAPI::WriteDCON(CDgnIDEAArchiveAPI& ar, S_DCON_D& DConD)
{
...
BOOL CDgnClassIREWAPI::WriteRDBM(CDgnIDEAArchiveAPI& ar, UINT nKey, S_RDGN_BEAM& RdbmD)
{
	ar << nKey;
	ar << RdbmD.dDt;
	ar << RdbmD.dDb;
...
BOOL CDgnClassIREWAPI::WriteRDCN(CDgnIDEAArchiveAPI& ar, UINT nKey, S_RDGN_COLM& RbcnD)
{
	ar << nKey;
	ar << RbcnD.dDc;
	ar << RbcnD.dSubBarNum;
...
BOOL CDgnClassIREWAPI::WriteRCBM(CDgnIDEAArchiveAPI& ar, UINT nKey, S_RCHK_BEAM& RcbmD)
{
	ar << nKey;
	int i(0), j(0);
	for (i=0; i<3; i++)
...
BOOL CDgnClassIREWAPI::WriteRCCN(CDgnIDEAArchiveAPI& ar, UINT nKey, S_RCHK_COLM& RccnD)
{
	ar << nKey;
	int i(0), j(0);
...
BOOL CDgnClassIREWAPI::WriteREBT(CDgnIDEAArchiveAPI& ar, UINT nKey, S_REBT_D& RebtD)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteRPMS(CDgnIDEAArchiveAPI& ar, S_RPSC_MBAR_SSM& RpmsD)
{  
	ar.WriteText(_T("%s \n"), _LSX(** PSC Main Rebar **));
	ar << RpmsD.nType;
	ar << RpmsD.nRefY;
...
BOOL CDgnClassIREWAPI::WriteRPSS(CDgnIDEAArchiveAPI& ar, S_RPSC_SBAR_SSM& RpssD)
{
	ar.WriteText(_T("%s \n"), _LSX(** PSC Sub Rebar **));
	ar << RpssD.bDiagonal;
...
BOOL CDgnClassIREWAPI::WriteRPSC(CDgnIDEAArchiveAPI& ar, UINT nKey, S_RPSC_SSM_D& RpscD)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteTDIF(CDgnIDEAArchiveAPI& ar, UINT nKey, UINT nIJ, S_TDIF_D& TdifD)
{
	ar << nKey;
	ar << nIJ;
...
BOOL CDgnClassIREWAPI::WriteTDLS(CDgnIDEAArchiveAPI&  ar, UINT nKey, UINT nStag, UINT nStep, S_TDLS_D& TdlsD)
{
	ar << nKey;
	ar << nStag;
	ar << nStep;
...
BOOL CDgnClassIREWAPI::WriteTHIK(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_THIK_D& iThik)
{
...
BOOL CDgnClassIREWAPI::WriteSTRP(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_STRP_DL& iStrp)
{
	ar.WriteText(_T("%s \n"), _LSX(** Plate Result **));
	ar << nEKey;
	ar << nLKey;
...
BOOL CDgnClassIREWAPI::WriteSTRPCS(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_STRP_CSDL& iStrp)
{
	ar.WriteText(_T("%s \n"), _LSX(** Plate Result **));
	ar << nEKey;
	ar << nLKey;
...
// for construction Stage
BOOL CDgnClassIREWAPI::WriteCSLC(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_STLD_D& iCslc)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteCLAT(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_STLD_D& iClat)
{
	return WriteCSLC(ar, nKey, iClat);
}

BOOL CDgnClassIREWAPI::WriteSTAG(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_STAG_D& iStag)
{
	int i(0), nSize(0);
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteCSCS(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_CSCS_D& iCscs)
{
	int i(0), nSize(0);
	ar << nKey;
	ar << iCscs.nSectKey;
...
BOOL CDgnClassIREWAPI::WriteGRUP(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_GRUP_D& iGrup)
{
	int i(0), nSize(0);
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteBNGR(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_BNGR_D& iBngr)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteLDGR(CDgnIDEAArchiveAPI&  ar, UINT nKey, S_LDGR_D& iLdgr)
{
	ar << nKey;
...
BOOL CDgnClassIREWAPI::WriteREAC(CDgnIDEAArchiveAPI& ar, UINT nEKey, UINT nLKey, UINT nType, S_REAC_D& ReacD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteDISP(CDgnIDEAArchiveAPI& ar, UINT nEKey, UINT nLKey, UINT nType, S_DISP_D& DispD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteDISPCS(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_DISP_CSD& DispD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteTFOR(CDgnIDEAArchiveAPI& ar, UINT nEKey, UINT nLKey, UINT nType, S_TFOR_D& TforD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteTFORCS(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_TFOR_CSD& TforD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteBFOR(CDgnIDEAArchiveAPI& ar, UINT nEKey, UINT nLKey, UINT nType, S_BFOR_D& BforD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteBFORCS(CDgnIDEAArchiveAPI& ar, UINT nEKey, UINT nLKey, UINT nType, S_BFOR_CSD& BforD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteBFORPT(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_BFOR_PT& BforDPT)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteBFORPTCC(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_BFOR_PTCC& BforDPTCC)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;  
...
BOOL CDgnClassIREWAPI::WriteBFORPTCS(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_BFOR_PTCS& BforDPTCS)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteRECC(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_RECC_D& ReccD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteDSPC(CDgnIDEAArchiveAPI&  ar, UINT nEKey, UINT nLKey, UINT nType, S_DSPC_D& DspcD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;
...
BOOL CDgnClassIREWAPI::WriteBCFO(CDgnIDEAArchiveAPI& ar, UINT nEKey, UINT nLKey, UINT nType, S_BCFO_B& BcfoD)
{
	ar << nEKey;
	ar << nLKey;
	ar << nType;  
...
BOOL CDgnClassIREWAPI::ExportIDEADataTest(CDgnIDEAArchiveAPI& ar, CString& szMCTPath, CDgnClassIRED& rData)
{
	TRY
	{
		int i(0), nSize(0);
