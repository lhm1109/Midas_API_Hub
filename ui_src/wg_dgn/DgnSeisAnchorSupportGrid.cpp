// DgnSeisAnchorSupportGrid.cpp : implementation file
...
CDgnSeisAnchorSupportGrid::CDgnSeisAnchorSupportGrid(CWnd* pParent/* = NULL*/)
{

	m_pParent = (CDgnSeisAnchorEvalItemNewSubSupportDlg*)pParent;

}

CDgnSeisAnchorSupportGrid::~CDgnSeisAnchorSupportGrid()
{
}

/////////////////////////////////////////////////////////////////////////////
// User Defined Finction
void CDgnSeisAnchorSupportGrid::SetData2Grid(T_ANEV_REG_SUPP_TYPE_D& Data)
{
	...
	if(nRow > 0) 
	{
		nCol = Data.aLayer[0].aBrevType.GetSize();
	}
...
BOOL CDgnSeisAnchorSupportGrid::GetGrid2Data(T_ANEV_REG_SUPP_TYPE_D& Data)
{
...
void CDgnSeisAnchorSupportGrid::SetDataToRow(ROWCOL nRow, CStringArray& raValue)
{
...
BOOL CDgnSeisAnchorSupportGrid::GetRowToData(ROWCOL nRow, CStringArray& raValue)
{
	int nColCount = GetColCount();
	ASSERT(nColCount == raValue.GetSize());
...
CString CDgnSeisAnchorSupportGrid::GetEditingValue(ROWCOL nRow, ROWCOL nCol)
{
	CString strNum(_T(""));
	BOOL bGet = FALSE;
	ROWCOL ncRow, ncCol;
...
BEGIN_MESSAGE_MAP(CDgnSeisAnchorSupportGrid, CWnd)
#undef CWnd
	//{{AFX_MSG_MAP(CDgnSeisAnchorSupportGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

///////////////////////////////////////////////////////////////////////////
// CDgnSeisAnchorSupportGrid message handlers

// 그리드 초기화 
void CDgnSeisAnchorSupportGrid::Initialize()
{
...
BOOL CDgnSeisAnchorSupportGrid::GetStyleRowCol(ROWCOL nRow, ROWCOL nCol, CGXStyle& style, GXModifyType mt, int nType)
{
	BOOL bCurrentRow;
	BOOL bCurrentCell;
	BOOL bEnabled;
...
void CDgnSeisAnchorSupportGrid::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CDgnSeisAnchorSupportGrid::OnPasteFromClipboard(const CGXRange &range)
{
	CGXGridWnd x;
	CGXRange r;
	CGXRange toRange;
...
BOOL CDgnSeisAnchorSupportGrid::VerifyPasteRange(CGXRange& from, CGXRange& to)
{
...
int CDgnSeisAnchorSupportGrid::GetSelectedRowsCount(int top, int bottom)
{
	int toRows;
	toRows = bottom - top + 1;
	return toRows;
...
int CDgnSeisAnchorSupportGrid::GetSelectedColsCount(int left, int right)
{
	int toCols;
	toCols = right - left + 1;
	return toCols;
...
void CDgnSeisAnchorSupportGrid::ShowData()
{
	ROWCOL nRow, nCol;
...
void CDgnSeisAnchorSupportGrid::SetViewData()
{
	m_pParent->SetViewData();
}

BOOL CDgnSeisAnchorSupportGrid::ProcessKeys(CWnd *pSender, UINT nMessage, UINT nChar, UINT nRepCnt, UINT flags)
{
	CRowColArray awRows;
...
BOOL CDgnSeisAnchorSupportGrid::SetRightValidCell(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CDgnSeisAnchorSupportGrid::SetLeftValidCell(ROWCOL nRow, ROWCOL nCol)
{
