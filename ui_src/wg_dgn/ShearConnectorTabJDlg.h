#if !defined(AFX_SHEARCONNECTORTABJDLG_H__)
#define AFX_SHEARCONNECTORTABJDLG_H__
...
class __MY_EXT_CLASS__ CShearConnectorTabJDlg : public CChildDialog
{
	// Construction
public:
	CShearConnectorTabJDlg(CWnd* pParent = NULL);   // standard constructor
	
	// Dialog Data
	//{{AFX_DATA(CShearConnectorTabJDlg)
	...
	// Overrides
	//{{AFX_VIRTUAL(CShearConnectorTabJDlg)
protected:
...
public:
	...
	//{{AFX_MSG(CShearConnectorTabJDlg)
