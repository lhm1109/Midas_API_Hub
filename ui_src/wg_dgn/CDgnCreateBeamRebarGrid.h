// DgnCreateBeamRebarGrid.h: interface for the CDgnCreateBeamRebarGrid class.
//////////////////////////////////////////////////////////////////////

#if !defined(__DGNCREATEBEAMREBARGRID_H__)
#define __DGNCREATEBEAMREBARGRID_H__
...
/////////////////////////////////////////////////////////////////////////////
// CDgnCreateBeamRebarGrid window
class CDgnCreateBeamRebarGrid : public CTBCommon
{
// Construction
public:
...
// Operations
public:
	void Initialize(CArray<T_RBGC_MABR, T_RBGC_MABR&>* pData, CConcSectionCreateBeamRebar* pParent);

	BOOL DeleteRecordByKey(REBAR_KEY &key, T_RBGC_MABR &data);
	BOOL InsertRecordByKey(REBAR_KEY &key, T_RBGC_MABR &data);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDgnCreateBeamRebarGrid)
	//}}AFX_VIRTUAL
public:
	virtual int  GetKeyColID() { return 0; }
	virtual void OnChangedSelectionPublic(long *keys, int nSize);

	virtual BOOL ValidateAndMakeRecord(CStringArray &value, CRowColArray &aCols, REBAR_KEY &key, T_RBGC_MABR &data);
	...
	BOOL SetCurrentMaRb(REBAR_KEY key, T_RBGC_MABR& data);
...
protected:
	...
	CArray<T_RBGC_MABR, T_RBGC_MABR&>* m_pData;

// Implementation
public:
	virtual ~CDgnCreateBeamRebarGrid();
	BOOL GetValue(ROWCOL nRow, REBAR_KEY &key, T_RBGC_MABR &data);
	BOOL SetValue(ROWCOL nRow, REBAR_KEY key, T_RBGC_MABR &data);
	BOOL SetValue(CGXData* pData, ROWCOL nRow, REBAR_KEY key, T_RBGC_MABR &data, CRowColArray &awCols);
	void ConvStrToData(int i, CString& value, T_RBGC_MABR& data);
	void ConvDataToStr(int i, REBAR_KEY key, T_RBGC_MABR& data, CString& value);

	void GetAllSelectedKey(CArray<REBAR_KEY, REBAR_KEY>& aSelKey);
	void MakeSearchKey(REBAR_KEY &key, T_RBGC_MABR &data, CStringArray &aKey);
...
protected:
	//{{AFX_MSG(CDgnCreateBeamRebarGrid)
...
private:
	...
	CConcSectionCreateBeamRebar* m_pParent;
...
#endif // !defined(__DGNCREATEBEAMREBARGRID_H__)
