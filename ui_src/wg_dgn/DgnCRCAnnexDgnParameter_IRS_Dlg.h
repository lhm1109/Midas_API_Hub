#if !defined(__DgnCRCAnnexDgnParameter_IRS_Dlg_H__)
#define __DgnCRCAnnexDgnParameter_IRS_Dlg_H__
...
class __MY_EXT_CLASS__ CDgnCRCAnnexDgnParameter_IRS_Dlg : public CDialogMove
{
// Construction
public:
	CDgnCRCAnnexDgnParameter_IRS_Dlg(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDgnConMatDlg)
	enum { IDD = IDD_DGN_CRC_DESIGN_PARAMETER_IRS_ANNEX1 };
