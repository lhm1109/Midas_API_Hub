#if !defined(AFX_AssessmentLoadCombMainGrid_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_AssessmentLoadCombMainGrid_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// AssessmentLoadCombMainGrid.h : header file
//
...
class CAssessmentLoadCombPSCDlg;
/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombMainGrid window

// 메모 : DB에 값을 넣는 것은 Child에 있음

class CAssessmentLoadCombMainGrid : public CTBCommon
{
// Construction
public:
	CAssessmentLoadCombMainGrid(CAssessmentLoadCombPSCDlg* pParent);

// Attributes
public:
	CString m_aCurDefVal[50];
	CAssessmentLoadCombSubGrid* m_pSubGrid;
...
public:
	...
	//{{AFX_VIRTUAL(CAssessmentLoadCombMainGrid)
	//}}AFX_VIRTUAL
...
// Implementation
public:
	virtual ~CAssessmentLoadCombMainGrid();
...
protected:
	...
	//{{AFX_MSG(CAssessmentLoadCombMainGrid)
	...
	CAssessmentLoadCombPSCDlg* m_pParent;
};
...
#endif // !defined(AFX_AssessmentLoadCombMainGrid_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
