// DgnRebarPscShear_I.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnRebarPscShear_I dialog


CDgnRebarPscShear_I::CDgnRebarPscShear_I(CWnd* pParent /*=NULL*/)
	: CChildDialog(CDgnRebarPscShear_I::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnRebarPscShear_I)
	//}}AFX_DATA_INIT
	...
	m_bShowStirrup = (PscdD.iDgnCode == JTG_D62_04 || PscdD.iDgnCode == CJJ_11_2011 ||PscdD.iDgnCode == TB_10002_3_05);   // JTG D62-04.

	m_aCtrlStirrup.Add(IDC_DGN_STRR_CHECK);
	m_aCtrlStirrup.Add(IDC_DGN_STRR_PCH_TEXT);
	m_aCtrlStirrup.Add(IDC_DGN_STRR_PCH_EDIT);
	m_aCtrlStirrup.Add(IDC_DGN_STRR_PCH_UNIT);
	m_aCtrlStirrup.Add(IDC_DGN_STRR_AW_TEXT);
	m_aCtrlStirrup.Add(IDC_DGN_STRR_AW_EDIT);
	m_aCtrlStirrup.Add(IDC_DGN_STRR_AW_UNIT);

	m_Data.Initialize();
}

void CDgnRebarPscShear_I::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnRebarPscShear_I)
	DDX_Control(pDX, IDC_DGN_TENS_RF_EDIT, m_editTensRf);
	DDX_Control(pDX, IDC_DGN_STRR_AW_UNIT, m_unitStrrAw);
	DDX_Control(pDX, IDC_DGN_STRR_AW_EDIT, m_editStrrAw);
	DDX_Control(pDX, IDC_DGN_STRR_PCH_UNIT, m_unitStrrPch);
	DDX_Control(pDX, IDC_DGN_STRR_PCH_EDIT, m_editStrrPch);
	DDX_Control(pDX, IDC_DGN_STRR_CHECK, m_chkStirrup);
	DDX_Control(pDX, IDC_DGN_LBAR_ALT_EDIT, m_editLbarAlt);
	DDX_Control(pDX, IDC_DGN_LBAR_ALT_UNIT, m_unitLbarAlt);
	DDX_Control(pDX, IDC_DGN_LBAR_AWT_EDIT, m_editLbarAwt);
	DDX_Control(pDX, IDC_DGN_LBAR_AWT_UNIT, m_unitLbarAwt);
	DDX_Control(pDX, IDC_DGN_LBAR_PCH_EDIT, m_editLbarPch);
	DDX_Control(pDX, IDC_DGN_LBAR_PCH_UNIT, m_unitLbarPch);
	DDX_Control(pDX, IDC_DGN_SBAR_ANG_EDIT, m_editSbarAng);
	DDX_Control(pDX, IDC_DGN_SBAR_ANG_UNIT, m_unitSbarAng);
	DDX_Control(pDX, IDC_DGN_SBAR_AW_EDIT, m_editSbarAw);
	DDX_Control(pDX, IDC_DGN_SBAR_AW_UNIT, m_unitSbarAw);
	DDX_Control(pDX, IDC_DGN_SBAR_PCH_EDIT, m_editSbarPch);
	DDX_Control(pDX, IDC_DGN_SBAR_PCH_UNIT, m_unitSbarPch);
	DDX_Control(pDX, IDC_DGN_TENS_ANG_EDIT, m_editTensAng);
	DDX_Control(pDX, IDC_DGN_TENS_ANG_UNIT, m_unitTensAng);
	DDX_Control(pDX, IDC_DGN_TENS_AP_EDIT, m_editTenAp);
	DDX_Control(pDX, IDC_DGN_TENS_AP_UNIT, m_unitTenAp);
	DDX_Control(pDX, IDC_DGN_TENS_PCH_EDIT, m_editTensPch);
	DDX_Control(pDX, IDC_DGN_TENS_PCH_UNIT, m_unitTensPch);
	DDX_Control(pDX, IDC_DGN_TENS_PE_EDIT, m_editTensPe);
	DDX_Control(pDX, IDC_DGN_TENS_PE_UNIT, m_unitTensPe);
	DDX_Control(pDX, IDC_DGN_LBAR_CHECK, m_chkLbar);
	DDX_Control(pDX, IDC_DGN_SBAR_CHECK, m_chkSbar);
	DDX_Control(pDX, IDC_DGN_TENS_CHECK, m_chkTens);
	DDX_Control(pDX, IDC_DGN_ACP_CHECK, m_chkAcp);
	DDX_Control(pDX, IDC_DGN_CT_EDIT, m_editCoverThk);
	DDX_Control(pDX, IDC_DGN_CT_UNIT, m_unitCoverThk);
	DDX_Control(pDX, IDC_DGN_INC_FC_CHECK, m_chkIncFC);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDgnRebarPscShear_I, CChildDialog)
	//{{AFX_MSG_MAP(CDgnRebarPscShear_I)
	ON_BN_CLICKED(IDC_DGN_LBAR_CHECK, OnDgnLbarCheck)
	ON_BN_CLICKED(IDC_DGN_SBAR_CHECK, OnDgnSbarCheck)
	ON_BN_CLICKED(IDC_DGN_TENS_CHECK, OnDgnTensCheck)
	ON_BN_CLICKED(IDC_DGN_STRR_CHECK, OnDgnStrrCheck)
	ON_BN_CLICKED(IDC_DGN_ACP_CHECK,	OnDgnAcpCheck)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CDgnRebarPscShear_I::SetCurData(T_RPSC_SBAR* pData)
{
	ASSERT(pData);  
	m_Data = *pData;
...
BOOL CDgnRebarPscShear_I::GetCurData(T_RPSC_SBAR* pData)
{
	ASSERT(pData);
...
/////////////////////////////////////////////////////////////////////////////
// CDgnRebarPscShear_I message handlers

BOOL CDgnRebarPscShear_I::OnInitDialog() 
{
	...
	aCtrlAcp.Add(IDC_DGN_ACP_CHECK);
	aCtrlAcp.Add(IDC_DGN_CT_TEXT);
	aCtrlAcp.Add(IDC_DGN_CT_EDIT);
	aCtrlAcp.Add(IDC_DGN_CT_UNIT);
	aCtrlAcp.Add(IDC_DGN_INC_FC_CHECK);
...
BOOL CDgnRebarPscShear_I::DestroyWindow() 
{
...
void CDgnRebarPscShear_I::OnDgnLbarCheck() 
{
...
void CDgnRebarPscShear_I::OnDgnSbarCheck() 
{
	// TODO: Add your control notification handler code here
...
void CDgnRebarPscShear_I::OnDgnTensCheck() 
{
	// TODO: Add your control notification handler code here
...
void CDgnRebarPscShear_I::OnDgnStrrCheck() 
{
	// TODO: Add your control notification handler code here
...
void CDgnRebarPscShear_I::OnDgnAcpCheck()
{
...
void CDgnRebarPscShear_I::Data2Dlg()
{
	// °æ»çÀÎÀåÃ¶±Ù
	...
	if (m_bShowStirrup)
	{
		m_chkStirrup.SetCheck(m_Data.bStirExist);
...
void CDgnRebarPscShear_I::Dlg2Data(T_RPSC_SBAR* pData)
{
	ASSERT(pData);
	pData->Initialize();
