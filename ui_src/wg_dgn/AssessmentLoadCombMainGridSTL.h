#if !defined(AFX_AssessmentLoadCombMainGridSTL_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_AssessmentLoadCombMainGridSTL_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// AssessmentLoadCombMainGridSTL.h : header file
//
...
class CAssessmentLoadCombSubGridSTL;
class CAssessmentLoadCombSTLDlg;
/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombMainGridSTL window

// 메모 : DB에 값을 넣는 것은 Child에 있음

class CAssessmentLoadCombMainGridSTL : public CTBCommon
{
	// Construction
public:
	CAssessmentLoadCombMainGridSTL(CAssessmentLoadCombSTLDlg* pParent);

	// Attributes
public:
	CString m_aCurDefVal[50];
	CAssessmentLoadCombSubGridSTL* m_pSubGrid;
...
public:
	...
	//{{AFX_VIRTUAL(CAssessmentLoadCombMainGridSTL)
	//}}AFX_VIRTUAL
...
public:
	...
	// Implementation
public:
	virtual ~CAssessmentLoadCombMainGridSTL();
...
protected:
	...
	//{{AFX_MSG(CAssessmentLoadCombMainGridSTL)
	...
	CAssessmentLoadCombSTLDlg* m_pParent;
};
...
#endif // !defined(AFX_AssessmentLoadCombMainGridSTL_H__5B5AF002_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
