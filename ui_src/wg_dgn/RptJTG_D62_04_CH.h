//////////////////////////////////////////////////////////////////////
// RptJTG_D62_04_CH.h: interface for the DgnJTG_D62_04 class.
// author: maxiao
// time  : 2006-12-08
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_RPTJTG_D62_04_CH_H__INCLUDED_)
#define AFX_RPTJTG_D62_04_CH_H__INCLUDED_
...
class __MY_EXT_CLASS__ CRptJTG_D62_04_CH : public CReportBase , public CPrtKSCE_USD03  
{
public:
	CRptJTG_D62_04_CH();
	virtual ~CRptJTG_D62_04_CH();
...
protected:  
	...
	CRCImportFile_CH* m_pJTG_D62_04;
...
protected:
	...
	BOOL MakeTensRebarStressData(int& iChapID, T_PARA_RPT& paraD);
	 ...
	 // 6.3. 嘉묏쌓뙈櫓昑菉寮윗壇제駱炬
	BOOL MakeConstructStagecsncData(int& iChapID, T_PARA_RPT& paraD);
	...
	//6.5 졺돨李蕨멀쏘좆뮌炬
	BOOL MakeBrlrData(int& iChapID, T_PARA_RPT& paraD);

	//6.6 졺돨팹繫뮈쏘痰좆뮌炬
	BOOL MakeBrcrData(int& iChapID, T_PARA_RPT& paraD);
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++
		// 6.10. 料돨죙룹욱똑駱炬
	BOOL MakeServiceStageColumnCrackData(int& iChapID, T_PARA_RPT& paraD);

	// 6.11.料돨菉/튤懃예윗駱炬
	BOOL MakeColumnCtcsData(int& iChapID, T_PARA_RPT& paraD);

	// 6.12.料돨菉/튤懃예箕駱炬
	BOOL MakeColumnCscsData(int& iChapID, T_PARA_RPT& paraD);

	// 6.13.料돨李蕨멀쏘좆뮌炬
	BOOL MakeCrlrData(int& iChapID, T_PARA_RPT& paraD);
...
#endif // !defined(AFX_RPTJTG_D62_04_CH_H__INCLUDED_)
