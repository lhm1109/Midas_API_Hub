#if !defined(__DgnCRCAnnexDgnParameterDlg_LSD_H__)
#define __DgnCRCAnnexDgnParameterDlg_LSD_H__
...
class __MY_EXT_CLASS__ CDgnCRCAnnexDgnParameterDlg_LSD : public CDialogMove
{
	// Construction
public:
	CDgnCRCAnnexDgnParameterDlg_LSD(CWnd* pParent = NULL);   // standard constructor
	
	// Dialog Data
	//{{AFX_DATA(CDgnConMatDlg)
	enum { IDD = IDD_DGN_CRC_DESIGN_PARAMETER_LSD_ANNEX };
...
#endif // !defined(AFX_DgnCRCAnnexDgnParameterDlg_LSD_H__4B768343_DD95_11D3_888F_0000C0F30D4D__INCLUDED_)
