// Dgn_PSCRptManager_IRS.h: interface for the CDgn_PSCRptManager_IRS class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_Dgn_PSCRptManager_IRS_H__320D0EDD_A144_432B_A6E6_1B91E6B8F83C__INCLUDED_)
#define AFX_Dgn_PSCRptManager_IRS_H__320D0EDD_A144_432B_A6E6_1B91E6B8F83C__INCLUDED_
...
typedef BOOL (PSC_Print_Detail_Design_Shear_EC)(const int /*iDgncode*/, UINT /*iElemKey*/, UINT /*iIJ*/, void* /*pFysgAashtoBase*/, size_t /*sizeFysgAashtobase*/, void* /*pFysgAashtoBase*/, size_t /*sizeFysgAashtobase*/, void* /*pFysgAashtoBase*/, size_t /*sizeFysgAashtobase*/,BOOL & /*bVersionOK*/ );


class CDgn_PSCRptManager_IRS : public CDgn_DllManager_Base       
{
public:
	CDgn_PSCRptManager_IRS();
	virtual ~CDgn_PSCRptManager_IRS();
...
protected:
	...
	PSC_Print_Detail_Design_Shear_EC*     m_pShearDetail;
...
public:
	...
	BOOL Print_DetailReport_ShearDesign_IRS(int iDgnCode, ElemPairK iElemKey, UINT iIJ, PSC_DATA_POSI& InData, PSC_CUMS_BASE& CumsBase,PSC_FRCR_D& FrcrD);
