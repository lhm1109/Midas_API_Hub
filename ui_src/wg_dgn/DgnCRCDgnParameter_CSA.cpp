...
CDgnCRCDgnParameter_CSA::CDgnCRCDgnParameter_CSA(T_PSCD_D* pParamData, CWnd* pParent /*=NULL*/)
: CMyChildDialog(CDgnCRCDgnParameter_CSA::IDD, pParent)
{
...
//   m_aExposureType.Add(IDC_CSA_PARAMETER14);
//   m_aExposureType.Add(IDC_CSA_PARAMETER15);
//   m_aExposureType.Add(IDC_CSA_PARAMETER16);
//   m_aExposureType.Add(IDC_CSA_PARAMETER17);
	m_aSegment.Add(IDC_CSA_PARAMETER19);
	m_aSegment.Add(IDC_CSA_PARAMETER20);
}

CDgnCRCDgnParameter_CSA::~CDgnCRCDgnParameter_CSA()
{
}


void CDgnCRCDgnParameter_CSA::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDgnCRCDgnParameter_CSA, CMyChildDialog)
...
BOOL CDgnCRCDgnParameter_CSA::OnInitDialog() 
{
...
void CDgnCRCDgnParameter_CSA::OnClickSelectAllOutputOpt()
{
	UpdateData(TRUE);
	// SET TRUE
...
void CDgnCRCDgnParameter_CSA::OnClickUnselectAllOutputOpt()
{
	UpdateData(TRUE);
...
void CDgnCRCDgnParameter_CSA::Initial_Data()
{
...
BOOL CDgnCRCDgnParameter_CSA::Dlg2Data()
{
	// radio
