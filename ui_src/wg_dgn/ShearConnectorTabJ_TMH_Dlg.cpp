...
CShearConnectorTabJ_TMH_Dlg::CShearConnectorTabJ_TMH_Dlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CShearConnectorTabJ_TMH_Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CShearConnectorTabJ_TMH_Dlg)
...
void CShearConnectorTabJ_TMH_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CShearConnectorTabJ_TMH_Dlg)
...
BEGIN_MESSAGE_MAP(CShearConnectorTabJ_TMH_Dlg, CChildDialog)
	//{{AFX_MSG_MAP(CShearConnectorTabJ_TMH_Dlg)
...
void CShearConnectorTabJ_TMH_Dlg::SetData(BOOL bBothIJ, int nOption)
{
	m_bBothIJ = bBothIJ;
	m_nOption = nOption;
}

void CShearConnectorTabJ_TMH_Dlg::GetData(T_PSCN_D &PscnD)
{
...
void CShearConnectorTabJ_TMH_Dlg::InitUnit()
{
...
void CShearConnectorTabJ_TMH_Dlg::ControlsEnableDisable()
{
	BOOL bEnable = FALSE;
...
void CShearConnectorTabJ_TMH_Dlg::Data2Dlg()
{
	if(m_bBothIJ)
	{
...
void CShearConnectorTabJ_TMH_Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
/////////////////////////////////////////////////////////////////////////////
// CShearConnectorTabJ_TMH_Dlg message handlers
BOOL CShearConnectorTabJ_TMH_Dlg::OnInitDialog()
{
...
BOOL CShearConnectorTabJ_TMH_Dlg::DestroyWindow()
{
	Dlg2Data();
...
void CShearConnectorTabJ_TMH_Dlg::OnShearConnectAeBtn()
{
	double dArea = 0.0;
...
void CShearConnectorTabJ_TMH_Dlg::OnShearConnectFyBtn()
{
	double dFy = 0.0;
