#if !defined(__DgnCRCDgnParameter_CSA_H__)
#define __DgnCRCDgnParameter_CSA_H__
...
class __MY_EXT_CLASS__ CDgnCRCDgnParameter_CSA : public CMyChildDialog
{
	// Construction
public:
	CDgnCRCDgnParameter_CSA(T_PSCD_D* pParamData, CWnd* pParent = NULL);   // standard constructor
	~CDgnCRCDgnParameter_CSA(); 

	// Dialog Data
	//{{AFX_DATA(CDgnCRCDgnParameter_EC2PSC)
	enum { IDD = IDD_DGN_CRC_DESIGN_PARAMETER_CSA};
	...
	mit::frx::MButton   m_RdoTndType;
	mit::frx::MButton   m_RdoTndCalcMethod;
	mit::frx::MButton   m_RdoRebarEpoxy;
	mit::frx::MButton   m_RdoExposureType;
	//}}AFX_DATA
...
protected:
	...
	// Implementation
protected:
	//{{AFX_MSG(CDgnCRCDgnParameter_CSA)
