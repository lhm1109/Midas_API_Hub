...
/////////////////////////////////////////////////////////////////////////////
// CDgnCfPfdlDlg dialog


CDgnCfPfdlDlg::CDgnCfPfdlDlg(CWnd* pParent /*=NULL*/)
	: CMenuBarChildDlg(CDgnCfPfdlDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnCfPfdlDlg)
	m_nOption = -1;
	m_pfdl = 2;
	//m_dPhiby = 0.0;
	//m_dPhibz = 0.0;
...
void CDgnCfPfdlDlg::DoDataExchange(CDataExchange* pDX)
{
	CMenuBarChildDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnCfPfdlDlg)
...
BEGIN_MESSAGE_MAP(CDgnCfPfdlDlg, CMenuBarChildDlg)
	//{{AFX_MSG_MAP(CDgnCfPfdlDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnCfPfdlDlg message handlers

BOOL CDgnCfPfdlDlg::OnInitDialog() 
{
	CMenuBarChildDlg::OnInitDialog();

	if(m_pDoc==NULL)	return TRUE;
	CString str[] = {_LS(IDS_TB_PFDL_1),_LS(IDS_TB_PFDL_2),_LS(IDS_TB_PFDL_3)};
	for (int i=0; i< 3; i++)
...
void CDgnCfPfdlDlg::OnDgnClose() 
{
	// TODO: Add your control notification handler code here
	CTreeMenuBarBase::SetModeST(__TMMODE_TREEMENU__);
}

void CDgnCfPfdlDlg::OnDgnExecute() 
{
...
void CDgnCfPfdlDlg::Initial_SelectItem() 
{
	// Unselected All.
...
void CDgnCfPfdlDlg::Initial_Data()
{
...
void CDgnCfPfdlDlg::OnDgnPhibAr() 
{
	m_nOption  = 0;			//	add/replace
	UpdateData(FALSE);
}

void CDgnCfPfdlDlg::OnDgnPhibDel() 
{
	m_nOption  = 1;			//	Delete
	UpdateData(FALSE);
}
...
// Add by ZINU.('02.3.21).
void CDgnCfPfdlDlg::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
...
// Add by ZINU.('02.3.21).
void CDgnCfPfdlDlg::Update_InitDataByCode()
{
	...
	CString strTitle = _T("");
	BOOL bShow = FALSE;
	m_pDoc->GetDesignTitleCfs(ID_DGN_PERFOR_DUCTILITY_LEVEL_CFS, strTitle, bShow);

	EnableItems(bShow);
}

void CDgnCfPfdlDlg::OnSelPfdl()
{
	m_pfdl = m_lstPfdl.GetCurSel();
}

void CDgnCfPfdlDlg::EnableItems(BOOL bEnable)
{
