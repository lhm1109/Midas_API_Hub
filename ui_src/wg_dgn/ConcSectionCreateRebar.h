...
#if !defined(AFX_CONCSECTIONCREATEREBAR_H__0E038880_1B43_4058_B4ED_8DE2CE7BE12F__INCLUDED_)
#define AFX_CONCSECTIONCREATEREBAR_H__0E038880_1B43_4058_B4ED_8DE2CE7BE12F__INCLUDED_
...
class __MY_EXT_CLASS__ CConcSectionCreateRebar : public CChildDialog
{
protected:
 I_DlgViewPanel * m_pIDVP;
// Construction
public:
	CConcSectionCreateRebar(CWnd* pParent = NULL);   // standard constructor
	virtual ~CConcSectionCreateRebar();
...
// Dialog Data
	//{{AFX_DATA(CConcSectionCreateRebar)
	enum { IDD = IDD_DGN_CON_CREATE_REBAR };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CConcSectionCreateRebar)
	public:
...
protected:
	...
	//{{AFX_MSG(CConcSectionCreateRebar)
	...
	afx_msg void OnDeltaposDgnShearYStepSpin(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnDeltaposDgnShearZStepSpin(NMHDR* pNMHDR, LRESULT* pResult);
...
#endif // !defined(AFX_CONCSECTIONCREATEREBAR_H__0E038880_1B43_4058_B4ED_8DE2CE7BE12F__INCLUDED_)
