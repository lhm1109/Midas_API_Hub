#if !defined(__DGNREBARPSCSHEAR_I_H__)
#define __DGNREBARPSCSHEAR_I_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnRebarPscShear_I.h : header file
//
...
class CDgnRebarPscShear_I : public CChildDialog
{
// Construction
public:
	CDgnRebarPscShear_I(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDgnRebarPscShear_I)
	enum { IDD = IDD_DGN_REBAR_PSC_SHEAR_I };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDgnRebarPscShear_I)
	public:
...
#endif // !defined(__DGNREBARPSCSHEAR_I_H__)
