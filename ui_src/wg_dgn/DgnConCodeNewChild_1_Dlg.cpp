...
CDgnConCodeNewChild1Dlg::CDgnConCodeNewChild1Dlg(CDgnConCodeNewDlg* pParent /*=NULL*/, T_DCON_D* pData, BOOL bExistData/*=FALSE*/)
	: CDconChildDialog(CDgnConCodeNewChild1Dlg::IDD, pParent, pData, bExistData)
{
...
void CDgnConCodeNewChild1Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDgnConCodeNewChild1Dlg, CDconChildDialog)
...
BOOL CDgnConCodeNewChild1Dlg::OnInitDialog() 
{
    ...
    if (UseAlpha2Colm(strCode))
        GetDlgItem(IDC_DGN_EQ_FACTOR25)->GetWindowRect(&RefRect);
    else
    {
...
void CDgnConCodeNewChild1Dlg::SetComboCdAndIe()
{
...
void CDgnConCodeNewChild1Dlg::SetComboCdAngle_ACI318()
{
	m_CmbCd.ResetContent();
...
void CDgnConCodeNewChild1Dlg::SetComboBox()
{
	const CString& strCode = CDBLib::GetConvertCodeName(m_pData->DesignCode);
...
BOOL CDgnConCodeNewChild1Dlg::UseAlpha2Colm(const CString& strCode)
{
    return CDgnCodeCtrl::IsConCodeUseAlpha2ColmSSWB(strCode) ? TRUE : FALSE;
}

BOOL CDgnConCodeNewChild1Dlg::UseBeamColmJointDesign(const CString& strCode)
{
    bool bUse = false;
    if (strCode == CONCODE_ACI318_14 || strCode == CONCODE_ACI318M_14 || 
        strCode == CONCODE_ACI318_19 || strCode == CONCODE_ACI318M_19 || 
		strCode == CONCODE_ACI318_25 || strCode == CONCODE_ACI318M_25 || 
        strCode == CONCODE_NSCP_2015 || strCode == CONCODE_NTC_DCEC_2017 || strCode == CONCODE_NTC_DCEC_2023)
    {
        bUse = true;
    }
    else if (strCode == CONCODE_KDS_41_30_2018)
    {
        const auto nCode = CDgnCodeCtrl::GetConCodeID(strCode);
        bUse = CDgnCodeCtrl::IsIDesignModule(nCode);
    }
    else if (strCode == CONCODE_KDS_41_20_2022)
    {
        bUse = true;
    }
...
void CDgnConCodeNewChild1Dlg::AlignControl()
{
	//m_grpWallType.InitControl(this, CDgnConCodeNewChild1Dlg::IDD, IDC_DGN_WALLTYPE_N0, TRUE, TRUE);
}

void CDgnConCodeNewChild1Dlg::SetShowPMCurveMethod(const CString& strCode)
{
...
void CDgnConCodeNewChild1Dlg::InitCtrl()
{
	m_grpSeisParam.InitControl(this, CDgnConCodeNewChild1Dlg::IDD, IDC_DGN_SEIS_PARAM_GRB, TRUE, TRUE);
...
void CDgnConCodeNewChild1Dlg::OnDgnRcctrlSpecial() 
{
...
void CDgnConCodeNewChild1Dlg::GetInitValue(CString strCode)
{
	if(!m_bExistData)
	{
		m_iAlphaType1 = 1;
...
void CDgnConCodeNewChild1Dlg::OnChangeFrameType()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild1Dlg::OnChangeAlphaType()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild1Dlg::OnChkSpecialWall()
{
	UpdateData(TRUE);
	EnableWindowBySpecialWall();
}

void CDgnConCodeNewChild1Dlg::OnChangeBndrElemMethodType()
{
	UpdateData(TRUE);
	EnableWindowByBndrElemMethod();
}

// void CDgnConCodeNewChild1Dlg::OnSelchangeConStressStrainCombo()
// {
...
void CDgnConCodeNewChild1Dlg::EnableWindowByBeamColmJointDesign(const CString& strCode, BOOL bChangeValue/*=TRUE*/)
{
...
void CDgnConCodeNewChild1Dlg::EnableWindowByBndrElemMethod()
{
...
void CDgnConCodeNewChild1Dlg::OnChangeTorsion()
{
...
void CDgnConCodeNewChild1Dlg::OnUpdateByCode()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild1Dlg::SetShowJointDesign(const CString& strCode)
{
...
void CDgnConCodeNewChild1Dlg::SetShowExposure(const CString& strCode)
{
...
void CDgnConCodeNewChild1Dlg::SetShowBeamDeflection(const CString& strCode)
{
...
void CDgnConCodeNewChild1Dlg::SetAlpha2Colm(const CString& strCode)
{
...
void CDgnConCodeNewChild1Dlg::UpdateChildData()
{
...
void CDgnConCodeNewChild1Dlg::ChangeDesignCode()
{
...
void CDgnConCodeNewChild1Dlg::ResizeChildDlg()
{
...
//     CDlgUtil::CtrlShowHide(this, m_aStressStrainType, (strCode == CONCODE_KDS_41_20_2022) ? SW_SHOW : SW_HIDE);
	CDlgUtil::CtrlShowHide(this, m_aFsMethod, (strCode == CONCODE_KDS_41_30_2018) ? SW_SHOW : SW_HIDE);
	...
	if (strCode == CONCODE_KDS_41_30_2018) nIDRef = IDC_DGN_FS_METHOD_FRM;
...
void CDgnConCodeNewChild1Dlg::ReAlingShearDesignCtrl()
{
...
void CDgnConCodeNewChild1Dlg::EnableWindowBySpecialWall()
{
	if(m_bSpecialWall)
	{ 
...
void CDgnConCodeNewChild1Dlg::SetEQCtrl(const CString& strCode)
{
	CString strTxt=_T("");
	int iStatus	= GetDataStatus(strCode);
...
BOOL CDgnConCodeNewChild1Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild1Dlg::OnBCJoint()//PMS:4562 (Tel. 4022) MNET:XXXX-BSCHOI-20121108 #1
{
    UpdateData(TRUE);
...
LRESULT CDgnConCodeNewChild1Dlg::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	BOOL bSeisParamFolded = m_grpSeisParam.GetFoldState();
	ResizeChildDlg();
	if(!bSeisParamFolded)
