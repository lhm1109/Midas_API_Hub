...
/////////////////////////////////////////////////////////////////////////////
// CCPGFatigueParamTabJDlg_CSA dialog
...
class __MY_EXT_CLASS__ CCPGFatigueParamTabJDlg_CSA : public CChildDialog
{
	// Construction
public:
	CCPGFatigueParamTabJDlg_CSA(CWnd* pParent = NULL);   // standard constructor


	// Dialog Data
	//{{AFX_DATA(CCPGFatigueParamTabJDlg_CSA)
	enum { IDD = IDD_DGN_CPG_FATIGUE_PARAM_TAB_J_CSA_DLG };
	...
	CEditUnit	m_edtDesignLife;

	BOOL      m_bAutoChk;
	CEditUnit	m_edtNdValue;
	CEditUnit	m_edtPValue;
	...
	//{{AFX_VIRTUAL(CCPGFatigueParamTabJDlg_CSA)
protected:
...
protected:
	...
	//{{AFX_MSG(CCPGFatigueParamTabJDlg_CSA)
