// 
// DgnCRCAnnexDgnParameter_BS_Dlg.cpp : implementation file
// 
#include "stdafx.h"
#include "wg_dgn.h"
...
/////////////////////////////////////////////////////////////////////////////
// CDgnCRCAnnexDgnParameter_BS_Dlgdialog
CDgnCRCAnnexDgnParameter_BS_Dlg::CDgnCRCAnnexDgnParameter_BS_Dlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CDgnCRCAnnexDgnParameter_BS_Dlg::IDD, pParent)
{
	m_bIncrevtu = FALSE;
...
CDgnCRCAnnexDgnParameter_BS_Dlg::~CDgnCRCAnnexDgnParameter_BS_Dlg()
{

}

void CDgnCRCAnnexDgnParameter_BS_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnCRCAnnexDgnParameter_BS_Dlg)	
...
void CDgnCRCAnnexDgnParameter_BS_Dlg::InitUnit()
{
	CString strCode = _T("");
	strCode = CDBLib::GetPscCodeName(m_pParamData->iDgnCode);

	GetDlgItem(IDC_DGN_BS5400_STC)->SetWindowText(strCode);  // DgnCode!!
...
void CDgnCRCAnnexDgnParameter_BS_Dlg::Data2Dlg()
{
...
BOOL CDgnCRCAnnexDgnParameter_BS_Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
BEGIN_MESSAGE_MAP(CDgnCRCAnnexDgnParameter_BS_Dlg, CDialogMove)
	//{{AFX_MSG_MAP(CDgnCRCAnnexDgnParameter_BS_Dlg)
	ON_BN_CLICKED(IDC_DGN_UPDATE_BY_CODE_BTN, OnResetDgnParam_byAnnex)	
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

BOOL CDgnCRCAnnexDgnParameter_BS_Dlg::OnInitDialog()
{
...
void CDgnCRCAnnexDgnParameter_BS_Dlg::OnOK()
{
	if(!Dlg2Data())
	{
		return;
...
void CDgnCRCAnnexDgnParameter_BS_Dlg::OnCancel()
{
	CDialogMove::OnCancel();
}

void CDgnCRCAnnexDgnParameter_BS_Dlg::OnResetDgnParam_byAnnex()
{
...
void CDgnCRCAnnexDgnParameter_BS_Dlg::EnableDisableControls()
{
    UpdateData(TRUE);
