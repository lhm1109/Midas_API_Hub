#if !defined(AFX_DGNSTLSPCSECTITABDLG_H__)
#define AFX_DGNSTLSPCSECTITABDLG_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnStlSPCSectITabDlg.h : header file
//
...
class CDgnSteelSPCSectGrid;

class CDgnStlSPCSectITabDlg : public CChildDialog
{
// Construction
public:
	CDgnStlSPCSectITabDlg(CWnd* pParent = NULL);   // standard constructor  

// Dialog Data
	//{{AFX_DATA(CDgnStlSPCSectITabDlg)
	enum { IDD = IDD_DGN_STL_SPC_SECT_I_DLG };	
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDgnStlSPCSectITabDlg)
	protected:
...
#endif // !defined(AFX_DGNSTLSPCSECTITABDLG_H__)
