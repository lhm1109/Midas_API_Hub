// CShearConnectorBarAreaIRSDlg.cpp : implementation file
//
...
CShearConnectorBarAreaIRSDlg::CShearConnectorBarAreaIRSDlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CShearConnectorBarAreaIRSDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CShearConnectorBarAreaIRSDlg)	
	//}}AFX_DATA_INIT

	m_pDoc = CDBDoc::GetDocPoint(); ASSERT(m_pDoc);
}

CShearConnectorBarAreaIRSDlg::~CShearConnectorBarAreaIRSDlg()
{
}

void CShearConnectorBarAreaIRSDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogMove::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CShearConnectorBarAreaIRSDlg)
...
BEGIN_MESSAGE_MAP(CShearConnectorBarAreaIRSDlg, CDialogMove)
...
void CShearConnectorBarAreaIRSDlg::InitUnit()
{
	m_untArea.SetUnitType(D_UNITSYS_BASE_AREA);
}

void CShearConnectorBarAreaIRSDlg::InitCombo()
{
	// Rebar Code
...
// void CShearConnectorBarAreaIRSDlg::InitDiaCombo()
// {
//   CStringArray aRBName;
...
void CShearConnectorBarAreaIRSDlg::CalcArea()
{
	UpdateData(TRUE);
...
void CShearConnectorBarAreaIRSDlg::GetValue(double &dArea)
{
	dArea = m_edtArea.GetEditValue();
}

/////////////////////////////////////////////////////////////////////////////
// CShearConnectorBarAreaIRSDlg message handlers

BOOL CShearConnectorBarAreaIRSDlg::OnInitDialog() 
{
...
void CShearConnectorBarAreaIRSDlg::OnOK() 
{
	CDialogMove::OnOK();
}

// void CShearConnectorBarAreaIRSDlg::OnShearConnectorAreaCodeCmb()
// {
// //   // Rebar Name
// //   CString strRebarCode = _T("");
// //   m_cmbCode.GetLBText(m_cmbCode.GetCurSel(), strRebarCode);
...
void CShearConnectorBarAreaIRSDlg::OnShearConnectorAreaDiaCmb()
{
	CalcArea();
}

void CShearConnectorBarAreaIRSDlg::OnShearConnectorAreaLatNumEdt()
{
	CalcArea();
}

void CShearConnectorBarAreaIRSDlg::OnShearConnectorAreaLongNumEdt()
{
	CalcArea();
}
