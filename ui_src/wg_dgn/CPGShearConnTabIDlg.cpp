// CPGShearConnTabIDlg.cpp : implementation file
//
...
CCPGShearConnTabIDlg::CCPGShearConnTabIDlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCPGShearConnTabIDlg::IDD, pParent)
{
	m_nSFCalc = 0;

	//{{AFX_DATA_INIT(CCPGShearConnTabIDlg)
...
void CCPGShearConnTabIDlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCPGShearConnTabIDlg)
...
BEGIN_MESSAGE_MAP(CCPGShearConnTabIDlg, CChildDialog)
	//{{AFX_MSG_MAP(CCPGShearConnTabIDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCPGShearConnTabIDlg message handlers

BOOL CCPGShearConnTabIDlg::OnInitDialog() 
{
	...
	m_chkGroup.InitControl(this, CCPGShearConnTabIDlg::IDD, IDC_CPSC_FOLDE_GROUP_BOX,TRUE,TRUE);
	//m_chkFrc.InitControl(this, CCPGShearConnTabIDlg::IDD, IDC_CPSC_FRC_GROUP_BOX,TRUE,TRUE);
	ResizeDialog();
...
BOOL CCPGShearConnTabIDlg::DestroyWindow() 
{
	Dlg2Data();
...
void CCPGShearConnTabIDlg::InitCombo()
{
...
void CCPGShearConnTabIDlg::InitUnit()
{
...
void CCPGShearConnTabIDlg::Data2Dlg()
{
...
BOOL CCPGShearConnTabIDlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CCPGShearConnTabIDlg::GetCpscData()
{
	Dlg2Data();
	m_pParent->m_I_Data = m_Data;
}

void CCPGShearConnTabIDlg::SetCpscData()
{
	Data2Dlg();
}

void CCPGShearConnTabIDlg::ControlsEnableDisable()
{
	UpdateData(TRUE);
...
CRect CCPGShearConnTabIDlg::GetResizeHeight()
{	
	CRect r;
...
void CCPGShearConnTabIDlg::ResizeDialog()
{	
...
void CCPGShearConnTabIDlg::ResizeWindow()
{

}

LRESULT CCPGShearConnTabIDlg::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	m_pParent->ResizeWindow();
	return 0L;
}

void CCPGShearConnTabIDlg::OnShearConnectDiaBtn()
{
	double dDia = 0.;
...
void CCPGShearConnTabIDlg::OnShearConnectFuBtn()
{
	double dFy = 0.;
