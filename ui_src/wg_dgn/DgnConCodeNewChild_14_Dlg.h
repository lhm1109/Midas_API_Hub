#if !defined(__DGN_CON_CODE_NEW_CHILD_14_DLG_H__)
#define __DGN_CON_CODE_NEW_CHILD_14_DLG_H__

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnConCodeNewChild_14_Dlg.h : header file
//
...
class __MY_EXT_CLASS__ CDgnConCodeNewChild14Dlg : public CDconChildDialog
{
// Construction
public:
	CDgnConCodeNewChild14Dlg(CDgnConCodeNewDlg* pParent = NULL, T_DCON_D* pData=NULL, BOOL bExistData=FALSE);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDgnConCodeNewChild4Dlg)
	enum { IDD = IDD_DGN_CON_CODE_CHILD14_DLG };
	...
	mit::frx::MComboBox m_CmbQ;
	//double    m_dR;
	double    m_dQ;
	double    m_dR;
	int		m_nPMCurveMethod;
	int		m_nCheckPos;
	BOOL    m_bConsiderReduction;
...
protected:
	...
	CArray<UINT, UINT> m_aBeamColmJoint;
	...
	CArray<UINT, UINT> m_aConsiderReduction;
...
#endif // !defined(__DGN_CON_CODE_NEW_CHILD_14_DLG_H__)
