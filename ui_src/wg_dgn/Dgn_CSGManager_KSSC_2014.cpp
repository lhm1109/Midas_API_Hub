// Dgn_CSGManager_KSSC_2014.cpp: implementation of the CDgn_CSGManager_KSSC_2014 class.
//
//////////////////////////////////////////////////////////////////////
...
CDgn_CSGManager_KSSC_2014::CDgn_CSGManager_KSSC_2014() : CDgn_CSGManager()
{
}

CDgn_CSGManager_KSSC_2014::~CDgn_CSGManager_KSSC_2014()
{

}

BOOL CDgn_CSGManager_KSSC_2014::InitialData(int nDgnType, int nDgnCode)
{
	...
	m_pMemberRes = (PDGNENGINE_FUNC*)GetProcAddress(hDllCalc, "Get_CsgMemberResultKSSC_LSD2014");
	if (!m_pMemberRes) return FALSE;

	m_pConsRes = (PDGNENGINE_FUNC3*)GetProcAddress(hDllCalc, "Check_CsgConstructibilityKSSC_LSD2014"); 
	if(!m_pConsRes) return FALSE;

	m_pStrnRes = (PDGNENGINE_FUNC3*)GetProcAddress(hDllCalc, "Check_CsgStrnengthKSSC_LSD2014"); 
	if(!m_pStrnRes) return FALSE;

	m_pServRes = (PDGNENGINE_FUNC3*)GetProcAddress(hDllCalc, "Check_CsgServiceKSSC_LSD2014"); 
	if(!m_pServRes) return FALSE;

	m_pFatiRes = (PDGNENGINE_FUNC3*)GetProcAddress(hDllCalc, "Check_CsgFatigueKSSC_LSD2014"); 
	if(!m_pFatiRes) return FALSE;

	m_pSconRes = (PDGNENGINE_FUNC3*)GetProcAddress(hDllCalc, "Check_CsgShearConnectorKSSC_LSD2014"); 
	if(!m_pSconRes) return FALSE;

	m_pStfnRes = (PDGNENGINE_FUNC3*)GetProcAddress(hDllCalc, "Check_CsgStiffenerKSSC_LSD2014"); 
	if(!m_pStfnRes) return FALSE;

	return TRUE;
}

BOOL CDgn_CSGManager_KSSC_2014::Check_MemberResult(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &rData)
{
...
BOOL CDgn_CSGManager_KSSC_2014::Check_ConstructibilityRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes)
{
	size_t TSize_In    = sizeof(CSG_MEMB_POSD_KSCE_LSD);
...
BOOL CDgn_CSGManager_KSSC_2014::Check_StrengthRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes)
{
	size_t TSize_In    = sizeof(CSG_MEMB_POSD_KSCE_LSD);
	size_t TSize_MembR = sizeof(CSG_MEMB_RES_AASHTO_LRFD_D);
...
BOOL CDgn_CSGManager_KSSC_2014::Check_ServiceRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes)
{
	size_t TSize_In    = sizeof(CSG_MEMB_POSD_KSCE_LSD);
	size_t TSize_MembR = sizeof(CSG_MEMB_RES_AASHTO_LRFD_D);
...
BOOL CDgn_CSGManager_KSSC_2014::Check_FatigueRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes)
{
	size_t TSize_In    = sizeof(CSG_MEMB_POSD_KSCE_LSD);
	size_t TSize_MembR = sizeof(CSG_MEMB_RES_AASHTO_LRFD_D);
...
BOOL CDgn_CSGManager_KSSC_2014::Check_ShearConnRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes)
{
	size_t TSize_In    = sizeof(CSG_MEMB_POSD_KSCE_LSD);
	size_t TSize_MembR = sizeof(CSG_MEMB_RES_AASHTO_LRFD_D);
...
BOOL CDgn_CSGManager_KSSC_2014::Check_StiffenerRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes) 
{
	size_t TSize_In    = sizeof(CSG_MEMB_POSD_KSCE_LSD);
	size_t TSize_MembR = sizeof(CSG_MEMB_RES_AASHTO_LRFD_D);
...
BOOL CDgn_CSGManager_KSSC_2014::Check_BearingStiffenerRes(CSG_MEMB_POSD_KSCE_LSD &MembD, CSG_MEMB_RESULT_D &MembRes, CSG_CHECK_RESULT_CODES &ChkRes)
{
    return TRUE;
}
