// CPGLateralTorsionTab_IRC_Dlg.cpp : implementation file
//
...
CCPGLateralTorsionTab_IRC_Dlg::CCPGLateralTorsionTab_IRC_Dlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CCPGLateralTorsionTab_IRC_Dlg::IDD, pParent)
{
	//전역변수 초기화
	

	//{{AFX_DATA_INIT(CCPGLateralTorsionTab_IRC_Dlg)
	m_bUse = TRUE;	
	m_iAlpha = 0;
...
void CCPGLateralTorsionTab_IRC_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCPGLateralTorsionTab_IRC_Dlg)
...
BEGIN_MESSAGE_MAP(CCPGLateralTorsionTab_IRC_Dlg, CChildDialog)
	//{{AFX_MSG_MAP(CCPGLateralTorsionTab_IRC_Dlg)
...
/////////////////////////////////////////////////////////////////////////////
// CCPGLateralTorsionTab_IRC_Dlg message handlers


BOOL CCPGLateralTorsionTab_IRC_Dlg::OnInitDialog() 
{
...
BOOL CCPGLateralTorsionTab_IRC_Dlg::DestroyWindow() 
{
	Dlg2Data();
...
void CCPGLateralTorsionTab_IRC_Dlg::SetInitUnit()
{
...
void CCPGLateralTorsionTab_IRC_Dlg::OnUseChk() 
{
	UpdateData(TRUE);
...
void CCPGLateralTorsionTab_IRC_Dlg::InitialDlgData()
{
	//m_Data.Initialize();
...
BOOL CCPGLateralTorsionTab_IRC_Dlg::Data2Dlg()
{
...
BOOL CCPGLateralTorsionTab_IRC_Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CCPGLateralTorsionTab_IRC_Dlg::GetCgltData()
{
	Dlg2Data();
...
void CCPGLateralTorsionTab_IRC_Dlg::SetCgltData()
{
	Data2Dlg();
}

void CCPGLateralTorsionTab_IRC_Dlg::SetAllControlEnable()
{
	bool enable = true;
