...
CDgnCRCAnnexDgnParameter_IRS_Dlg::CDgnCRCAnnexDgnParameter_IRS_Dlg(CWnd* pParent /*=NULL*/)
	: CDialogMove(CDgnCRCAnnexDgnParameter_IRS_Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnConMatDlg)
	//}}AFX_DATA_INIT
}

void CDgnCRCAnnexDgnParameter_IRS_Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDgnCRCAnnexDgnParameter_IRS_Dlg, CDialogMove)
...
BOOL CDgnCRCAnnexDgnParameter_IRS_Dlg::OnInitDialog() 
{
...
void CDgnCRCAnnexDgnParameter_IRS_Dlg::OnCancel() 
{
	// TODO: Add extra cleanup here
	CDialogMove::OnCancel();
}

void CDgnCRCAnnexDgnParameter_IRS_Dlg::OnOK() 
{
	UpdateData(TRUE);
...
void CDgnCRCAnnexDgnParameter_IRS_Dlg::Dlg2Data()
{
...
void CDgnCRCAnnexDgnParameter_IRS_Dlg::Initial_Data()
{
	//if (m_pParamData->iDgnCode==IRC_112_2011_PSC)
	//{
	...
	//	if      (iIndex==0) strCode  = _T("Recommended");
	//	else if (iIndex==1) strCode  = _T("British");
	//	else if (iIndex==2) strCode  = _T("Italy");
	//	else
	//		ASSERT(0);
	...
	if (m_pParamData->iDgnCode==IRS_PSC)
	{
...
void CDgnCRCAnnexDgnParameter_IRS_Dlg::OnResetDgnParam_byAnnex()
{
	// RESET!!
	if (m_pParamData->iDgnCode==IRS_PSC)
	{
...
/*
void CDgnCRCAnnexDgnParameter_IRS_Dlg::GetDefaultDatabyAnnex(T_PSCD_D& ParamData, int nAnnex)
{
	if(nAnnex < 0 || nAnnex > 2)  return;

	ParamData.dGamma_c_PT   = 1.50;
	ParamData.dGamma_s_PT   = 1.15;
	ParamData.dGamma_ps_PT  = 1.15;
	ParamData.dGamma_c_A    = 1.20;
	ParamData.dGamma_s_A    = 1.00;
	ParamData.dGamma_ps_A   = 1.00;
	ParamData.dGamma_c_serv = 1.00;
	ParamData.dGamma_s_serv = 1.00;
	//
	ParamData.dAlpha_cc     = 0.85;
	ParamData.dAlpha_ct     = 1.00;
	//
	ParamData.dk1_sl        = 0.60;
	ParamData.dk3_sl        = 0.80;
	ParamData.dk4_sl        = 1.00;
	ParamData.dk6_sl        = 0.70;
	//
	ParamData.dk1_ps        = 0.80;
	ParamData.dk2_ps        = 0.90;
	ParamData.dk5_ps        = 0.75;
	ParamData.dk7_ps        = 0.75;
	ParamData.dk8_ps        = 0.85;
	//
	ParamData.dk_c_ps_stage = 1.00;
	ParamData.dk_t_ps_stage = 1.00;
	ParamData.dk_c_ps       = 1.00;
	ParamData.dk_t_ps       = 1.00;
	//
	ParamData.dk3_cr        = 3.400;
	ParamData.dk4_cr        = 0.425;
	...
	{
		// Annex별 다른 변수는 다시 SET함.
		ParamData.dAlpha_ct     = 0.85;
		ParamData.dk3_sl        = 0.70;
		ParamData.dk4_sl        = 0.90;
		ParamData.dk6_sl        = 0.65;
		ParamData.dk5_ps        = 0.60;
	}  
}
*/