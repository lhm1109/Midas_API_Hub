// DgnConCodeNewChild_16_Dlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDgnConCodeNewChild16Dlg dialog


CDgnConCodeNewChild16Dlg::CDgnConCodeNewChild16Dlg(CDgnConCodeNewDlg* pParent /*=NULL*/, T_DCON_D* pData, BOOL bExistData/*=FALSE*/)
	: CDconChildDialog(CDgnConCodeNewChild16Dlg::IDD, pParent, pData, bExistData)
{
	//{{AFX_DATA_INIT(CDgnConCodeNewChild16Dlg)
// 	m_pData = pData;
...
void CDgnConCodeNewChild16Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDconChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnConCodeNewChild16Dlg)
...
BEGIN_MESSAGE_MAP(CDgnConCodeNewChild16Dlg, CDconChildDialog)
	//{{AFX_MSG_MAP(CDgnConCodeNewChild16Dlg)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnConCodeNewChild16Dlg message handlers

BOOL CDgnConCodeNewChild16Dlg::OnInitDialog()
{
...
void CDgnConCodeNewChild16Dlg::SetComboCdAndIe()
{
...
void CDgnConCodeNewChild16Dlg::SetComboCdAngle_ACI318()
{
	m_CmbCd.ResetContent();
...
void CDgnConCodeNewChild16Dlg::SetComboBox()
{
...
BOOL CDgnConCodeNewChild16Dlg::UseAlpha2Colm(const CString& strCode)
{
	return CDgnCodeCtrl::IsConCodeUseAlpha2ColmSSWB(strCode) ? TRUE : FALSE;
}

BOOL CDgnConCodeNewChild16Dlg::UseBeamColmJointDesign(const CString& strCode)
{
...
void CDgnConCodeNewChild16Dlg::AlignControl()
{
	//m_grpWallType.InitControl(this, CDgnConCodeNewChild16Dlg::IDD, IDC_DGN_WALLTYPE_N0, TRUE, TRUE);
}

void CDgnConCodeNewChild16Dlg::SetShowPMCurveMethod(const CString& strCode)
{
...
void CDgnConCodeNewChild16Dlg::InitCtrl()
{
	m_grpSeisParam.InitControl(this, CDgnConCodeNewChild16Dlg::IDD, IDC_DGN_SEIS_PARAM_GRB, TRUE, TRUE);
...
void CDgnConCodeNewChild16Dlg::OnDgnRcctrlSpecial()
{
...
void CDgnConCodeNewChild16Dlg::GetInitValue(CString strCode)
{
	if (!m_bExistData)
	{
		m_iAlphaType1 = 1;
...
void CDgnConCodeNewChild16Dlg::OnChangeFrameType()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild16Dlg::OnChangeAlphaType()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild16Dlg::OnChkSpecialWall()
{
	UpdateData(TRUE);
	EnableWindowBySpecialWall();
}

void CDgnConCodeNewChild16Dlg::OnChangeBndrElemMethodType()
{
	UpdateData(TRUE);
	EnableWindowByBndrElemMethod();
}

void CDgnConCodeNewChild16Dlg::EnableWindowByBeamColmJointDesign(const CString& strCode, BOOL bChangeValue/*=TRUE*/)
{
...
void CDgnConCodeNewChild16Dlg::EnableWindowByBndrElemMethod()
{
...
void CDgnConCodeNewChild16Dlg::OnChangeTorsion()
{
...
void CDgnConCodeNewChild16Dlg::OnUpdateByCode()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild16Dlg::SetShowExposure(const CString& strCode)
{
...
void CDgnConCodeNewChild16Dlg::SetShowBeamDeflection(const CString& strCode)
{
...
void CDgnConCodeNewChild16Dlg::SetAlpha2Colm(const CString& strCode)
{
...
void CDgnConCodeNewChild16Dlg::UpdateChildData()
{
...
void CDgnConCodeNewChild16Dlg::ChangeDesignCode()
{
...
void CDgnConCodeNewChild16Dlg::ResizeChildDlg()
{
	BOOL bShowFrame = m_bSpecialEQ;
	...
	CDlgUtil::CtrlEnableDisable(this, m_aShearWallType, bSpecialEQShowFrame && m_iFrameType!=2);
	if(bSpecialEQShowFrame && m_iFrameType!=2)	EnableWindowBySpecialWall();
...
void CDgnConCodeNewChild16Dlg::ReAlingShearDesignCtrl()
{
...
void CDgnConCodeNewChild16Dlg::EnableWindowBySpecialWall()
{
	if (m_bSpecialWall)
	{
...
void CDgnConCodeNewChild16Dlg::SetEQCtrl(const CString& strCode)
{
	CString strTxt = _T("");
	int iStatus = GetDataStatus(strCode);
	...
	if(iStatus == 20)
	{
		...
		GetDlgItem(IDC_DGN_EQ_FACTOR4)->EnableWindow(FALSE);
		GetDlgItem(IDC_DGN_EQ_FACTOR11)->EnableWindow(FALSE);
		GetDlgItem(IDC_DGN_EQ_FACTOR12)->EnableWindow(FALSE);
		...
		CDlgUtil::CtrlShowHide(this, m_arCtrlSDR, m_bSpecialEQ);

		if(m_iFrameType != 2)
		{
			GetDlgItem(IDC_DGN_EQ_FACTOR1)->EnableWindow(TRUE);
			GetDlgItem(IDC_DGN_EQ_FACTOR2)->EnableWindow(TRUE);
			GetDlgItem(IDC_DGN_EQ_FACTOR3)->EnableWindow(TRUE);
			GetDlgItem(IDC_DGN_EQ_FACTOR4)->EnableWindow(TRUE);
			GetDlgItem(IDC_DGN_EQ_FACTOR11)->EnableWindow(TRUE);
			GetDlgItem(IDC_DGN_EQ_FACTOR12)->EnableWindow(TRUE);
...
BOOL CDgnConCodeNewChild16Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild16Dlg::OnBCJoint()//PMS:4562 (Tel. 4022) MNET:XXXX-BSCHOI-20121108 #1
{
	UpdateData(TRUE);
...
void CDgnConCodeNewChild16Dlg::OnBtnWallEnvelopMethod()
{
...
LRESULT CDgnConCodeNewChild16Dlg::OnFoldButtonClicked(WPARAM wParam, LPARAM lParam)
{
	BOOL bSeisParamFolded = m_grpSeisParam.GetFoldState();
	ResizeChildDlg();
	if (!bSeisParamFolded)
