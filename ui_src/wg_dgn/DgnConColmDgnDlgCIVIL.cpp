...
CDgnConColmDgnDlgCIVIL::CDgnConColmDgnDlgCIVIL(CWnd* pParent /*=NULL*/)
	: CMenuBarChildDlg(CDgnConColmDgnDlgCIVIL::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnConColmDgnDlgCIVIL)
	m_AddorDel = 0;
	//}}AFX_DATA_INIT
...
void CDgnConColmDgnDlgCIVIL::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnConColmDgnDlgCIVIL)
...
BEGIN_MESSAGE_MAP(CDgnConColmDgnDlgCIVIL, CMenuBarChildDlg)
	//{{AFX_MSG_MAP(CDgnConColmDgnDlgCIVIL)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnConColmDgnDlgCIVIL message handlers
...
void CDgnConColmDgnDlgCIVIL::ResetSectGridData(BOOL bKeepChk/*FALSE*/)
{
...
void CDgnConColmDgnDlgCIVIL::SetInitStirCB()
{
...
void CDgnConColmDgnDlgCIVIL::SetInitUnit()
{
...
void CDgnConColmDgnDlgCIVIL::SetData2Dlg()
{
...
BOOL CDgnConColmDgnDlgCIVIL::OnInitDialog() 
{
...
void CDgnConColmDgnDlgCIVIL::OnDgnDesignSection() 
{
...
BOOL CDgnConColmDgnDlgCIVIL::CheckInputData()
{
	double dH;
...
void CDgnConColmDgnDlgCIVIL::SetDlg2Data()
{
	CString str = _T("");
	m_RdgnData.nType = 1;
...
void CDgnConColmDgnDlgCIVIL::OnDgnExecute() 
{
	UpdateData(TRUE);
...
void CDgnConColmDgnDlgCIVIL::OnDgnClose() 
{
...
void CDgnConColmDgnDlgCIVIL::ShowBitmap(CString& colType)
{
	CWnd* pWnd[9];
...
// ShowHideControl
//------------------------------------------------------------------
void CDgnConColmDgnDlgCIVIL::ShowHideControl(CString& colType)
{
...
void CDgnConColmDgnDlgCIVIL::SetControlText(BOOL bBox)
{
	if(bBox == TRUE)
	{
...
// SelectElemOnView 
//---------------------------------------------------------------------------
void CDgnConColmDgnDlgCIVIL::SelectElemOnView()
{
	if(m_pDoc==NULL)	return;
	if(m_pDoc->m_pViewCtrl->SelectedElemCount()) m_pDoc->m_pViewCtrl->UnSelectAllElem(NULL, FALSE);
...
// ChangeSectionInfo 
//---------------------------------------------------------------------------
void CDgnConColmDgnDlgCIVIL::ChangeSectionInfo()
{
	// Select Elem. On View
	SelectElemOnView();
...
void CDgnConColmDgnDlgCIVIL::InitSectGrid()
{
	...
	m_SelectGrid.InitSectGrid(m_arColmData, 1); // 1 : Dgn Mode

}

LRESULT CDgnConColmDgnDlgCIVIL::OnChangeFocusSectionGrid(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDgnConColmDgnDlgCIVIL::OnSelectCheckSectionGrid(WPARAM wParam, LPARAM lParam)
{
...
void CDgnConColmDgnDlgCIVIL::OnDgnColmSelectAll()
{
...
void CDgnConColmDgnDlgCIVIL::OnDgnColmUnSelectAll()
{
	ResetSectGridData();
...
// DB 관련 
//
void CDgnConColmDgnDlgCIVIL::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
...
void CDgnConColmDgnDlgCIVIL::UpdateBuffer()
{
