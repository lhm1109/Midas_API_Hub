#if !defined(AFX_AssessmentLoadCombSubGridSTLNR_H__5B5AF003_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_AssessmentLoadCombSubGridSTLNR_H__5B5AF003_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// AssessmentLoadCombSubGridSTLNR.h : header file
//
...
class CAssessmentLoadCombSubGridSTLNR : public CTBBrowserWnd
{
	// Construction
public:
...
public:
	...
	CDBDoc* m_pDoc;
	CAssessmentLoadCombMainGridSTLNR* m_pMainGrid;
	CString m_sKey;
...
public:
	...
	// Overrides
		...
		//{{AFX_VIRTUAL(CAssessmentLoadCombSubGridSTLNR)
		//}}AFX_VIRTUAL
	...
	// Implementation
public:
	virtual ~CAssessmentLoadCombSubGridSTLNR();
...
protected:
	//{{AFX_MSG(CAssessmentLoadCombSubGridSTLNR)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
#endif // !defined(AFX_AssessmentLoadCombSubGridSTLNR_H__5B5AF003_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
