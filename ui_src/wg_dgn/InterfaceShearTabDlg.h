#if !defined(AFX_INTERFACESHEARTABIDLG_H__)
#define AFX_INTERFACESHEARTABIDLG_H__
...
class __MY_EXT_CLASS__ CInterfaceShearTabDlg : public CChildDialog
{
	// Construction
public:
	CInterfaceShearTabDlg(int nIJ, CWnd* pParent = NULL);   // standard constructor


	enum { IDD = IDD_DGN_DESIGN_INTERFACE_SHEAR_TAB_DLG };
