// DGN_CSGRptManager_CSA_S6.cpp: implementation of the CDgn_CSGRptManager_CSA14 class.
//
//////////////////////////////////////////////////////////////////////
...
CDgn_CSGRptManager_CSA_S6::CDgn_CSGRptManager_CSA_S6()
{
	m_pCSGDetail_CSA_S6 = NULL;
}
...
BOOL CDgn_CSGRptManager_CSA_S6::InitialData(int iNationType)
{
	...
	{	
		m_pCSGDetail_CSA_S6 = (CSG_Print_DetailReport_CSA_S6*)GetProcAddress(hDllCalc, "Print_CSGDetailReport_CSA_S6");
		if(!m_pCSGDetail_CSA_S6) return FALSE;
	}

	return TRUE;
}

BOOL CDgn_CSGRptManager_CSA_S6::Print_DetailReport(int iDgnCode, LPCTSTR szProgramDir, LPCTSTR szProjectFileDir, LPCTSTR szSaveFileName,
																										 CArray<CSG_MEMB_POSD_KSCE_LSD, CSG_MEMB_POSD_KSCE_LSD&>& aInData,   CArray<CSG_RPT_RES_CSA_14,  CSG_RPT_RES_CSA_14&>& aRptData)
{
	...
	size_t TSize_Rpt  = sizeof(CArray<CSG_MEMB_RES_CSA_S6_D, CSG_MEMB_RES_CSA_S6_D&>);

	int nSelUnit = CDBLib::EN_REPORT_UNIT_SI;
	...
	bCheck = (*m_pCSGDetail_CSA_S6)(&ROpt, pProInte,
