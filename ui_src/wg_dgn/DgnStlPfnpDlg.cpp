...
CDgnStlPfnpDlg::CDgnStlPfnpDlg(CWnd* pParent /*=NULL*/)
	: CMenuBarChildDlg(CDgnStlPfnpDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnStlPfnpDlg)
	m_nOption = -1;
	m_pfnp = 1.1;
	//}}AFX_DATA_INIT
...
void CDgnStlPfnpDlg::DoDataExchange(CDataExchange* pDX)
{
	CMenuBarChildDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnStlPfnpDlg)
...
BEGIN_MESSAGE_MAP(CDgnStlPfnpDlg, CMenuBarChildDlg)
	//{{AFX_MSG_MAP(CDgnStlPfnpDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CDgnStlPfnpDlg message handlers

BOOL CDgnStlPfnpDlg::OnInitDialog() 
{
...
void CDgnStlPfnpDlg::OnDgnClose() 
{
	// TODO: Add your control notification handler code here
	CTreeMenuBarBase::SetModeST(__TMMODE_TREEMENU__);
}

void CDgnStlPfnpDlg::OnDgnExecute() 
{
...
void CDgnStlPfnpDlg::Initial_SelectItem() 
{
	// Unselected All.
...
BOOL CDgnStlPfnpDlg::ErrorCheck()
{
	BOOL bCheck = TRUE;
...
void CDgnStlPfnpDlg::Initial_Data()
{
...
void CDgnStlPfnpDlg::OnDgnPfnpAr() 
{
	m_nOption  = 0;			//	add/replace
	UpdateData(FALSE);
}

void CDgnStlPfnpDlg::OnDgnPfnpDel() 
{
	m_nOption  = 1;			//	Delete
	UpdateData(FALSE);
}
...
// Add by ZINU.('02.3.21).
void CDgnStlPfnpDlg::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
...
// Add by ZINU.('02.3.21).
void CDgnStlPfnpDlg::Update_InitDataByCode()
{
	...
	CString strTitle = _T("");
	BOOL bShow = FALSE;
	m_pDoc->GetDesignTitleStl(ID_DGN_PERFOR_NON_PLASTIC_FORCE_COEFFICIENT, strTitle, bShow);

	EnableItems(bShow);
}

void CDgnStlPfnpDlg::EnableItems(BOOL bEnable)
{
