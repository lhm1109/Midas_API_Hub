// RatingCaseMainGrid.h: interface for the CRatingCaseMainGrid class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_RATINGCASEMAINGRID_H__2119AB30_1751_4782_93D9_9F39F4DF5547__INCLUDED_)
#define AFX_RATINGCASEMAINGRID_H__2119AB30_1751_4782_93D9_9F39F4DF5547__INCLUDED_
...
class CRatingCaseDlg;
class CRatingCaseSubGrid;

class CRatingCaseMainGrid : public CTBCommon
{
public:
	CRatingCaseMainGrid();

	T_RTLD_D RateLoad[7]; // DC, DW, T, SEC, Permanet, User, Temp.Gradient...
...
// Operations
public:
	void Initialize(T_RTLD_D RateData[10], CRatingCaseDlg* pParent);
...
public:
	...
	void LoadDlgData();
	void SetRtldData(T_RTLD_D RateData[10]);
...
private:
	CRatingCaseDlg* m_pParent;

};

#endif // !defined(AFX_RATINGCASEMAINGRID_H__2119AB30_1751_4782_93D9_9F39F4DF5547__INCLUDED_)
