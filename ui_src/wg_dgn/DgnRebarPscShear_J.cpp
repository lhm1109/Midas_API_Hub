// DgnRebarPscShear_J.cpp : implementation file
//
...
CDgnRebarPscShear_J::CDgnRebarPscShear_J(CWnd* pParent /*=NULL*/)
	: CChildDialog(CDgnRebarPscShear_J::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDgnRebarPscShear_J)
...
void CDgnRebarPscShear_J::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDgnRebarPscShear_J)
...
BEGIN_MESSAGE_MAP(CDgnRebarPscShear_J, CChildDialog)
	//{{AFX_MSG_MAP(CDgnRebarPscShear_J)
...
void CDgnRebarPscShear_J::SetCurData(T_RPSC_SBAR* pData, BOOL bSymmetry)
{
	ASSERT(pData);  
	m_Data = *pData;
...
BOOL CDgnRebarPscShear_J::GetCurData(T_RPSC_SBAR* pData)
{
	ASSERT(pData);
...
/////////////////////////////////////////////////////////////////////////////
// CDgnRebarPscShear_J message handlers

BOOL CDgnRebarPscShear_J::OnInitDialog() 
{
...
BOOL CDgnRebarPscShear_J::DestroyWindow() 
{
...
void CDgnRebarPscShear_J::OnDgnLbarCheck() 
{
...
void CDgnRebarPscShear_J::OnDgnSbarCheck() 
{
	// TODO: Add your control notification handler code here
...
void CDgnRebarPscShear_J::OnDgnTensCheck() 
{
	// TODO: Add your control notification handler code here
...
void CDgnRebarPscShear_J::OnDgnStrrCheck() 
{
	// TODO: Add your control notification handler code here
...
void CDgnRebarPscShear_J::OnDgnAcpCheck()
{
...
void CDgnRebarPscShear_J::Data2Dlg()
{
	// °æ»çÀÎÀåÃ¶±Ù
...
void CDgnRebarPscShear_J::Dlg2Data(T_RPSC_SBAR* pData)
{
	ASSERT(pData);
	pData->Initialize();
