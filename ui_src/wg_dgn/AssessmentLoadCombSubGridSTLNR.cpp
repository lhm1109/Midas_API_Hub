// AssessmentLoadCombSubGridSTLNR.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombSubGridSTLNR
CAssessmentLoadCombSubGridSTLNR::CAssessmentLoadCombSubGridSTLNR()
{
	m_pMainGrid = 0;
...
BEGIN_MESSAGE_MAP(CAssessmentLoadCombSubGridSTLNR, CTBBrowserWnd)
	//{{AFX_MSG_MAP(CAssessmentLoadCombSubGridSTLNR)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()


/////////////////////////////////////////////////////////////////////////////
// CAssessmentLoadCombSubGridSTLNR message handlers
void CAssessmentLoadCombSubGridSTLNR::Initialize(CDBDoc* pDoc)
{
...
// Column별 헤더 이름을 설정한다.
void CAssessmentLoadCombSubGridSTLNR::SetHeaderTitle()
{
	CString title;
	int i;
	ROWCOL nCol;
...
void CAssessmentLoadCombSubGridSTLNR::SetLoadCaseColumnStyle(ROWCOL nCol)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::IsMainAppendRow()
{
	return m_sKey == _LS(IDS_WG_CMD__ADDD__Append_Row);
}

BOOL CAssessmentLoadCombSubGridSTLNR::IsMainNewRow()
{
	return m_sKey == _LS(IDS_WG_CMD__ADDD__New_Row);
}

BOOL CAssessmentLoadCombSubGridSTLNR::OnAddNewRecord(ROWCOL nRow)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::OnModifyRecord(ROWCOL nRow)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::OnDeleteRecord(ROWCOL nRow)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::OnDeleteRecords(CRowColArray &awRows)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::OnCanceledAddNew()
{
	BOOL bRetVal = CTBBrowserWnd::OnCanceledAddNew();
	return bRetVal;
}

BOOL CAssessmentLoadCombSubGridSTLNR::OnCanceledModify()
{
	BOOL bRetVal = CTBBrowserWnd::OnCanceledModify();
	return bRetVal;
}

BOOL CAssessmentLoadCombSubGridSTLNR::OnInsertEmptyRecord(ROWCOL nRow)
{
...
void CAssessmentLoadCombSubGridSTLNR::OnModifyCell(ROWCOL nRow, ROWCOL nCol)
{
	m_pMainGrid->SetModeEdit();// 먼저 호출되어야 한다. 주1 참조
	CTBBrowserWnd::OnModifyCell(nRow, nCol);
}

void CAssessmentLoadCombSubGridSTLNR::OnChangeStld()
{
	// 지워진 하중들은 제거한다.
	T_STLD_D stldData;
	T_SPLC_D splcData;
...
BOOL CAssessmentLoadCombSubGridSTLNR::OnValidateField(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::OnStartEditing(ROWCOL nRow, ROWCOL nCol)
{
...
BOOL CAssessmentLoadCombSubGridSTLNR::ValidataFieldDbl(ROWCOL nRow, ROWCOL nCol)
{
	CString value;
	int nErrCode;
...
void CAssessmentLoadCombSubGridSTLNR::SetData(CString sKey)
{
	m_sKey = sKey;
...
void CAssessmentLoadCombSubGridSTLNR::GetData(T_ALCS_D &data)
{
	int nAnalType;
	T_STLD_K nKey;
