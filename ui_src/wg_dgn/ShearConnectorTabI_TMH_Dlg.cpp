// CShearConnectorTabI_TMH_Dlg.cpp : implementation file
//
...
CShearConnectorTabI_TMH_Dlg::CShearConnectorTabI_TMH_Dlg(CWnd* pParent /*=NULL*/)
	: CChildDialog(CShearConnectorTabI_TMH_Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CShearConnectorTabI_TMH_Dlg)
...
void CShearConnectorTabI_TMH_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CChildDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CShearConnectorTabI_TMH_Dlg)
...
BEGIN_MESSAGE_MAP(CShearConnectorTabI_TMH_Dlg, CChildDialog)
	//{{AFX_MSG_MAP(CShearConnectorTabI_TMH_Dlg)
...
void CShearConnectorTabI_TMH_Dlg::SetData(BOOL bBothIJ, int nOption)
{
	m_nOption = nOption;
}

void CShearConnectorTabI_TMH_Dlg::GetData(T_PSCN_D &PscnD)
{
...
void CShearConnectorTabI_TMH_Dlg::InitUnit()
{
...
void CShearConnectorTabI_TMH_Dlg::ControlsEnableDisable()
{
...
void CShearConnectorTabI_TMH_Dlg::Data2Dlg()
{
...
void CShearConnectorTabI_TMH_Dlg::Dlg2Data()
{
	UpdateData(TRUE);
...
/////////////////////////////////////////////////////////////////////////////
// CShearConnectorTabI_TMH_Dlg message handlers
BOOL CShearConnectorTabI_TMH_Dlg::OnInitDialog()
{
...
BOOL CShearConnectorTabI_TMH_Dlg::DestroyWindow()
{
	Dlg2Data();
...
void CShearConnectorTabI_TMH_Dlg::OnShearConnectAeBtn()
{
	double dArea = 0.0;
...
void CShearConnectorTabI_TMH_Dlg::OnShearConnectFyBtn()
{
	double dFy = 0.0;
