#if !defined(AFX_SHEARCONNECTORTABJ_IRS_DLG_H__)
#define AFX_SHEARCONNECTORTABJ_IRS_DLG_H__
...
class __MY_EXT_CLASS__ CShearConnectorTabJ_IRS_Dlg : public CChildDialog
{
	// Construction
public:
	CShearConnectorTabJ_IRS_Dlg(CWnd* pParent = NULL);   // standard constructor
	
	// Dialog Data
	//{{AFX_DATA(CShearConnectorTabJ_IRS_Dlg)
	...
	// Overrides
	//{{AFX_VIRTUAL(CShearConnectorTabJ_IRS_Dlg)
protected:
...
public:
	...
	//{{AFX_MSG(CShearConnectorTabJ_IRS_Dlg)
...
#endif // !defined(AFX_SHEARCONNECTORTABJDLG_H__)
