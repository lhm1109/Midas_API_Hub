#if !defined(AFX_DgnBeamGridWndRusCIVIL_H__DBAB41C3_7E03_4493_882F_C1BFD0A20EDD__INCLUDED_)
#define AFX_DgnBeamGridWndRusCIVIL_H__DBAB41C3_7E03_4493_882F_C1BFD0A20EDD__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DgnBeamGridWndRusCIVIL.h : header file
//

#include "..\wg_common\wg_common_TBBrowserWnd.h"

/////////////////////////////////////////////////////////////////////////////
// CDgnBeamGridWndRusCIVIL window

struct T_RCHK_BEAM;
class CDBDoc;
class DgnConBeamBarDlgCIVIL;

class CDgnBeamGridWndRusCIVIL : public CTBBrowserWnd
{
// Construction
public:
	CDgnBeamGridWndRusCIVIL(T_RCHK_BEAM* pBeamData, CWnd* pParent = NULL);
	virtual ~CDgnBeamGridWndRusCIVIL();
...
protected:
	...
	//{{AFX_MSG(CDgnBeamGridWndRusCIVIL)
...
#endif // !defined(AFX_DgnBeamGridWndRusCIVIL_H__DBAB41C3_7E03_4493_882F_C1BFD0A20EDD__INCLUDED_)
