#if !defined(AFX_AssessmentLoadCombSubGrid_H__5B5AF003_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
#define AFX_AssessmentLoadCombSubGrid_H__5B5AF003_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// AssessmentLoadCombSubGrid.h : header file
//
...
class CAssessmentLoadCombSubGrid : public CTBBrowserWnd
{
// Construction
public:
...
public:
	...
	CDBDoc* m_pDoc;
	CAssessmentLoadCombMainGrid* m_pMainGrid;
	CString m_sKey;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CAssessmentLoadCombSubGrid)
	//}}AFX_VIRTUAL
...
// Implementation
public:
	virtual ~CAssessmentLoadCombSubGrid();
...
protected:
	//{{AFX_MSG(CAssessmentLoadCombSubGrid)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
#endif // !defined(AFX_AssessmentLoadCombSubGrid_H__5B5AF003_5156_11D3_92DE_0000C0B0E6B3__INCLUDED_)
