...
export function MainWorkspace({ endpoint, baseUrl }: MainWorkspaceProps) {
  const { 
    currentVersionId, 
    getCurrentVersion, 
    saveCurrentVersion, 
