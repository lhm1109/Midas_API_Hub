...
#### ✨ 새로운 기능
- ✅ Manager 탭 검색 기능 추가 (대소문자 무시)
- ✅ CSV/Excel import 시 대소문자 무시 헤더 매핑
- ✅ Deploy 컬럼 추가 및 CSV export 지원
- ✅ Excel 파일 import 지원 (.xlsx, .xls, .xlsm)

#### 🔧 변경 사항
- ✅ 상태 값 소문자 통일 (wip → progress)
- ✅ 컬럼 헤더 유연한 매핑 (End Point, endpoint, endPoint 모두 인식)
- ✅ 데이터베이스 마이그레이션 SQL 제공

#### 🐛 버그 수정
- ✅ 모달 입력 필드 자동 포커스 문제 해결
- ✅ Products 테이블 컬럼 누락 수정
...
Copyright (c) 2026 MIDAS IT

---

## 📞 문의

- **이슈**: [GitHub Issues](https://github.com/your-org/bat-rack/issues)
- **이메일**: dev@midasit.com
- **팀 Slack**: #bat-rack-dev

---

<p align="center">
  Made with ❤️ by MIDAS IT Development Team
</p>
